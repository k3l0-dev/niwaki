...
class pcFcAggrIfClearCountersLTask(ManagedObject):
    """ACI Managed Object: ``pcFcAggrIfClearCountersLTask``.

    RN format: ``pcFcAggrIfClearCountersLTask``
    """

    _aci_class: ClassVar[str] = "pcFcAggrIfClearCountersLTask"
    _rn_format: ClassVar[str] = "pcFcAggrIfClearCountersLTask"
