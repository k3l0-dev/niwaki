...
class pcAggrIfClearCountersLTask(ManagedObject):
    """ACI Managed Object: ``pcAggrIfClearCountersLTask``.

    RN format: ``pcAggrIfClearCountersLTask``
    """

    _aci_class: ClassVar[str] = "pcAggrIfClearCountersLTask"
    _rn_format: ClassVar[str] = "pcAggrIfClearCountersLTask"
