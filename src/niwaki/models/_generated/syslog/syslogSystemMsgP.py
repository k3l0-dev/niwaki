...
class syslogSystemMsgP(ManagedObject):
    """ACI Managed Object: ``syslogSystemMsgP`` — System Messages Policy.

    RN format: ``sysmsgp``
    """

    _aci_class: ClassVar[str] = "syslogSystemMsgP"
    _rn_format: ClassVar[str] = "sysmsgp"
