...
class dnsLbl(ManagedObject):
    """ACI Managed Object: ``dnsLbl`` — DNS Profile Label.

    The network domain name label. Labels enable classifying which objects can and cannot communicate with one another.

    RN format: ``dnslbl-{name}``
    """

    _aci_class: ClassVar[str] = "dnsLbl"
    _rn_format: ClassVar[str] = "dnslbl-{name}"
    ...
    _write_access: ClassVar[frozenset[str]] = frozenset(
        ["admin", "fabric-protocol", "tenant-connectivity"]
    )
