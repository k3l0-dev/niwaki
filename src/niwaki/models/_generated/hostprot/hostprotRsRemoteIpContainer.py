...
class hostprotRsRemoteIpContainer(ManagedObject):
    """ACI Managed Object: ``hostprotRsRemoteIpContainer`` — Host Protection Domain Policy.

    RN format: ``rsremoteIpContainer-[{target_dn}]``
    """
