...
class hostprotRemoteIpContainerDef(ManagedObject):
    """ACI Managed Object: ``hostprotRemoteIpContainerDef`` — Host Protection Domain remote ip container.

    RN format: ``remoteipcont``
    """

    _aci_class: ClassVar[str] = "hostprotRemoteIpContainerDef"
    _rn_format: ClassVar[str] = "remoteipcont"
