...
class hostprotRemoteIpContainer(ManagedObject):
    """ACI Managed Object: ``hostprotRemoteIpContainer`` — Remote Ip Container.

    RN format: ``remoteipcont``
    """

    _aci_class: ClassVar[str] = "hostprotRemoteIpContainer"
