...
class hostprotNamespace(ManagedObject):
    """ACI Managed Object: ``hostprotNamespace`` — Openshift k8s namespace.

    RN format: ``ns-{name}``
    """

    _aci_class: ClassVar[str] = "hostprotNamespace"
    _rn_format: ClassVar[str] = "ns-{name}"
