...
class hostprotFilterContainer(ManagedObject):
    """ACI Managed Object: ``hostprotFilterContainer`` — Remote Ip filter Container.

    RN format: ``filterContainer``
    """

    _aci_class: ClassVar[str] = "hostprotFilterContainer"
    _rn_format: ClassVar[str] = "filterContainer"
