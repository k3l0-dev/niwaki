...
class dhcpOptionPol(ManagedObject):
    """ACI Managed Object: ``dhcpOptionPol`` — DHCP Option Policy.
    ...
    RN format: ``dhcpoptpol-{name}``
    """

    _aci_class: ClassVar[str] = "dhcpOptionPol"
    _rn_format: ClassVar[str] = "dhcpoptpol-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The DHCP option policy name. This name can be up to 64 alphanumeric characters.",
        ),
    ]
