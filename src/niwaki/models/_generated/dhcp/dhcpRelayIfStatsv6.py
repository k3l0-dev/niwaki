...
class dhcpRelayIfStatsv6(ManagedObject):
    """ACI Managed Object: ``dhcpRelayIfStatsv6`` — IPv6 Relay Interface Statistics.

    RN format: ``statv6``
    """

    _aci_class: ClassVar[str] = "dhcpRelayIfStatsv6"
    _rn_format: ClassVar[str] = "statv6"
