...
class dhcpRsToNodeGrp(ManagedObject):
    """ACI Managed Object: ``dhcpRsToNodeGrp`` — DHCP Node Group.

    RN format: ``rstoNodeGrp-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "dhcpRsToNodeGrp"
    _rn_format: ClassVar[str] = "rstoNodeGrp-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1807": "fltDhcpRsToNodeGrpResolveFail",
    }
