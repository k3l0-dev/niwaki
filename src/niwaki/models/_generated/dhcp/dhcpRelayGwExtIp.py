...
class dhcpRelayGwExtIp(ManagedObject):
    """ACI Managed Object: ``dhcpRelayGwExtIp`` — Use the external secondary address for DHCP relay gateway.

    Enable external secondary IPs for DHCP relay gateway

    RN format: ``relayGwExtIp``
    """

    _aci_class: ClassVar[str] = "dhcpRelayGwExtIp"
    _rn_format: ClassVar[str] = "relayGwExtIp"
