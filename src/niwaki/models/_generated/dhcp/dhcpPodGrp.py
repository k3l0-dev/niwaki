...
class dhcpPodGrp(ManagedObject):
    """ACI Managed Object: ``dhcpPodGrp`` — DHCP POD Group.

    DHCP POD Group

    RN format: ``dhcppodgrp-{name}``
    """

    _aci_class: ClassVar[str] = "dhcpPodGrp"
    _rn_format: ClassVar[str] = "dhcppodgrp-{name}"
