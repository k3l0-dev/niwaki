...
class dhcpRelayIfStats(ManagedObject):
    """ACI Managed Object: ``dhcpRelayIfStats`` — Relay Interface Statistics.
    ...
    _aci_class: ClassVar[str] = "dhcpRelayIfStats"
    _rn_format: ClassVar[str] = "stat"
