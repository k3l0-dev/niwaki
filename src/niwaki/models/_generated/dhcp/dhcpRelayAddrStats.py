...
class dhcpRelayAddrStats(ManagedObject):
    """ACI Managed Object: ``dhcpRelayAddrStats`` — Relay Address Statistics.

    RN format: ``statistics``
    """

    _aci_class: ClassVar[str] = "dhcpRelayAddrStats"
    _rn_format: ClassVar[str] = "statistics"
