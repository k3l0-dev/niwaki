...
class dhcpNodeGrp(ManagedObject):
    """ACI Managed Object: ``dhcpNodeGrp`` — DHCP Node Group.

    The DHCP Node Group.

    RN format: ``dhcpndgrp-{name}``
    """

    _aci_class: ClassVar[str] = "dhcpNodeGrp"
    _rn_format: ClassVar[str] = "dhcpndgrp-{name}"
