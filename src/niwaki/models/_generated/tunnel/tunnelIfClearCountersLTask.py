...
class tunnelIfClearCountersLTask(ManagedObject):
    """ACI Managed Object: ``tunnelIfClearCountersLTask``.

    RN format: ``tunnelIfClearCountersLTask``
    """

    _aci_class: ClassVar[str] = "tunnelIfClearCountersLTask"
    _rn_format: ClassVar[str] = "tunnelIfClearCountersLTask"
