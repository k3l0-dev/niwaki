...
class twampServerPol(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "twampServerPol"
    _rn_format: ClassVar[str] = "twampServP-{name}"
    ...
    twamp_server_inactivity_timer: Annotated[
        int,
        Field(
            ge=1,
            le=65535,
            validation_alias="inactivityTimer",
            serialization_alias="inactivityTimer",
    ...
    twamp_server_port_number: Annotated[
        int,
        Field(
            ge=1,
            le=65535,
            ...
            description="TWAMP server listening port number.",
        ),
    ] = 862
