...
class maintRsReltomaintp(ManagedObject):
    """ACI Managed Object: ``maintRsReltomaintp`` — Relation to Maintenance Policy.

    RN format: ``rsreltomaintp``
    """

    _aci_class: ClassVar[str] = "maintRsReltomaintp"
    _rn_format: ClassVar[str] = "rsreltomaintp"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1434": "fltMaintRsReltomaintpResolveFail",
    }
