...
class maintPodMaintGrp(ManagedObject):
    """ACI Managed Object: ``maintPodMaintGrp`` — POD Maintenance Group.

    POD Maintenance Group. A set of PODs to which a maintenance policy may be applied.

    RN format: ``podmaintgrp-{name}``
    """

    _aci_class: ClassVar[str] = "maintPodMaintGrp"
    _rn_format: ClassVar[str] = "podmaintgrp-{name}"
