...
class maintUpgJobInstallLTask(ManagedObject):
    """ACI Managed Object: ``maintUpgJobInstallLTask``.

    Upgrade job to install the local task.

    RN format: ``maintUpgJobInstallLTask``
    """

    _aci_class: ClassVar[str] = "maintUpgJobInstallLTask"
    _rn_format: ClassVar[str] = "maintUpgJobInstallLTask"
    ...
    type: ActionType = Field(
        default=ActionType.INSTALL, description="The specific type of the object or component."
    )
