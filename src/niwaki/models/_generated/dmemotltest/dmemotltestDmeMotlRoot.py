...
class dmemotltestDmeMotlRoot(ManagedObject):
    """ACI Managed Object: ``dmemotltestDmeMotlRoot``.

    RN format: ``dme_motl_root``
    """

    _aci_class: ClassVar[str] = "dmemotltestDmeMotlRoot"
    _rn_format: ClassVar[str] = "dme_motl_root"
