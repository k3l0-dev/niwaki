...
class monCommonPol(ManagedObject):
    """ACI Managed Object: ``monCommonPol`` — Monitoring Policy.
    ...
    _aci_class: ClassVar[str] = "monCommonPol"
    _rn_format: ClassVar[str] = "moncommon"
