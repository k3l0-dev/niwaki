...
class monInfraPol(ManagedObject):
    """ACI Managed Object: ``monInfraPol`` — Monitoring Policy.
    ...
    RN format: ``moninfra-{name}``
    """

    _aci_class: ClassVar[str] = "monInfraPol"
    _rn_format: ClassVar[str] = "moninfra-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The access monitoring policy name. This name cannot be changed after it has been created.",
        ),
    ]
