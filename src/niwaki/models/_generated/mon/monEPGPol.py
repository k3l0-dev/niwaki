...
class monEPGPol(ManagedObject):
    """ACI Managed Object: ``monEPGPol`` — Monitoring Policy.
    ...
    RN format: ``monepg-{name}``
    """

    _aci_class: ClassVar[str] = "monEPGPol"
    _rn_format: ClassVar[str] = "monepg-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the tenant monitoring policy group. This cannot be changed after it has been created.",
        ),
    ]
