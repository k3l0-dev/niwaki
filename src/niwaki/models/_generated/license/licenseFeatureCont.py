...
class licenseFeatureCont(ManagedObject):
    """ACI Managed Object: ``licenseFeatureCont`` — Container for licensed features.

    RN format: ``features``
    """

    _aci_class: ClassVar[str] = "licenseFeatureCont"
    _rn_format: ClassVar[str] = "features"
