...
class mdpConsumerEPgInfoRef(ManagedObject):
    """ACI Managed Object: ``mdpConsumerEPgInfoRef`` — MDP EPg-Consumer Service Def (resolved).

    RN format: ``consumerepgref-[{consumer_epg_dn}]``
    """

    _aci_class: ClassVar[str] = "mdpConsumerEPgInfoRef"
    _rn_format: ClassVar[str] = "consumerepgref-[{consumer_epg_dn}]"
    _naming_props: ClassVar[list[str]] = ["consumer_epg_dn"]
