...
class mdpDomainCont(ManagedObject):
    """ACI Managed Object: ``mdpDomainCont`` — Container for registered domains/nodes.

    RN format: ``mdpDomainCont``
    """

    _aci_class: ClassVar[str] = "mdpDomainCont"
    _rn_format: ClassVar[str] = "mdpDomainCont"
