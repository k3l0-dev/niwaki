...
class mdpRsTenantInfoDefToMdpPolDefCont(ManagedObject):
    """ACI Managed Object: ``mdpRsTenantInfoDefToMdpPolDefCont`` — Container of multi-domain policies (resolved).

    RN format: ``rsTenantInfoDefToMdpPolDefCont``
    """

    _aci_class: ClassVar[str] = "mdpRsTenantInfoDefToMdpPolDefCont"
    _rn_format: ClassVar[str] = "rsTenantInfoDefToMdpPolDefCont"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3734": "fltMdpRsTenantInfoDefToMdpPolDefContResolveFail",
    }
