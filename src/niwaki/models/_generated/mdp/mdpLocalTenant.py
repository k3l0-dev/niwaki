...
class mdpLocalTenant(ManagedObject):
    """ACI Managed Object: ``mdpLocalTenant`` — Local Multi-Domain Tenant.

    RN format: ``mdpLocalTenant``
    """

    _aci_class: ClassVar[str] = "mdpLocalTenant"
    _rn_format: ClassVar[str] = "mdpLocalTenant"
