...
class mdpRsRemoteCtxDefToMultiDomCtxDef(ManagedObject):
    """ACI Managed Object: ``mdpRsRemoteCtxDefToMultiDomCtxDef`` — MDP Domain Remote Ctx reference.

    Relation to MultiDomCtxDef to get updated ScopeId

    RN format: ``rsremoteCtxDefToMultiDomCtxDef``
    """

    _aci_class: ClassVar[str] = "mdpRsRemoteCtxDefToMultiDomCtxDef"
    _rn_format: ClassVar[str] = "rsremoteCtxDefToMultiDomCtxDef"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3733": "fltMdpRsRemoteCtxDefToMultiDomCtxDefResolveFail",
    }
