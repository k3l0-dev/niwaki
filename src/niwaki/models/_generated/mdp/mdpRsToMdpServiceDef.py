...
class mdpRsToMdpServiceDef(ManagedObject):
    """ACI Managed Object: ``mdpRsToMdpServiceDef`` — MDP Service Def (resolved).

    RN format: ``rstoMdpServiceDef``
    """

    _aci_class: ClassVar[str] = "mdpRsToMdpServiceDef"
    _rn_format: ClassVar[str] = "rstoMdpServiceDef"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3854": "fltMdpRsToMdpServiceDefResolveFail",
    }
