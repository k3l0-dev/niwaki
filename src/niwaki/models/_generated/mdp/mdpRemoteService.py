...
class mdpRemoteService(ManagedObject):
    """ACI Managed Object: ``mdpRemoteService`` — Multi-Domain Imported Service.

    RN format: ``mdprsrv``
    """

    _aci_class: ClassVar[str] = "mdpRemoteService"
    _rn_format: ClassVar[str] = "mdprsrv"
