...
class mdpDomainPeeringPol(ManagedObject):
    """ACI Managed Object: ``mdpDomainPeeringPol`` — Domain Peering Policy.

    RN format: ``domainPeeringPol``
    """

    _aci_class: ClassVar[str] = "mdpDomainPeeringPol"
    _rn_format: ClassVar[str] = "domainPeeringPol"
