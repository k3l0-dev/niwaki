...
class coppIfPol(ManagedObject):
    """ACI Managed Object: ``coppIfPol`` — Per interface per protocol CoPP policy.

    RN format: ``coppifpol-{name}``
    """

    _aci_class: ClassVar[str] = "coppIfPol"
    _rn_format: ClassVar[str] = "coppifpol-{name}"
