...
class coppLeafProfile(ManagedObject):
    """ACI Managed Object: ``coppLeafProfile`` — CoPP Leaf Level Policy.

    RN format: ``coppleafp-{name}``
    """

    _aci_class: ClassVar[str] = "coppLeafProfile"
    _rn_format: ClassVar[str] = "coppleafp-{name}"
