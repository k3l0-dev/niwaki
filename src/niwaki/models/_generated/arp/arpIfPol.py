...
class arpIfPol(ManagedObject):
    """ACI Managed Object: ``arpIfPol`` — ARP Interface Policy.

    RN format: ``arpifpol-{name}``
    """

    _aci_class: ClassVar[str] = "arpIfPol"
    _rn_format: ClassVar[str] = "arpifpol-{name}"
