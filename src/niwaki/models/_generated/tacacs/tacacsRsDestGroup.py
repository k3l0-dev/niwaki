...
class tacacsRsDestGroup(ManagedObject):
    """ACI Managed Object: ``tacacsRsDestGroup`` — TACACS Destination Group.

    RN format: ``rsdestGroup``
    """

    _aci_class: ClassVar[str] = "tacacsRsDestGroup"
    _rn_format: ClassVar[str] = "rsdestGroup"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3088": "fltTacacsRsDestGroupResolveFail",
    }
