...
class l3EncRtdIfClearCountersLTask(ManagedObject):
    """ACI Managed Object: ``l3EncRtdIfClearCountersLTask``.

    RN format: ``l3EncRtdIfClearCountersLTask``
    """

    _aci_class: ClassVar[str] = "l3EncRtdIfClearCountersLTask"
    _rn_format: ClassVar[str] = "l3EncRtdIfClearCountersLTask"
