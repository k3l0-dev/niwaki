...
class l3IpCktEp(ManagedObject):
    """ACI Managed Object: ``l3IpCktEp`` — IP Circuit Endpoint.
    ...
    identifier_of_the_ip_circuit_endpoint: Annotated[
        str,
        Field(pattern="^[0-9a-fA-F.:/ ]+$", alias="addr", description="IP address of the endpoint"),
    ]
