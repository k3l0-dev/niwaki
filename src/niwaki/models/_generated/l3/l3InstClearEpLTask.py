...
class l3InstClearEpLTask(ManagedObject):
    """ACI Managed Object: ``l3InstClearEpLTask``.

    The instance of a task to clear all endpoints under a given bridge domain.

    RN format: ``l3InstClearEpLTask``
    """

    _aci_class: ClassVar[str] = "l3InstClearEpLTask"
    _rn_format: ClassVar[str] = "l3InstClearEpLTask"
