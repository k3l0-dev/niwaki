...
class l3LbRtdIfClearCountersLTask(ManagedObject):
    """ACI Managed Object: ``l3LbRtdIfClearCountersLTask``.

    RN format: ``l3LbRtdIfClearCountersLTask``
    """

    _aci_class: ClassVar[str] = "l3LbRtdIfClearCountersLTask"
    _rn_format: ClassVar[str] = "l3LbRtdIfClearCountersLTask"
