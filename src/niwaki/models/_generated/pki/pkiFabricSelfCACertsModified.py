...
class pkiFabricSelfCACertsModified(ManagedObject):
    """ACI Managed Object: ``pkiFabricSelfCACertsModified`` — To notify apps that Certs are modified.

    RN format: ``certmod``
    """

    _aci_class: ClassVar[str] = "pkiFabricSelfCACertsModified"
    _rn_format: ClassVar[str] = "certmod"
