...
class fcPinningLbl(ManagedObject):
    """ACI Managed Object: ``fcPinningLbl`` — Fibre Channel Uplink Pinning Label.

    RN format: ``pinninglbl-{name}``
    """

    _aci_class: ClassVar[str] = "fcPinningLbl"
    _rn_format: ClassVar[str] = "pinninglbl-{name}"
