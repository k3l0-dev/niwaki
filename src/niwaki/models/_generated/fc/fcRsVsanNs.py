...
class fcRsVsanNs(ManagedObject):
    """ACI Managed Object: ``fcRsVsanNs`` — Relation to VSAN Pool.

    RN format: ``rsvsanNs``
    """

    _aci_class: ClassVar[str] = "fcRsVsanNs"
    _rn_format: ClassVar[str] = "rsvsanNs"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2284": "fltFcRsVsanNsResolveFail",
    }
