...
class fcPinningP(ManagedObject):
    """ACI Managed Object: ``fcPinningP`` — Fibre Channel Uplink Pinning Group Profile.

    Fiber Channel Pinning Profile. Its used for pinning host interfaces to uplink interfaces.

    RN format: ``pinningp-{name}``
    """

    _aci_class: ClassVar[str] = "fcPinningP"
    _rn_format: ClassVar[str] = "pinningp-{name}"
