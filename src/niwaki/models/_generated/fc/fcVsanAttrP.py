...
class fcVsanAttrP(ManagedObject):
    """ACI Managed Object: ``fcVsanAttrP`` — VSAN Attributes.

    RN format: ``vsanattrp-[{name}]``
    """

    _aci_class: ClassVar[str] = "fcVsanAttrP"
    _rn_format: ClassVar[str] = "vsanattrp-[{name}]"
