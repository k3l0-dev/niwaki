...
class statsTunnel(ManagedObject):
    """ACI Managed Object: ``statsTunnel``.

    RN format: ``tun-{id}``
    """

    _aci_class: ClassVar[str] = "statsTunnel"
    _rn_format: ClassVar[str] = "tun-{id}"
    ...
    # ── Naming (required) ──────────────────────────────────────────────────────
    id: Annotated[str, Field(min_length=1, max_length=512, description="An object identifier.")]
