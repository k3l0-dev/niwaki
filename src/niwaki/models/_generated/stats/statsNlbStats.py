...
class statsNlbStats(ManagedObject):
    """ACI Managed Object: ``statsNlbStats`` — Network Service NLB Service.

    RN format: ``nlbstats-{name}``
    """

    _aci_class: ClassVar[str] = "statsNlbStats"
    _rn_format: ClassVar[str] = "nlbstats-{name}"
