...
class statsALbStats(ManagedObject):
    """ACI Managed Object: ``statsALbStats`` — Native Service LB Service.

    RN format: ``albstats-{name}``
    """

    _aci_class: ClassVar[str] = "statsALbStats"
    _rn_format: ClassVar[str] = "albstats-{name}"
