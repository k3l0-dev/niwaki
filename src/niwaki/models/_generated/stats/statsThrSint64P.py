...
class statsThrSint64P(ManagedObject):
    """ACI Managed Object: ``statsThrSint64P`` — Base Threshold Policy Definition.

    RN format: ``thrSint64-{property}``
    """

    _aci_class: ClassVar[str] = "statsThrSint64P"
    _rn_format: ClassVar[str] = "thrSint64-{property}"
