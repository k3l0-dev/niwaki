...
class statsThrUint64P(ManagedObject):
    """ACI Managed Object: ``statsThrUint64P`` — Base Threshold Policy Definition.

    The concrete statistical threshold policy for a 64-bit unsigned integer data type.

    RN format: ``thrUint64-{property}``
    """

    _aci_class: ClassVar[str] = "statsThrUint64P"
    _rn_format: ClassVar[str] = "thrUint64-{property}"
