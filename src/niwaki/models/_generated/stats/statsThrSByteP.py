...
class statsThrSByteP(ManagedObject):
    """ACI Managed Object: ``statsThrSByteP`` — Base Threshold Policy Definition.

    The concrete statistical threshold policy for a signed byte data type.

    RN format: ``thrSByte-{property}``
    """

    _aci_class: ClassVar[str] = "statsThrSByteP"
    _rn_format: ClassVar[str] = "thrSByte-{property}"
