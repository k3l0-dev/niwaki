...
class statsThrSint16P(ManagedObject):
    """ACI Managed Object: ``statsThrSint16P`` — Base Threshold Policy Definition.

    The concrete statistical threshold policy for a 16-bit signed Int data type.

    RN format: ``thrSint16-{property}``
    """

    _aci_class: ClassVar[str] = "statsThrSint16P"
    _rn_format: ClassVar[str] = "thrSint16-{property}"
