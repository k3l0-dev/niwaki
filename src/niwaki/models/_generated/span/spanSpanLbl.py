...
class spanSpanLbl(ManagedObject):
    """ACI Managed Object: ``spanSpanLbl`` — SPAN Source-destination Group Match Label.

    The SPAN label is used for SPAN label parameters.

    RN format: ``spanlbl-{name}``
    """

    _aci_class: ClassVar[str] = "spanSpanLbl"
    _rn_format: ClassVar[str] = "spanlbl-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the label that is used to match SPAN sources with SPAN destination(s).",
        ),
    ]
