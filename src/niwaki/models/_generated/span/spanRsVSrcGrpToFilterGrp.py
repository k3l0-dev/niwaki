...
class spanRsVSrcGrpToFilterGrp(ManagedObject):
    """ACI Managed Object: ``spanRsVSrcGrpToFilterGrp`` — Relation from VSPAN Source Grp to span FilterGrp.

    Relation to FilterGrp. Used by OVS agent

    RN format: ``rsvSrcGrpToFilterGrp``
    """

    _aci_class: ClassVar[str] = "spanRsVSrcGrpToFilterGrp"
    _rn_format: ClassVar[str] = "rsvSrcGrpToFilterGrp"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3661": "fltSpanRsVSrcGrpToFilterGrpResolveFail",
    }
