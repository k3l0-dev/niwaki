...
class spanVDestGrp(ManagedObject):
    """ACI Managed Object: ``spanVDestGrp`` — VSPAN Destination Group.
    ...
    RN format: ``vdestgrp-{name}``
    """

    _aci_class: ClassVar[str] = "spanVDestGrp"
    _rn_format: ClassVar[str] = "vdestgrp-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the VSPAN destination group.",
        ),
    ]
