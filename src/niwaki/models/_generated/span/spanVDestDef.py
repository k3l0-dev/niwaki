...
class spanVDestDef(ManagedObject):
    """ACI Managed Object: ``spanVDestDef`` — SPAN Destination.

    The VLAN-based SPAN (VSPAN) destination definition.

    RN format: ``vdestdef-{name}``
    """

    _aci_class: ClassVar[str] = "spanVDestDef"
    _rn_format: ClassVar[str] = "vdestdef-{name}"
