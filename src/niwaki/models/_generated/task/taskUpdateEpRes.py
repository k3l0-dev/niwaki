...
class taskUpdateEpRes(ManagedObject):
    """ACI Managed Object: ``taskUpdateEpRes`` — UpdateEpResTask.

    RN format: ``TaskUpdateEpRes``
    """

    _aci_class: ClassVar[str] = "taskUpdateEpRes"
    _rn_format: ClassVar[str] = "TaskUpdateEpRes"
