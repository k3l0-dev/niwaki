...
class taskUpdateSgRes(ManagedObject):
    """ACI Managed Object: ``taskUpdateSgRes`` — UpdateSgResTask.

    RN format: ``TaskUpdateSgRes``
    """

    _aci_class: ClassVar[str] = "taskUpdateSgRes"
    _rn_format: ClassVar[str] = "TaskUpdateSgRes"
