...
class taskDeployCtx(ManagedObject):
    """ACI Managed Object: ``taskDeployCtx`` — DeployCtxTask.

    RN format: ``TaskDeployCtx``
    """

    _aci_class: ClassVar[str] = "taskDeployCtx"
    _rn_format: ClassVar[str] = "TaskDeployCtx"
