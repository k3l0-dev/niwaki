...
class taskRemoveSubnet(ManagedObject):
    """ACI Managed Object: ``taskRemoveSubnet`` — RemoveSubnetTask.

    RN format: ``TaskRemoveSubnet``
    """

    _aci_class: ClassVar[str] = "taskRemoveSubnet"
    _rn_format: ClassVar[str] = "TaskRemoveSubnet"
