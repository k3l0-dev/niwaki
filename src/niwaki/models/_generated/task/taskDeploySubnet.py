...
class taskDeploySubnet(ManagedObject):
    """ACI Managed Object: ``taskDeploySubnet`` — DeploySubnetTask.

    RN format: ``TaskDeploySubnet``
    """

    _aci_class: ClassVar[str] = "taskDeploySubnet"
    _rn_format: ClassVar[str] = "TaskDeploySubnet"
