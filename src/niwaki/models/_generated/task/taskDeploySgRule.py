...
class taskDeploySgRule(ManagedObject):
    """ACI Managed Object: ``taskDeploySgRule`` — DeploySgRuleTask.

    RN format: ``TaskDeploySgRule``
    """

    _aci_class: ClassVar[str] = "taskDeploySgRule"
    _rn_format: ClassVar[str] = "TaskDeploySgRule"
