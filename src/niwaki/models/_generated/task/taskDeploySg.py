...
class taskDeploySg(ManagedObject):
    """ACI Managed Object: ``taskDeploySg`` — DeploySgTask.

    RN format: ``TaskDeploySg``
    """

    _aci_class: ClassVar[str] = "taskDeploySg"
    _rn_format: ClassVar[str] = "TaskDeploySg"
