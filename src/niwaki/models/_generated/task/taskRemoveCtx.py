...
class taskRemoveCtx(ManagedObject):
    """ACI Managed Object: ``taskRemoveCtx`` — RemoveCtxTask.

    RN format: ``TaskRemoveCtx``
    """

    _aci_class: ClassVar[str] = "taskRemoveCtx"
    _rn_format: ClassVar[str] = "TaskRemoveCtx"
