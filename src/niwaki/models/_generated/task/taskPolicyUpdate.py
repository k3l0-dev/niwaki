...
class taskPolicyUpdate(ManagedObject):
    """ACI Managed Object: ``taskPolicyUpdate`` — PolicyUpdateTask.

    RN format: ``TaskPolicyUpdate``
    """

    _aci_class: ClassVar[str] = "taskPolicyUpdate"
    _rn_format: ClassVar[str] = "TaskPolicyUpdate"
