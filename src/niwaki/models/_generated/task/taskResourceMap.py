...
class taskResourceMap(ManagedObject):
    """ACI Managed Object: ``taskResourceMap`` — ResourceMapTask.

    Task objects

    RN format: ``TaskResourceMap``
    """

    _aci_class: ClassVar[str] = "taskResourceMap"
    _rn_format: ClassVar[str] = "TaskResourceMap"
