...
class taskRemoveCsr(ManagedObject):
    """ACI Managed Object: ``taskRemoveCsr`` — RemoveCsrTask.

    RN format: ``TaskRemoveCsr``
    """

    _aci_class: ClassVar[str] = "taskRemoveCsr"
    _rn_format: ClassVar[str] = "TaskRemoveCsr"
