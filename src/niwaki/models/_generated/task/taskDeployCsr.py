...
class taskDeployCsr(ManagedObject):
    """ACI Managed Object: ``taskDeployCsr`` — DeployCsrTask.

    RN format: ``TaskDeployCsr``
    """

    _aci_class: ClassVar[str] = "taskDeployCsr"
    _rn_format: ClassVar[str] = "TaskDeployCsr"
