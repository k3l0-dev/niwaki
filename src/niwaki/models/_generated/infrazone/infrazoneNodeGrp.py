...
class infrazoneNodeGrp(ManagedObject):
    """ACI Managed Object: ``infrazoneNodeGrp`` — Infrastructure Zone Node Group.

    Infrastructure Zone Node Group: Used for listing member nodes of the zone

    RN format: ``nodegrp-{name}``
    """

    _aci_class: ClassVar[str] = "infrazoneNodeGrp"
    _rn_format: ClassVar[str] = "nodegrp-{name}"
