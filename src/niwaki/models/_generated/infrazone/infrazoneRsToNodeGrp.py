...
class infrazoneRsToNodeGrp(ManagedObject):
    """ACI Managed Object: ``infrazoneRsToNodeGrp`` — Infrastructure Zone Node Group.

    RN format: ``rstoNodeGrp-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "infrazoneRsToNodeGrp"
    _rn_format: ClassVar[str] = "rstoNodeGrp-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1993": "fltInfrazoneRsToNodeGrpResolveFail",
    }
