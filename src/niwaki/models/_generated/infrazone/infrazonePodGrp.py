...
class infrazonePodGrp(ManagedObject):
    """ACI Managed Object: ``infrazonePodGrp`` — Zone POD Group.

    POD Group

    RN format: ``podgrp-{name}``
    """

    _aci_class: ClassVar[str] = "infrazonePodGrp"
    _rn_format: ClassVar[str] = "podgrp-{name}"
