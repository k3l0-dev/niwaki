...
class quotaCont(ManagedObject):
    """ACI Managed Object: ``quotaCont`` — Container for Quota Configuration.

    Container for quota configurations

    RN format: ``quotacont``
    """

    _aci_class: ClassVar[str] = "quotaCont"
    _rn_format: ClassVar[str] = "quotacont"
