...
class faultThrValueSByte(ManagedObject):
    """ACI Managed Object: ``faultThrValueSByte``.

    The threshold value Sbyte.

    RN format: ``thrValSByte-{property}``
    """

    _aci_class: ClassVar[str] = "faultThrValueSByte"
    _rn_format: ClassVar[str] = "thrValSByte-{property}"
