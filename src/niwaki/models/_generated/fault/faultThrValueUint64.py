...
class faultThrValueUint64(ManagedObject):
    """ACI Managed Object: ``faultThrValueUint64``.

    The threshold value uint 64.

    RN format: ``thrValUint64-{property}``
    """

    _aci_class: ClassVar[str] = "faultThrValueUint64"
    _rn_format: ClassVar[str] = "thrValUint64-{property}"
