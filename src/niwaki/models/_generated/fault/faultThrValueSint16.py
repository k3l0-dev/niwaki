...
class faultThrValueSint16(ManagedObject):
    """ACI Managed Object: ``faultThrValueSint16``.

    The threshold value Service Interface Notification Statistics (SINT) 16.

    RN format: ``thrValSint16-{property}``
    """

    _aci_class: ClassVar[str] = "faultThrValueSint16"
    _rn_format: ClassVar[str] = "thrValSint16-{property}"
