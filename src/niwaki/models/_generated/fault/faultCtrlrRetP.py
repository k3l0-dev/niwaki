...
class faultCtrlrRetP(ManagedObject):
    """ACI Managed Object: ``faultCtrlrRetP`` — Controller Fault Retention Policy.
    ...
    _aci_class: ClassVar[str] = "faultCtrlrRetP"
    _rn_format: ClassVar[str] = "ifcfretp"
    ...
    maximum_size: Annotated[
        ...
        Field(
            ...
            le=500000,
            alias="maxSize",
            description="The maximum number of records to be maintained in the fault log.",
        ),
    ] = 100000
