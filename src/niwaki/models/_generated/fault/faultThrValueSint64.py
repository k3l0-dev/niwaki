...
class faultThrValueSint64(ManagedObject):
    """ACI Managed Object: ``faultThrValueSint64``.

    The threshold value Service Interface Notification Statistics (SINT) 64.

    RN format: ``thrValSint64-{property}``
    """

    _aci_class: ClassVar[str] = "faultThrValueSint64"
    _rn_format: ClassVar[str] = "thrValSint64-{property}"
