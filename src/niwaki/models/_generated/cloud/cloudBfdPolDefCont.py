...
class cloudBfdPolDefCont(ManagedObject):
    """ACI Managed Object: ``cloudBfdPolDefCont`` — Resolved BFD Policy Container.

    RN format: ``bfdpoldefcont``
    """

    _aci_class: ClassVar[str] = "cloudBfdPolDefCont"
    _rn_format: ClassVar[str] = "bfdpoldefcont"
