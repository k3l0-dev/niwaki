...
class cloudRsLDevToComputePol(ManagedObject):
    """ACI Managed Object: ``cloudRsLDevToComputePol`` — Relation from Cloud LDev to Compute Instance Policy.

    RN format: ``rsLDevToComputePol``
    """
