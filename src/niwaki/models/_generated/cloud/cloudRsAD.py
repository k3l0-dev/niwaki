...
class cloudRsAD(ManagedObject):
    """ACI Managed Object: ``cloudRsAD`` — Attachment to billing account.

    (Azure only, relation to active directory)

    RN format: ``rsAD``
    """

    _aci_class: ClassVar[str] = "cloudRsAD"
    _rn_format: ClassVar[str] = "rsAD"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3605": "fltCloudRsADResolveFail",
    }
