...
class cloudBfdPol(ManagedObject):
    """ACI Managed Object: ``cloudBfdPol`` — Tenant BFD Policy.

    RN format: ``bfdPol-{name}``
    """

    _aci_class: ClassVar[str] = "cloudBfdPol"
    _rn_format: ClassVar[str] = "bfdPol-{name}"
