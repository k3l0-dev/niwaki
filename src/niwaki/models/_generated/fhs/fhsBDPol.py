...
class fhsBDPol(ManagedObject):
    """ACI Managed Object: ``fhsBDPol`` — FHS BD Policy.

    RN format: ``bdpol-{name}``
    """

    _aci_class: ClassVar[str] = "fhsBDPol"
    _rn_format: ClassVar[str] = "bdpol-{name}"
