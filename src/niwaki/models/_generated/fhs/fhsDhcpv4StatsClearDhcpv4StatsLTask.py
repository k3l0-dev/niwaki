...
class fhsDhcpv4StatsClearDhcpv4StatsLTask(ManagedObject):
    """ACI Managed Object: ``fhsDhcpv4StatsClearDhcpv4StatsLTask``.

    RN format: ``fhsDhcpv4StatsClearDhcpv4StatsLTask``
    """

    _aci_class: ClassVar[str] = "fhsDhcpv4StatsClearDhcpv4StatsLTask"
    _rn_format: ClassVar[str] = "fhsDhcpv4StatsClearDhcpv4StatsLTask"
