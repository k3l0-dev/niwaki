...
class fhsArpStatsClearArpStatsLTask(ManagedObject):
    """ACI Managed Object: ``fhsArpStatsClearArpStatsLTask``.

    RN format: ``fhsArpStatsClearArpStatsLTask``
    """

    _aci_class: ClassVar[str] = "fhsArpStatsClearArpStatsLTask"
    _rn_format: ClassVar[str] = "fhsArpStatsClearArpStatsLTask"
