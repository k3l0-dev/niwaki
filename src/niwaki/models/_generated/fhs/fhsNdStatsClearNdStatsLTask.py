...
class fhsNdStatsClearNdStatsLTask(ManagedObject):
    """ACI Managed Object: ``fhsNdStatsClearNdStatsLTask``.

    RN format: ``fhsNdStatsClearNdStatsLTask``
    """

    _aci_class: ClassVar[str] = "fhsNdStatsClearNdStatsLTask"
    _rn_format: ClassVar[str] = "fhsNdStatsClearNdStatsLTask"
