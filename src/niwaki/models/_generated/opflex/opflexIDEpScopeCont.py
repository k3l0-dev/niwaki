...
class opflexIDEpScopeCont(ManagedObject):
    """ACI Managed Object: ``opflexIDEpScopeCont``.

    RN format: ``scopecont``
    """

    _aci_class: ClassVar[str] = "opflexIDEpScopeCont"
    _rn_format: ClassVar[str] = "scopecont"
