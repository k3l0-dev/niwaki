...
class opflexODevCliCmdResp(ManagedObject):
    """ACI Managed Object: ``opflexODevCliCmdResp``.

    RN format: ``resp``
    """

    _aci_class: ClassVar[str] = "opflexODevCliCmdResp"
    _rn_format: ClassVar[str] = "resp"
