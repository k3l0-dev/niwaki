...
class opflexODevCliCmdCont(ManagedObject):
    """ACI Managed Object: ``opflexODevCliCmdCont``.

    RN format: ``clicmdcont``
    """

    _aci_class: ClassVar[str] = "opflexODevCliCmdCont"
    _rn_format: ClassVar[str] = "clicmdcont"
