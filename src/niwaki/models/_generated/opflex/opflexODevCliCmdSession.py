...
class opflexODevCliCmdSession(ManagedObject):
    """ACI Managed Object: ``opflexODevCliCmdSession``.

    RN format: ``session-{session_id}``
    """

    _aci_class: ClassVar[str] = "opflexODevCliCmdSession"
    _rn_format: ClassVar[str] = "session-{session_id}"
    _naming_props: ClassVar[list[str]] = ["session_id"]
    ...
    session_id: Annotated[
        int, Field(validation_alias="sessionId", serialization_alias="sessionId")
    ] = 0
