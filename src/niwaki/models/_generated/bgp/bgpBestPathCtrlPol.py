...
class bgpBestPathCtrlPol(ManagedObject):
    """ACI Managed Object: ``bgpBestPathCtrlPol`` — BGP Best Path Control policy.

    RN format: ``bestpath-{name}``
    """

    _aci_class: ClassVar[str] = "bgpBestPathCtrlPol"
    _rn_format: ClassVar[str] = "bestpath-{name}"
    ...
    best_path_control: BgpPathCtrlType = Field(
        default=BgpPathCtrlType.ASPATHMULTIPATHRELAX, alias="ctrl", description="Best Path control"
    )
