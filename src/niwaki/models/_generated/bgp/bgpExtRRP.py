...
class bgpExtRRP(ManagedObject):
    """ACI Managed Object: ``bgpExtRRP`` — Route Reflector Profile.

    External Route Reflector Profile

    RN format: ``extrr``
    """

    _aci_class: ClassVar[str] = "bgpExtRRP"
    _rn_format: ClassVar[str] = "extrr"
