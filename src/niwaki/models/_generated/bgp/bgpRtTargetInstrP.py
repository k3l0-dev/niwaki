...
class bgpRtTargetInstrP(ManagedObject):
    """ACI Managed Object: ``bgpRtTargetInstrP`` — Route Target Instrumentation Profile.

    BGP Route Target Instrumentation Profile

    RN format: ``rttargetinstrp``
    """

    _aci_class: ClassVar[str] = "bgpRtTargetInstrP"
    _rn_format: ClassVar[str] = "rttargetinstrp"
    ...
    route_target_instrumentation_type: BgpRtTargetT = Field(
        default=BgpRtTargetT.EXPLICIT,
        validation_alias="rtTargetT",
        serialization_alias="rtTargetT",
        description="Route Target Instrumentation Type",
    )
