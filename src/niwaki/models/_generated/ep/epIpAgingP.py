...
class epIpAgingP(ManagedObject):
    """ACI Managed Object: ``epIpAgingP`` — IP Aging Policy.

    RN format: ``ipAgingP-{name}``
    """

    _aci_class: ClassVar[str] = "epIpAgingP"
    _rn_format: ClassVar[str] = "ipAgingP-{name}"
    ...
    admin_state: NwAdminSt = Field(
        default=NwAdminSt.DISABLED, alias="adminSt", description="Enable/disable IP aging feature"
    )
