...
class hsrpRsGroupPol(ManagedObject):
    """ACI Managed Object: ``hsrpRsGroupPol`` — Group Policy.

    Relationship to the HSRP Group policy

    RN format: ``rsGroupPol``
    """

    _aci_class: ClassVar[str] = "hsrpRsGroupPol"
    _rn_format: ClassVar[str] = "rsGroupPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2459": "fltHsrpRsGroupPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnHsrpGroupPolName",
            serialization_alias="tnHsrpGroupPolName",
        ),
    ] = ""
