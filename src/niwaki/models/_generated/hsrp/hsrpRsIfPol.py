...
class hsrpRsIfPol(ManagedObject):
    """ACI Managed Object: ``hsrpRsIfPol`` — Interface Policy.

    Relationship to the HSRP interface policy

    RN format: ``rsIfPol``
    """

    _aci_class: ClassVar[str] = "hsrpRsIfPol"
    _rn_format: ClassVar[str] = "rsIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2460": "fltHsrpRsIfPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnHsrpIfPolName",
            serialization_alias="tnHsrpIfPolName",
        ),
    ] = ""
