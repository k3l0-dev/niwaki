...
class orchsLdevCont(ManagedObject):
    """ACI Managed Object: ``orchsLdevCont`` — Container for LDevVips.

    RN format: ``ldevcont``
    """

    _aci_class: ClassVar[str] = "orchsLdevCont"
    _rn_format: ClassVar[str] = "ldevcont"
