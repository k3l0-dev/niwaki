...
class orchsRsLDevItem(ManagedObject):
    """ACI Managed Object: ``orchsRsLDevItem`` — Logical L4-L7 Device.

    Association from Local Resource to Real Resource

    RN format: ``rsLDevItem-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "orchsRsLDevItem"
    _rn_format: ClassVar[str] = "rsLDevItem-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2631": "fltOrchsRsLDevItemResolveFail",
    }
