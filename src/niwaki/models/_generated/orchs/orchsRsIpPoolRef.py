...
class orchsRsIpPoolRef(ManagedObject):
    """ACI Managed Object: ``orchsRsIpPoolRef`` — External IP Address Pool.

    Association from Local Resource to Real Resource

    RN format: ``rsIpPoolRef``
    """

    _aci_class: ClassVar[str] = "orchsRsIpPoolRef"
    _rn_format: ClassVar[str] = "rsIpPoolRef"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2635": "fltOrchsRsIpPoolRefResolveFail",
    }
    ...
    type: FvIpLoc = Field(
        ...
        description="This should only be External now, since Internal will just be a template which PyQuery Creates",
    )
