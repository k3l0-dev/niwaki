...
class orchsRsToMdev(ManagedObject):
    """ACI Managed Object: ``orchsRsToMdev`` — Association to Mdev.

    Association from Local Resource to Mdev

    RN format: ``rstoMdev-[{target_dn}]``
    """
