...
class orchsRsAbsGraphRef(ManagedObject):
    """ACI Managed Object: ``orchsRsAbsGraphRef`` — Common Graph Template.

    Association from Local Resource to Real Resource

    RN format: ``rsabsGraphRef-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "orchsRsAbsGraphRef"
    _rn_format: ClassVar[str] = "rsabsGraphRef-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2889": "fltOrchsRsAbsGraphRefResolveFail",
    }
