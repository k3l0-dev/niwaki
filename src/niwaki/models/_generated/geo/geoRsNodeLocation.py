...
class geoRsNodeLocation(ManagedObject):
    """ACI Managed Object: ``geoRsNodeLocation`` — Relation to Fabric Node.

    A source relation to the node belonging to this rack.

    RN format: ``rsnodeLocation-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "geoRsNodeLocation"
    _rn_format: ClassVar[str] = "rsnodeLocation-[{target_dn}]"
