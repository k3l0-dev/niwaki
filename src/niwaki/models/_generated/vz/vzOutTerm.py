...
class vzOutTerm(ManagedObject):
    """ACI Managed Object: ``vzOutTerm`` — OutTerm Subject.
    ...
    _aci_class: ClassVar[str] = "vzOutTerm"
    ...
    terminal_level_dscp: Annotated[
        ...
        Field(
            ...
            description="Terminal level dscp value",
        ),
    ] = "unspecified"
