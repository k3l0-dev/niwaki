...
class vzRsOutTermGraphAtt(ManagedObject):
    """ACI Managed Object: ``vzRsOutTermGraphAtt`` — L4-L7 Service Graph Template.
    ...
    RN format: ``rsOutTermGraphAtt``
    """

    _aci_class: ClassVar[str] = "vzRsOutTermGraphAtt"
    _rn_format: ClassVar[str] = "rsOutTermGraphAtt"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1126": "fltVzRsOutTermGraphAttResolveFail",
    }
