...
class vzRsSdwanPol(ManagedObject):
    """ACI Managed Object: ``vzRsSdwanPol`` — Relation to SDWAN SLA Policy.

    Relationship to SDWan SLA Policy

    RN format: ``rsSdwanPol``
    """

    _aci_class: ClassVar[str] = "vzRsSdwanPol"
    _rn_format: ClassVar[str] = "rsSdwanPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3330": "fltVzRsSdwanPolResolveFail",
    }
