...
class qinqCktEpClearEpLTask(ManagedObject):
    """ACI Managed Object: ``qinqCktEpClearEpLTask``.

    RN format: ``qinqCktEpClearEpLTask``
    """

    _aci_class: ClassVar[str] = "qinqCktEpClearEpLTask"
    _rn_format: ClassVar[str] = "qinqCktEpClearEpLTask"
