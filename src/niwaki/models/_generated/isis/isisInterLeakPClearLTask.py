...
class isisInterLeakPClearLTask(ManagedObject):
    """ACI Managed Object: ``isisInterLeakPClearLTask``.

    The Inter Leak Protocol Clear Link Task.

    RN format: ``isisInterLeakPClearLTask``
    """

    _aci_class: ClassVar[str] = "isisInterLeakPClearLTask"
    _rn_format: ClassVar[str] = "isisInterLeakPClearLTask"
