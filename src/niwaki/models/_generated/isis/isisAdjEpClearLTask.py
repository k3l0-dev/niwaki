...
class isisAdjEpClearLTask(ManagedObject):
    """ACI Managed Object: ``isisAdjEpClearLTask``.

    A task that clears the IS-IS adjacency endpoint entries associated with the specified neighbor.

    RN format: ``isisAdjEpClearLTask``
    """

    _aci_class: ClassVar[str] = "isisAdjEpClearLTask"
    _rn_format: ClassVar[str] = "isisAdjEpClearLTask"
