...
class l2extDomP(ManagedObject):
    """ACI Managed Object: ``l2extDomP`` — L2 Domain Profile.
    ...
    _aci_class: ClassVar[str] = "l2extDomP"
    _rn_format: ClassVar[str] = "l2dom-{name}"
