...
class dbgacRsToEpg(ManagedObject):
    """ACI Managed Object: ``dbgacRsToEpg`` — Destination EPG Relation for Atomic Counter Policy.

    A source relation to the set of requirements for an application-level endpoint group instance.

    RN format: ``rstoEpg-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "dbgacRsToEpg"
    _rn_format: ClassVar[str] = "rstoEpg-[{target_dn}]"
