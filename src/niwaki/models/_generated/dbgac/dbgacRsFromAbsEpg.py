...
class dbgacRsFromAbsEpg(ManagedObject):
    """ACI Managed Object: ``dbgacRsFromAbsEpg`` — Source L3Out EPG Relation for Atomic Counter Policy.

    RN format: ``rsfromAbsEpg-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "dbgacRsFromAbsEpg"
    _rn_format: ClassVar[str] = "rsfromAbsEpg-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1691": "fltDbgacRsFromAbsEpgResolveFail",
    }
