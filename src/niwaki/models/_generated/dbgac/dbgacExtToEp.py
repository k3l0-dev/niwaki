...
class dbgacExtToEp(ManagedObject):
    """ACI Managed Object: ``dbgacExtToEp`` — Ext IP Address to End-Point Atomic Counter Policy.
    ...
    RN format: ``acExtToEp-{name}``
    """

    _aci_class: ClassVar[str] = "dbgacExtToEp"
    _rn_format: ClassVar[str] = "acExtToEp-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the external host-to-endpoint atomic counter policy definition. This name can be between 1 and 64 alphanumeric characters. Note that you cannot change this name after the object has been saved.",
        ),
    ]
