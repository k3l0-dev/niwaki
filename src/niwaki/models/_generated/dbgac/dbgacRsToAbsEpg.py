...
class dbgacRsToAbsEpg(ManagedObject):
    """ACI Managed Object: ``dbgacRsToAbsEpg`` — Destination L3Out EPG Relation for Atomic Counter Policy.

    RN format: ``rstoAbsEpg-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "dbgacRsToAbsEpg"
    _rn_format: ClassVar[str] = "rstoAbsEpg-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1692": "fltDbgacRsToAbsEpgResolveFail",
    }
