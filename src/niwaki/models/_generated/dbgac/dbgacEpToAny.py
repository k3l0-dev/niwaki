...
class dbgacEpToAny(ManagedObject):
    """ACI Managed Object: ``dbgacEpToAny`` — End-Point to any Atomic Counter Policy.
    ...
    RN format: ``acEpToAny-{name}``
    """

    _aci_class: ClassVar[str] = "dbgacEpToAny"
    _rn_format: ClassVar[str] = "acEpToAny-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the endpoint-to-any atomic counter policy definition. This name can be between 1 and 64 alphanumeric characters. Note that you cannot change this name after the object has been saved.",
        ),
    ]
