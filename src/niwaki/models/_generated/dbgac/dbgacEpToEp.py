...
class dbgacEpToEp(ManagedObject):
    """ACI Managed Object: ``dbgacEpToEp`` — End-Point to End-Point Atomic Counter Policy.
    ...
    RN format: ``acEpToEp-{name}``
    """

    _aci_class: ClassVar[str] = "dbgacEpToEp"
    _rn_format: ClassVar[str] = "acEpToEp-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the endpoint-to-endpoint atomic counter policy definition. This name can be between 1 and 64 alphanumeric characters. Note that you cannot change this name after the object has been saved.",
        ),
    ]
