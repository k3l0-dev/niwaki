...
class dbgacIpToEpg(ManagedObject):
    """ACI Managed Object: ``dbgacIpToEpg`` — From an ExtIpernal IP Address to an EPG Atomic                        Counter Policy.
    ...
    RN format: ``ipToEpg-{name}``
    """

    _aci_class: ClassVar[str] = "dbgacIpToEpg"
    _rn_format: ClassVar[str] = "ipToEpg-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the IP address-to-endpoint group host atomic counter policy definition. This name can be between 1 and 64 alphanumeric characters. Note that you cannot change this name after the object has been saved.",
        ),
    ]
    ...
    source_ip: Annotated[
        str,
        Field(pattern="^[0-9a-fA-F.:/ ]+$", alias="srcIp", description="The source IP address."),
    ] = ""
