...
class dbgacRsFromEp(ManagedObject):
    """ACI Managed Object: ``dbgacRsFromEp`` — Source Ep Relation for Atomic Counter Policy.

    A source relation to the client endpoint attaching to the network.

    RN format: ``rsfromEp-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "dbgacRsFromEp"
    _rn_format: ClassVar[str] = "rsfromEp-[{target_dn}]"
