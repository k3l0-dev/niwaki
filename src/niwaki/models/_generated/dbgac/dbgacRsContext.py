...
class dbgacRsContext(ManagedObject):
    """ACI Managed Object: ``dbgacRsContext`` — Context Name.
    ...
    _aci_class: ClassVar[str] = "dbgacRsContext"
    _rn_format: ClassVar[str] = "rscontext"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2031": "fltDbgacRsContextResolveFail",
    }
