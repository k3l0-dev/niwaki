...
class dbgacEpToExt(ManagedObject):
    """ACI Managed Object: ``dbgacEpToExt`` — End-Point to Ext. IP Address Atomic Counter Policy.
    ...
    RN format: ``acEpToExt-{name}``
    """

    _aci_class: ClassVar[str] = "dbgacEpToExt"
    _rn_format: ClassVar[str] = "acEpToExt-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the endpoint-to-external host atomic counter policy definition. This name can be between 1 and 64 alphanumeric characters. Note that you cannot change this name after the object has been saved.",
        ),
    ]
