...
class aaaFactoryRole(ManagedObject):
    """ACI Managed Object: ``aaaFactoryRole`` — Role.

    RN format: ``factoryrole-{name}``
    """

    _aci_class: ClassVar[str] = "aaaFactoryRole"
    _rn_format: ClassVar[str] = "factoryrole-{name}"
