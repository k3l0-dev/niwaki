...
class aaaRsToSnInbEpg(ManagedObject):
    """ACI Managed Object: ``aaaRsToSnInbEpg`` — Inband Management to be used for talking to service engine.

    Association with the inband epg

    RN format: ``rstoSnInbEpg``
    """
