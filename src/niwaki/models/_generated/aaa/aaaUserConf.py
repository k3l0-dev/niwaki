...
class aaaUserConf(ManagedObject):
    """ACI Managed Object: ``aaaUserConf`` — User Configurationi Root.

    RN format: ``userconf``
    """

    _aci_class: ClassVar[str] = "aaaUserConf"
    _rn_format: ClassVar[str] = "userconf"
