...
class aaaActiveUserSession(ManagedObject):
    """ACI Managed Object: ``aaaActiveUserSession`` — User Token.

    RN format: ``actsession-{token_identifier}``
    """

    _aci_class: ClassVar[str] = "aaaActiveUserSession"
    _rn_format: ClassVar[str] = "actsession-{token_identifier}"
