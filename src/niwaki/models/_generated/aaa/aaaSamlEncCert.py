...
class aaaSamlEncCert(ManagedObject):
    """ACI Managed Object: ``aaaSamlEncCert`` — Key pair for SAML Encryption.

    RN format: ``samlenccert-{name}``
    """
    ...
    regenerate_encryption_key_pair: bool = Field(
        default=False, validation_alias="regenerate", serialization_alias="regenerate"
    )
