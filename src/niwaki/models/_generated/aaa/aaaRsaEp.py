...
class aaaRsaEp(ManagedObject):
    """ACI Managed Object: ``aaaRsaEp`` — Default RSA Authentication Settings.

    RN format: ``rsaext``
    """

    _aci_class: ClassVar[str] = "aaaRsaEp"
    _rn_format: ClassVar[str] = "rsaext"
