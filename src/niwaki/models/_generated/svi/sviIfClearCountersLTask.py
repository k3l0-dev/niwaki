...
class sviIfClearCountersLTask(ManagedObject):
    """ACI Managed Object: ``sviIfClearCountersLTask``.

    RN format: ``sviIfClearCountersLTask``
    """

    _aci_class: ClassVar[str] = "sviIfClearCountersLTask"
    _rn_format: ClassVar[str] = "sviIfClearCountersLTask"
