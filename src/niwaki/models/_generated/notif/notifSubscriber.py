...
class notifSubscriber(ManagedObject):
    ...
    name_of_the_subscriber: Annotated[
        str, Field(min_length=1, max_length=512, alias="subscriberName")
    ]
    ...
    type_of_notification_channel: Annotated[str, Field(max_length=512, alias="channelName")] = ""
    notif_channel: str = Field(default="", alias="notifChannel")
