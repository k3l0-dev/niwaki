...
class notifCont(ManagedObject):
    """ACI Managed Object: ``notifCont`` — Notification Class Container.

    RN format: ``notifications``
    """

    _aci_class: ClassVar[str] = "notifCont"
    _rn_format: ClassVar[str] = "notifications"
