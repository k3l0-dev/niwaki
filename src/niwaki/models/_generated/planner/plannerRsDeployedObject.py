...
class plannerRsDeployedObject(ManagedObject):
    """ACI Managed Object: ``plannerRsDeployedObject`` — Deployed Objects.

    Deployed Object

    RN format: ``rsdeployedObject-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "plannerRsDeployedObject"
    _rn_format: ClassVar[str] = "rsdeployedObject-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1852": "fltPlannerRsDeployedObjectResolveFail",
    }
