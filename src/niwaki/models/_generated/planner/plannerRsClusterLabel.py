...
class plannerRsClusterLabel(ManagedObject):
    """ACI Managed Object: ``plannerRsClusterLabel`` — Label.

    Label for this Cluster

    RN format: ``rsclusterLabel``
    """

    _aci_class: ClassVar[str] = "plannerRsClusterLabel"
    _rn_format: ClassVar[str] = "rsclusterLabel"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1905": "fltPlannerRsClusterLabelResolveFail",
    }
