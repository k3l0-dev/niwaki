...
class plannerGraphTmpl(ManagedObject):
    """ACI Managed Object: ``plannerGraphTmpl`` — L4-L7 Service Graph Template.

    Grapth template

    RN format: ``graph-{name}``
    """

    _aci_class: ClassVar[str] = "plannerGraphTmpl"
    _rn_format: ClassVar[str] = "graph-{name}"
    ...
    graph_span: Annotated[
        int,
        Field(
            ge=1, le=4000000000, alias="span", description="No of leafs this graph is deployed on"
        ),
    ] = 1
