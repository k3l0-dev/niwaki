...
class plannerRsAzureDomainLabel(ManagedObject):
    """ACI Managed Object: ``plannerRsAzureDomainLabel`` — Label.

    Label for this domain

    RN format: ``rsazureDomainLabel``
    """

    _aci_class: ClassVar[str] = "plannerRsAzureDomainLabel"
    _rn_format: ClassVar[str] = "rsazureDomainLabel"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2000": "fltPlannerRsAzureDomainLabelResolveFail",
    }
