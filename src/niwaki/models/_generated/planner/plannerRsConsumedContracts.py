...
class plannerRsConsumedContracts(ManagedObject):
    """ACI Managed Object: ``plannerRsConsumedContracts`` — Consumed Contracts.

    Contracts consumed by this epg

    RN format: ``rsconsumedContracts-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "plannerRsConsumedContracts"
    _rn_format: ClassVar[str] = "rsconsumedContracts-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1838": "fltPlannerRsConsumedContractsResolveFail",
    }
