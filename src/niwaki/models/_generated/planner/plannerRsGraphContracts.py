...
class plannerRsGraphContracts(ManagedObject):
    """ACI Managed Object: ``plannerRsGraphContracts`` — Contracts.

    RN format: ``rsgraphContracts-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "plannerRsGraphContracts"
    _rn_format: ClassVar[str] = "rsgraphContracts-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1839": "fltPlannerRsGraphContractsResolveFail",
    }
