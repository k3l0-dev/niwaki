...
class plannerRsAzureDomainTmpl(ManagedObject):
    """ACI Managed Object: ``plannerRsAzureDomainTmpl`` — Azure Domain.

    Azure Domain Template

    RN format: ``rsazureDomainTmpl``
    """

    _aci_class: ClassVar[str] = "plannerRsAzureDomainTmpl"
    _rn_format: ClassVar[str] = "rsazureDomainTmpl"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1999": "fltPlannerRsAzureDomainTmplResolveFail",
    }
