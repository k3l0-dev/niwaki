...
class plannerRsToConsumerL3Out(ManagedObject):
    """ACI Managed Object: ``plannerRsToConsumerL3Out`` — To Consumer L3Out.

    Consumer side l3out (for goto-two-arm)

    RN format: ``rstoConsumerL3Out``
    """

    _aci_class: ClassVar[str] = "plannerRsToConsumerL3Out"
    _rn_format: ClassVar[str] = "rstoConsumerL3Out"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1833": "fltPlannerRsToConsumerL3OutResolveFail",
    }
