...
class plannerRsL3OutVrf(ManagedObject):
    """ACI Managed Object: ``plannerRsL3OutVrf`` — VRF.

    VRF

    RN format: ``rsl3OutVrf``
    """

    _aci_class: ClassVar[str] = "plannerRsL3OutVrf"
    _rn_format: ClassVar[str] = "rsl3OutVrf"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1837": "fltPlannerRsL3OutVrfResolveFail",
    }
