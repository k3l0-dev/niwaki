...
class plannerACIConfigFilter(ManagedObject):
    """ACI Managed Object: ``plannerACIConfigFilter`` — Configuration options.

    RN format: ``cfgfilter-[{name}]``
    """

    _aci_class: ClassVar[str] = "plannerACIConfigFilter"
    _rn_format: ClassVar[str] = "cfgfilter-[{name}]"
