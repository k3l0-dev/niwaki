...
class plannerRsVmwareDomainLabel(ManagedObject):
    """ACI Managed Object: ``plannerRsVmwareDomainLabel`` — Label.

    Label for this domain

    RN format: ``rsvmwareDomainLabel``
    """

    _aci_class: ClassVar[str] = "plannerRsVmwareDomainLabel"
    _rn_format: ClassVar[str] = "rsvmwareDomainLabel"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2002": "fltPlannerRsVmwareDomainLabelResolveFail",
    }
