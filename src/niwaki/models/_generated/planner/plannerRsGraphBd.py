...
class plannerRsGraphBd(ManagedObject):
    """ACI Managed Object: ``plannerRsGraphBd`` — Bd.
    ...
    _aci_class: ClassVar[str] = "plannerRsGraphBd"
    _rn_format: ClassVar[str] = "rsgraphBd"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1830": "fltPlannerRsGraphBdResolveFail",
    }
