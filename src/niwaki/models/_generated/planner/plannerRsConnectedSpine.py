...
class plannerRsConnectedSpine(ManagedObject):
    """ACI Managed Object: ``plannerRsConnectedSpine`` — Connected Spine.

    Spine this leaf is connected to

    RN format: ``rsconnectedSpine``
    """

    _aci_class: ClassVar[str] = "plannerRsConnectedSpine"
    _rn_format: ClassVar[str] = "rsconnectedSpine"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1887": "fltPlannerRsConnectedSpineResolveFail",
    }
