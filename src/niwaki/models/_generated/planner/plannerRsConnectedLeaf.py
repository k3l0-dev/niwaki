...
class plannerRsConnectedLeaf(ManagedObject):
    """ACI Managed Object: ``plannerRsConnectedLeaf`` — Connected Leaf.

    Leaf this fex is connected to

    RN format: ``rsconnectedLeaf``
    """

    _aci_class: ClassVar[str] = "plannerRsConnectedLeaf"
    _rn_format: ClassVar[str] = "rsconnectedLeaf"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1862": "fltPlannerRsConnectedLeafResolveFail",
    }
