...
class plannerRsGraphCluster(ManagedObject):
    """ACI Managed Object: ``plannerRsGraphCluster`` — L4L7 Cluster.

    L4L7 Cluster

    RN format: ``rsgraphCluster``
    """

    _aci_class: ClassVar[str] = "plannerRsGraphCluster"
    _rn_format: ClassVar[str] = "rsgraphCluster"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1904": "fltPlannerRsGraphClusterResolveFail",
    }
