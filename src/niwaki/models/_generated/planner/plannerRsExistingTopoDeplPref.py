...
class plannerRsExistingTopoDeplPref(ManagedObject):
    """ACI Managed Object: ``plannerRsExistingTopoDeplPref`` — Deployment Filters for Existing Topology.

    RN format: ``rsexistingTopoDeplPref``
    """
