...
class plannerRsFexLabel(ManagedObject):
    """ACI Managed Object: ``plannerRsFexLabel`` — Label.

    Label for fex

    RN format: ``rsfexLabel``
    """

    _aci_class: ClassVar[str] = "plannerRsFexLabel"
    _rn_format: ClassVar[str] = "rsfexLabel"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1863": "fltPlannerRsFexLabelResolveFail",
    }
