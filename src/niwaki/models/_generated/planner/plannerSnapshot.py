...
class plannerSnapshot(ManagedObject):
    """ACI Managed Object: ``plannerSnapshot`` — Snapshot Object.

    RN format: ``snapshot-{name}``
    """

    _aci_class: ClassVar[str] = "plannerSnapshot"
    ...
    time_when_the_snapshot_was_created: str = Field(default="", alias="time")
