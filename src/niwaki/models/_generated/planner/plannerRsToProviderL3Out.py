...
class plannerRsToProviderL3Out(ManagedObject):
    """ACI Managed Object: ``plannerRsToProviderL3Out`` — To Provider L3Out.

    Provider side L3Out (for goto-two-arm)

    RN format: ``rstoProviderL3Out``
    """

    _aci_class: ClassVar[str] = "plannerRsToProviderL3Out"
    _rn_format: ClassVar[str] = "rstoProviderL3Out"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1835": "fltPlannerRsToProviderL3OutResolveFail",
    }
