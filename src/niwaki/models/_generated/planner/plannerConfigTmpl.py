...
class plannerConfigTmpl(ManagedObject):
    """ACI Managed Object: ``plannerConfigTmpl`` — Optimizer Config Template.

    RN format: ``cfg-{name}``
    """

    _aci_class: ClassVar[str] = "plannerConfigTmpl"
    _rn_format: ClassVar[str] = "cfg-{name}"
    ...
    topology: PlannerTopologyPref = PlannerTopologyPref.NEW
