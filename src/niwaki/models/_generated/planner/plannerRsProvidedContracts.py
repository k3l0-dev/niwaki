...
class plannerRsProvidedContracts(ManagedObject):
    """ACI Managed Object: ``plannerRsProvidedContracts`` — Provided Contracts.

    Contracts provided by this epg

    RN format: ``rsprovidedContracts-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "plannerRsProvidedContracts"
    _rn_format: ClassVar[str] = "rsprovidedContracts-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1840": "fltPlannerRsProvidedContractsResolveFail",
    }
