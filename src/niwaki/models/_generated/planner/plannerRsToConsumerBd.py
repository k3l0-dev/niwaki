...
class plannerRsToConsumerBd(ManagedObject):
    """ACI Managed Object: ``plannerRsToConsumerBd`` — To Consumer Bd.

    Consumer side Bridge Domain (for goto-two-arm)

    RN format: ``rstoConsumerBd``
    """

    _aci_class: ClassVar[str] = "plannerRsToConsumerBd"
    _rn_format: ClassVar[str] = "rstoConsumerBd"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1832": "fltPlannerRsToConsumerBdResolveFail",
    }
