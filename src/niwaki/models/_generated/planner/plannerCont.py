...
class plannerCont(ManagedObject):
    """ACI Managed Object: ``plannerCont`` — Optimizer Config container.

    RN format: ``planner``
    """

    _aci_class: ClassVar[str] = "plannerCont"
    _rn_format: ClassVar[str] = "planner"
