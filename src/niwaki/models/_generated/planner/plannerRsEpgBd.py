...
class plannerRsEpgBd(ManagedObject):
    """ACI Managed Object: ``plannerRsEpgBd`` — Bridge Domain.
    ...
    _aci_class: ClassVar[str] = "plannerRsEpgBd"
    _rn_format: ClassVar[str] = "rsepgBd"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1828": "fltPlannerRsEpgBdResolveFail",
    }
