...
class plannerRsLeafLabels(ManagedObject):
    """ACI Managed Object: ``plannerRsLeafLabels`` — Labels.

    Lables assigned to leaf

    RN format: ``rsleafLabels-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "plannerRsLeafLabels"
    _rn_format: ClassVar[str] = "rsleafLabels-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1865": "fltPlannerRsLeafLabelsResolveFail",
    }
