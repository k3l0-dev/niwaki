...
class plannerTenantAny(ManagedObject):
    """ACI Managed Object: ``plannerTenantAny`` — All tenants that need to be placed.

    RN format: ``tnany``
    """

    _aci_class: ClassVar[str] = "plannerTenantAny"
    _rn_format: ClassVar[str] = "tnany"
