...
class l2VfcIfClearCountersLTask(ManagedObject):
    """ACI Managed Object: ``l2VfcIfClearCountersLTask``.

    RN format: ``l2VfcIfClearCountersLTask``
    """

    _aci_class: ClassVar[str] = "l2VfcIfClearCountersLTask"
    _rn_format: ClassVar[str] = "l2VfcIfClearCountersLTask"
