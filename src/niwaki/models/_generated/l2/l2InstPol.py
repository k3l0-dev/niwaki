...
class l2InstPol(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "l2InstPol"
    _rn_format: ClassVar[str] = "l2pol-{name}"
    ...
    mtu_size_for_fabric_ports: Annotated[
        ...
        Field(
            ge=576,
            le=9216,
            validation_alias="fabricMtu",
            serialization_alias="fabricMtu",
    ...
    mtu_size_for_management_ports: Annotated[
        ...
        Field(
            ge=576,
            le=9216,
            validation_alias="managementMtu",
            serialization_alias="managementMtu",
            description="MTU Size for Management Ports",
        ),
    ] = 9000
