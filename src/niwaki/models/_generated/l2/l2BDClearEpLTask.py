...
class l2BDClearEpLTask(ManagedObject):
    """ACI Managed Object: ``l2BDClearEpLTask``.

    The task to clear all endpoints under a given bridge domain.

    RN format: ``l2BDClearEpLTask``
    """

    _aci_class: ClassVar[str] = "l2BDClearEpLTask"
    _rn_format: ClassVar[str] = "l2BDClearEpLTask"
