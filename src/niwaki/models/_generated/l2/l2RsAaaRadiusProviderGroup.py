...
class l2RsAaaRadiusProviderGroup(ManagedObject):
    """ACI Managed Object: ``l2RsAaaRadiusProviderGroup`` — Radius Provider Group Policy.

    RN format: ``rsaaaRadiusProviderGroup``
    """
