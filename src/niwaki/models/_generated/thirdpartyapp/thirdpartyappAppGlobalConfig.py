...
class thirdpartyappAppGlobalConfig(ManagedObject):
    """ACI Managed Object: ``thirdpartyappAppGlobalConfig`` — Node Group Global Config.

    Model to define global app config on specific node

    RN format: ``globalcfg-{name}``
    """

    _aci_class: ClassVar[str] = "thirdpartyappAppGlobalConfig"
    _rn_format: ClassVar[str] = "globalcfg-{name}"
