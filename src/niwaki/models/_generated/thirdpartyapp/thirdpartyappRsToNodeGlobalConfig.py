...
class thirdpartyappRsToNodeGlobalConfig(ManagedObject):
    """ACI Managed Object: ``thirdpartyappRsToNodeGlobalConfig`` — Relation to Global Config Policy.

    RN format: ``rstoNodeGlobalConfig-{name}``
    """

    _aci_class: ClassVar[str] = "thirdpartyappRsToNodeGlobalConfig"
    _rn_format: ClassVar[str] = "rstoNodeGlobalConfig-{name}"
    _naming_props: ClassVar[list[str]] = ["name"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4454": "fltThirdpartyappRsToNodeGlobalConfigResolveFail",
    }
