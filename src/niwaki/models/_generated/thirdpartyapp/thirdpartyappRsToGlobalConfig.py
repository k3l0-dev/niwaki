...
class thirdpartyappRsToGlobalConfig(ManagedObject):
    """ACI Managed Object: ``thirdpartyappRsToGlobalConfig`` — Node Group Global Config.

    RN format: ``rstoGlobalConfig-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "thirdpartyappRsToGlobalConfig"
    _rn_format: ClassVar[str] = "rstoGlobalConfig-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4455": "fltThirdpartyappRsToGlobalConfigResolveFail",
    }
