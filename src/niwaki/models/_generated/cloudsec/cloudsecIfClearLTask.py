...
class cloudsecIfClearLTask(ManagedObject):
    """ACI Managed Object: ``cloudsecIfClearLTask``.

    RN format: ``cloudsecIfClearLTask``
    """

    _aci_class: ClassVar[str] = "cloudsecIfClearLTask"
    _rn_format: ClassVar[str] = "cloudsecIfClearLTask"
