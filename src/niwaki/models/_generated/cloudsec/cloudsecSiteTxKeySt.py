...
class cloudsecSiteTxKeySt(ManagedObject):
    """ACI Managed Object: ``cloudsecSiteTxKeySt`` — Aggregated TXSaKey status on Site.

    Internal Mo for tracking tx key status on site

    RN format: ``sitetxkeystatus``
    """

    _aci_class: ClassVar[str] = "cloudsecSiteTxKeySt"
    _rn_format: ClassVar[str] = "sitetxkeystatus"
