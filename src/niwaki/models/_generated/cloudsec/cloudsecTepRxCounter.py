...
class cloudsecTepRxCounter(ManagedObject):
    """ACI Managed Object: ``cloudsecTepRxCounter`` — Tunnel Endpoint Packet Counters.

    RN format: ``tepRxCounter``
    """

    _aci_class: ClassVar[str] = "cloudsecTepRxCounter"
    _rn_format: ClassVar[str] = "tepRxCounter"
