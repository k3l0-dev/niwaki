...
class cloudsecSiteRxKeySt(ManagedObject):
    """ACI Managed Object: ``cloudsecSiteRxKeySt`` — Aggregated RXSaKey status on Site.

    Internal Mo for tracking rx key status on site

    RN format: ``siterxkeystatus``
    """

    _aci_class: ClassVar[str] = "cloudsecSiteRxKeySt"
    _rn_format: ClassVar[str] = "siterxkeystatus"
