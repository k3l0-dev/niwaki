...
class vmmRsVswitchOverrideMtuPol(ManagedObject):
    """ACI Managed Object: ``vmmRsVswitchOverrideMtuPol`` — Relation to MTU Policy.

    Relationship to policy providing physical configuration of the interfaces

    RN format: ``rsvswitchOverrideMtuPol``
    """

    _aci_class: ClassVar[str] = "vmmRsVswitchOverrideMtuPol"
    _rn_format: ClassVar[str] = "rsvswitchOverrideMtuPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3853": "fltVmmRsVswitchOverrideMtuPolResolveFail",
    }
