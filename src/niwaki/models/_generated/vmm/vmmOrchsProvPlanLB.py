...
class vmmOrchsProvPlanLB(ManagedObject):
    """ACI Managed Object: ``vmmOrchsProvPlanLB`` — Orchestrator Plan Loadbalancer settings.

    RN format: ``lb-{name}``
    """

    _aci_class: ClassVar[str] = "vmmOrchsProvPlanLB"
    _rn_format: ClassVar[str] = "lb-{name}"
