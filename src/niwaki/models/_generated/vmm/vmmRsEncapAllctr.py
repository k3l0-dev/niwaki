...
class vmmRsEncapAllctr(ManagedObject):
    """ACI Managed Object: ``vmmRsEncapAllctr`` — Encap Allocator.

    Relation to the allocator for encap

    RN format: ``rsEncapAllctr``
    """

    _aci_class: ClassVar[str] = "vmmRsEncapAllctr"
    _rn_format: ClassVar[str] = "rsEncapAllctr"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2100": "fltVmmRsEncapAllctrResolveFail",
    }
