...
class vmmRsUsrAggrLagPolAtt(ManagedObject):
    """ACI Managed Object: ``vmmRsUsrAggrLagPolAtt`` — Trunk PortGroup Relationship to Enhanced Lag Policy.

    RN format: ``rsUsrAggrLagPolAtt``
    """
