...
class vmmInjectedNwPol(ManagedObject):
    """ACI Managed Object: ``vmmInjectedNwPol`` — Injected Network Policy.

    RN format: ``nwpol-[{name}]``
    """

    _aci_class: ClassVar[str] = "vmmInjectedNwPol"
    _rn_format: ClassVar[str] = "nwpol-[{name}]"
