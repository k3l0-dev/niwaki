...
class vmmRsClusterAcc(ManagedObject):
    """ACI Managed Object: ``vmmRsClusterAcc`` — User Access Profile.

    RN format: ``rsclusterAcc``
    """

    _aci_class: ClassVar[str] = "vmmRsClusterAcc"
    _rn_format: ClassVar[str] = "rsclusterAcc"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4478": "fltVmmRsClusterAccResolveFail",
    }
