...
class vmmInjectedOrg(ManagedObject):
    """ACI Managed Object: ``vmmInjectedOrg`` — Injected Org.

    RN format: ``org-[{name}]``
    """

    _aci_class: ClassVar[str] = "vmmInjectedOrg"
    _rn_format: ClassVar[str] = "org-[{name}]"
