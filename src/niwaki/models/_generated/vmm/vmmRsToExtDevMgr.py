...
class vmmRsToExtDevMgr(ManagedObject):
    """ACI Managed Object: ``vmmRsToExtDevMgr`` — Extern device mgr profile.

    Association to External Device Controller Profile

    RN format: ``rstoExtDevMgr-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "vmmRsToExtDevMgr"
    _rn_format: ClassVar[str] = "rstoExtDevMgr-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3329": "fltVmmRsToExtDevMgrResolveFail",
    }
