...
class vmmRsPrefEnhancedLagPol(ManagedObject):
    """ACI Managed Object: ``vmmRsPrefEnhancedLagPol`` — Relation to Preferred Enhanced Lag Policy.

    RN format: ``rsprefEnhancedLagPol``
    """
