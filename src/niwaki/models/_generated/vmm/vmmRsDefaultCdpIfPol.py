...
class vmmRsDefaultCdpIfPol(ManagedObject):
    """ACI Managed Object: ``vmmRsDefaultCdpIfPol`` — CDP Interface Policy.

    A source relation to the Cisco Discovery Channel interface policy.

    RN format: ``rsdefaultCdpIfPol``
    """

    _aci_class: ClassVar[str] = "vmmRsDefaultCdpIfPol"
    _rn_format: ClassVar[str] = "rsdefaultCdpIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1068": "fltVmmRsDefaultCdpIfPolResolveFail",
    }
