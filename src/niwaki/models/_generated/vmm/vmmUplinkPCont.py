...
class vmmUplinkPCont(ManagedObject):
    """ACI Managed Object: ``vmmUplinkPCont`` — Uplink Policy Container.

    RN format: ``uplinkpcont``
    """

    _aci_class: ClassVar[str] = "vmmUplinkPCont"
    _rn_format: ClassVar[str] = "uplinkpcont"
    ...
    number_of_uplinks: Annotated[
        str, Field(max_length=512, alias="numOfUplinks", description="Number of uplinks")
    ] = ""
