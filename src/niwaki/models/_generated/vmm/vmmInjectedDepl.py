...
class vmmInjectedDepl(ManagedObject):
    """ACI Managed Object: ``vmmInjectedDepl`` — Deployment.

    RN format: ``depl-[{name}]``
    """

    _aci_class: ClassVar[str] = "vmmInjectedDepl"
    _rn_format: ClassVar[str] = "depl-[{name}]"
