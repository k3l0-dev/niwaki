...
class vmmInjectedReplSet(ManagedObject):
    """ACI Managed Object: ``vmmInjectedReplSet`` — ReplicaSet.

    RN format: ``rs-[{name}]``
    """

    _aci_class: ClassVar[str] = "vmmInjectedReplSet"
    _rn_format: ClassVar[str] = "rs-[{name}]"
