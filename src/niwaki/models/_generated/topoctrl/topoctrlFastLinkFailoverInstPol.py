...
class topoctrlFastLinkFailoverInstPol(ManagedObject):
    """ACI Managed Object: ``topoctrlFastLinkFailoverInstPol`` — Fast Link Failover Policy.

    RN format: ``fastlinkfailoverinstpol-{name}``
    """

    _aci_class: ClassVar[str] = "topoctrlFastLinkFailoverInstPol"
    _rn_format: ClassVar[str] = "fastlinkfailoverinstpol-{name}"
    ...
    fast_link_failover_mode_type: TopoctrlFastLinkFailoverModeType = Field(
        default=TopoctrlFastLinkFailoverModeType.OFF, alias="modeType"
    )
