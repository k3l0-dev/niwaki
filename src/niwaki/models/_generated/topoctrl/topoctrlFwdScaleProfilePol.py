...
class topoctrlFwdScaleProfilePol(ManagedObject):
    """ACI Managed Object: ``topoctrlFwdScaleProfilePol`` — Forwarding Scale Profile Policy.

    RN format: ``fwdscalepol-{name}``
    """

    _aci_class: ClassVar[str] = "topoctrlFwdScaleProfilePol"
    _rn_format: ClassVar[str] = "fwdscalepol-{name}"
    ...
    fwd_scale_profile_type: TopoctrlFwdScaleProfType = Field(
        default=TopoctrlFwdScaleProfType.DUAL_STACK,
        validation_alias="profType",
        serialization_alias="profType",
    )
