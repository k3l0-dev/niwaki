...
class oamRsSrcEncap(ManagedObject):
    """ACI Managed Object: ``oamRsSrcEncap`` — Source Encapsulation Attachment.

    A source relation to an 802.1q VLAN. This object indicates the VLAN an endpoint belongs to.

    RN format: ``rssrcEncap``
    """

    _aci_class: ClassVar[str] = "oamRsSrcEncap"
    _rn_format: ClassVar[str] = "rssrcEncap"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1297": "fltOamRsSrcEncapResolveFail",
    }
