...
class ptpRsProfile(ManagedObject):
    """ACI Managed Object: ``ptpRsProfile`` — Relation to PTP user profile.

    Relation to PTP user profile

    RN format: ``rsprofile``
    """

    _aci_class: ClassVar[str] = "ptpRsProfile"
    _rn_format: ClassVar[str] = "rsprofile"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3717": "fltPtpRsProfileResolveFail",
    }
