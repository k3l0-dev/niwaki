...
class ptpRsLatencyPtpMode(ManagedObject):
    """ACI Managed Object: ``ptpRsLatencyPtpMode`` — Relation to latencyPtpMode.

    Relation to latencyPtpMode MO

    RN format: ``rslatencyPtpMode``
    """

    _aci_class: ClassVar[str] = "ptpRsLatencyPtpMode"
    _rn_format: ClassVar[str] = "rslatencyPtpMode"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4013": "fltPtpRsLatencyPtpModeResolveFail",
    }
