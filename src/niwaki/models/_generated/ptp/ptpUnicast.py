...
class ptpUnicast(ManagedObject):
    """ACI Managed Object: ``ptpUnicast`` — PTP Unicast master/Slave.

    Holds PTP Unicast information

    RN format: ``ucast``
    """

    _aci_class: ClassVar[str] = "ptpUnicast"
    _rn_format: ClassVar[str] = "ucast"
