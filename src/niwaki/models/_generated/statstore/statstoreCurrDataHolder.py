...
class statstoreCurrDataHolder(ManagedObject):
    """ACI Managed Object: ``statstoreCurrDataHolder`` — Current Data Holder.
    ...
    _aci_class: ClassVar[str] = "statstoreCurrDataHolder"
    _rn_format: ClassVar[str] = "curr"
