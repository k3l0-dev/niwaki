...
class statstoreCurrDataHolder2(ManagedObject):
    """ACI Managed Object: ``statstoreCurrDataHolder2`` — Current Data Holder #2.

    RN format: ``curr2``
    """

    _aci_class: ClassVar[str] = "statstoreCurrDataHolder2"
    _rn_format: ClassVar[str] = "curr2"
