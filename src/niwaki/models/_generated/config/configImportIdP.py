...
class configImportIdP(ManagedObject):
    """ACI Managed Object: ``configImportIdP`` — ID Import Policy.

    RN format: ``impid-{name}``
    """

    _aci_class: ClassVar[str] = "configImportIdP"
    _rn_format: ClassVar[str] = "impid-{name}"
    ...
    id_file_to_import: Annotated[str, Field(max_length=512, alias="fileName")] = ""
