...
class intersightDeviceConnectorInst(ManagedObject):
    """ACI Managed Object: ``intersightDeviceConnectorInst`` — Intersight device connector policy.
    ...
    base64_encoded_parent_signature_block: Annotated[str, Field(alias="psb", repr=False)] = ""
