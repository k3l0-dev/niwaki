...
class l3extRsLblToInstP(ManagedObject):
    """ACI Managed Object: ``l3extRsLblToInstP`` — External Network Instance Profile.

    RN format: ``rslblToInstP-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "l3extRsLblToInstP"
    _rn_format: ClassVar[str] = "rslblToInstP-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3783": "fltL3extRsLblToInstPResolveFail",
    }
