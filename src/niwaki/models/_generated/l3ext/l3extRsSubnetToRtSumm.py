...
class l3extRsSubnetToRtSumm(ManagedObject):
    """ACI Managed Object: ``l3extRsSubnetToRtSumm`` — Route Summarization policy.

    RN format: ``rsSubnetToRtSumm``
    """

    _aci_class: ClassVar[str] = "l3extRsSubnetToRtSumm"
    _rn_format: ClassVar[str] = "rsSubnetToRtSumm"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2110": "fltL3extRsSubnetToRtSummResolveFail",
    }
