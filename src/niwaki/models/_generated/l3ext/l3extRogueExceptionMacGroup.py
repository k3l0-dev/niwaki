...
class l3extRogueExceptionMacGroup(ManagedObject):
    """ACI Managed Object: ``l3extRogueExceptionMacGroup`` — Abstract rogue exception mac group.

    RN format: ``rmacg-{name}``
    """

    _aci_class: ClassVar[str] = "l3extRogueExceptionMacGroup"
    _rn_format: ClassVar[str] = "rmacg-{name}"
