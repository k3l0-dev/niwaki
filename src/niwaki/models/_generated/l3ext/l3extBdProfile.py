...
class l3extBdProfile(ManagedObject):
    """ACI Managed Object: ``l3extBdProfile`` — External Bridge Group Profile.

    RN format: ``bdprofile-{name}``
    """

    _aci_class: ClassVar[str] = "l3extBdProfile"
    _rn_format: ClassVar[str] = "bdprofile-{name}"
