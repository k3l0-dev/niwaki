...
class l3extBdProfileCont(ManagedObject):
    """ACI Managed Object: ``l3extBdProfileCont`` — Conntainer of RsPath relationships.

    RN format: ``bdprofilecont``
    """

    _aci_class: ClassVar[str] = "l3extBdProfileCont"
    _rn_format: ClassVar[str] = "bdprofilecont"
