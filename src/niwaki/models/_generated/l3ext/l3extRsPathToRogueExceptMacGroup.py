...
class l3extRsPathToRogueExceptMacGroup(ManagedObject):
    """ACI Managed Object: ``l3extRsPathToRogueExceptMacGroup`` — Rogue Exception MAC Group.

    RN format: ``rsPathToRogueExceptMacGroup``
    """

    _aci_class: ClassVar[str] = "l3extRsPathToRogueExceptMacGroup"
    _rn_format: ClassVar[str] = "rsPathToRogueExceptMacGroup"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4433": "fltL3extRsPathToRogueExceptMacGroupResolveFail",
    }
