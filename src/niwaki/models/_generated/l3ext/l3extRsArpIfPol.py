...
class l3extRsArpIfPol(ManagedObject):
    """ACI Managed Object: ``l3extRsArpIfPol`` — ARP Policy.

    Relation to ARP policy

    RN format: ``rsArpIfPol``
    """

    _aci_class: ClassVar[str] = "l3extRsArpIfPol"
    _rn_format: ClassVar[str] = "rsArpIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3474": "fltL3extRsArpIfPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnArpIfPolName",
            serialization_alias="tnArpIfPolName",
        ),
    ] = ""
