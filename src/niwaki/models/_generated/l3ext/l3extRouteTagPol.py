...
class l3extRouteTagPol(ManagedObject):
    """ACI Managed Object: ``l3extRouteTagPol`` — Route Tag  Policy.

    A route tag is used to assign a number to identify the policy.

    RN format: ``rttag-{name}``
    """

    _aci_class: ClassVar[str] = "l3extRouteTagPol"
    _rn_format: ClassVar[str] = "rttag-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The route tag policy name.",
        ),
    ]
    ...
    route_tag: Annotated[int, Field(alias="tag", description="The color of a policy label.")] = (
        4294967295
    )
