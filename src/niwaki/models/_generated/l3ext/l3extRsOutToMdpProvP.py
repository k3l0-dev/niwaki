...
class l3extRsOutToMdpProvP(ManagedObject):
    """ACI Managed Object: ``l3extRsOutToMdpProvP`` — L3 Out Multi-domain Policy.

    Represents the associated Multi-Domain Policy

    RN format: ``rsoutToMdpProvP``
    """

    _aci_class: ClassVar[str] = "l3extRsOutToMdpProvP"
    _rn_format: ClassVar[str] = "rsoutToMdpProvP"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3732": "fltL3extRsOutToMdpProvPResolveFail",
    }
