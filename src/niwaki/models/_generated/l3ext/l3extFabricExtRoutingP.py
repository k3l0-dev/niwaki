...
class l3extFabricExtRoutingP(ManagedObject):
    """ACI Managed Object: ``l3extFabricExtRoutingP`` — Fabric External Routing Profile.

    Fabric External Routing Profile

    RN format: ``fabricExtRoutingP-{name}``
    """

    _aci_class: ClassVar[str] = "l3extFabricExtRoutingP"
    _rn_format: ClassVar[str] = "fabricExtRoutingP-{name}"
