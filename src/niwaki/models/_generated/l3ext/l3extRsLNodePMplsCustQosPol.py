...
class l3extRsLNodePMplsCustQosPol(ManagedObject):
    """ACI Managed Object: ``l3extRsLNodePMplsCustQosPol`` — Mpls Custom QOS Policy.

    RN format: ``rslNodePMplsCustQosPol``
    """

    _aci_class: ClassVar[str] = "l3extRsLNodePMplsCustQosPol"
    _rn_format: ClassVar[str] = "rslNodePMplsCustQosPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3847": "fltL3extRsLNodePMplsCustQosPolResolveFail",
    }
