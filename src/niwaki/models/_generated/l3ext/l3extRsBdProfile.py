...
class l3extRsBdProfile(ManagedObject):
    """ACI Managed Object: ``l3extRsBdProfile`` — External Bridge Group Profile.

    RN format: ``rsbdProfile``
    """

    _aci_class: ClassVar[str] = "l3extRsBdProfile"
    _rn_format: ClassVar[str] = "rsbdProfile"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3950": "fltL3extRsBdProfileResolveFail",
    }
