...
class cdpIfClearIfLTask(ManagedObject):
    """ACI Managed Object: ``cdpIfClearIfLTask``.

    RN format: ``cdpIfClearIfLTask``
    """

    _aci_class: ClassVar[str] = "cdpIfClearIfLTask"
    _rn_format: ClassVar[str] = "cdpIfClearIfLTask"
