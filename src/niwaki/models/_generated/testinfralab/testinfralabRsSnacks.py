...
class testinfralabRsSnacks(ManagedObject):
    """ACI Managed Object: ``testinfralabRsSnacks``.

    RN format: ``rssnacks-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "testinfralabRsSnacks"
    _rn_format: ClassVar[str] = "rssnacks-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1058": "fltTestinfralabRsSnacksResolveFail",
    }
