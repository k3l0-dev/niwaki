...
class infraRsQosPfcIfPol(ManagedObject):
    """ACI Managed Object: ``infraRsQosPfcIfPol`` — Interface Priority Flow Control.

    Relation to qosPfcIfPol

    RN format: ``rsqosPfcIfPol``
    """

    _aci_class: ClassVar[str] = "infraRsQosPfcIfPol"
    _rn_format: ClassVar[str] = "rsqosPfcIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2232": "fltInfraRsQosPfcIfPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnQosPfcIfPolName",
            serialization_alias="tnQosPfcIfPolName",
        ),
    ] = ""
