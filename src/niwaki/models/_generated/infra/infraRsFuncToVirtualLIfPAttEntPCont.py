...
class infraRsFuncToVirtualLIfPAttEntPCont(ManagedObject):
    """ACI Managed Object: ``infraRsFuncToVirtualLIfPAttEntPCont`` — VirtualLIfPs Using Function.

    RN format: ``rsfuncToVirtualLIfPAttEntPCont-[{target_dn}]``
    """
