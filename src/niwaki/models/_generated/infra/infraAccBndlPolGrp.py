...
class infraAccBndlPolGrp(ManagedObject):
    """ACI Managed Object: ``infraAccBndlPolGrp`` — PC/vPC Interface Policy Override Group.

    RN format: ``accbundlepolgrp-{name}``
    """

    _aci_class: ClassVar[str] = "infraAccBndlPolGrp"
    _rn_format: ClassVar[str] = "accbundlepolgrp-{name}"
