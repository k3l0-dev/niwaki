...
class infraRsLeafPGrpToLldpIfPol(ManagedObject):
    """ACI Managed Object: ``infraRsLeafPGrpToLldpIfPol`` — Relation to lldp interface policy for mgmt port.

    Relationship to lldp interface policy for mgmt port

    RN format: ``rsleafPGrpToLldpIfPol``
    """

    _aci_class: ClassVar[str] = "infraRsLeafPGrpToLldpIfPol"
    _rn_format: ClassVar[str] = "rsleafPGrpToLldpIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3582": "fltInfraRsLeafPGrpToLldpIfPolResolveFail",
    }
