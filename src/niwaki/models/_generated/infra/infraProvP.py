...
class infraProvP(ManagedObject):
    """ACI Managed Object: ``infraProvP`` — Access Provider Profile.

    The infrastructure provider profile.

    RN format: ``provp-{name}``
    """

    _aci_class: ClassVar[str] = "infraProvP"
    _rn_format: ClassVar[str] = "provp-{name}"
