...
class infraRsPathToAccBaseGrp(ManagedObject):
    """ACI Managed Object: ``infraRsPathToAccBaseGrp`` — Access Base Group.

    RN format: ``rspathToAccBaseGrp``
    """

    _aci_class: ClassVar[str] = "infraRsPathToAccBaseGrp"
    _rn_format: ClassVar[str] = "rspathToAccBaseGrp"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1631": "fltInfraRsPathToAccBaseGrpResolveFail",
    }
