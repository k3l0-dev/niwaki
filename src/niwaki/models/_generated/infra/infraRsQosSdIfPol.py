...
class infraRsQosSdIfPol(ManagedObject):
    """ACI Managed Object: ``infraRsQosSdIfPol`` — Slow Drain Policy.

    Relation to qosSDPol

    RN format: ``rsqosSdIfPol``
    """

    _aci_class: ClassVar[str] = "infraRsQosSdIfPol"
    _rn_format: ClassVar[str] = "rsqosSdIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2251": "fltInfraRsQosSdIfPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnQosSdIfPolName",
            serialization_alias="tnQosSdIfPolName",
        ),
    ] = ""
