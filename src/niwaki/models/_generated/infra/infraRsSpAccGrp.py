...
class infraRsSpAccGrp(ManagedObject):
    """ACI Managed Object: ``infraRsSpAccGrp`` — Spine Access Group.

    RN format: ``rsspAccGrp``
    """

    _aci_class: ClassVar[str] = "infraRsSpAccGrp"
    _rn_format: ClassVar[str] = "rsspAccGrp"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2148": "fltInfraRsSpAccGrpResolveFail",
    }
