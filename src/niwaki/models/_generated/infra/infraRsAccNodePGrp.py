...
class infraRsAccNodePGrp(ManagedObject):
    """ACI Managed Object: ``infraRsAccNodePGrp`` — Relation to Node Policy Group.

    A source relation to the node policy group.

    RN format: ``rsaccNodePGrp``
    """

    _aci_class: ClassVar[str] = "infraRsAccNodePGrp"
    _rn_format: ClassVar[str] = "rsaccNodePGrp"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1012": "fltInfraRsAccNodePGrpResolveFail",
    }
