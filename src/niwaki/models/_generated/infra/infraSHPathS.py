...
class infraSHPathS(ManagedObject):
    """ACI Managed Object: ``infraSHPathS`` — Host Path Selector.

    Spine Host Path Selector

    RN format: ``shpaths-{name}``
    """

    _aci_class: ClassVar[str] = "infraSHPathS"
    _rn_format: ClassVar[str] = "shpaths-{name}"
