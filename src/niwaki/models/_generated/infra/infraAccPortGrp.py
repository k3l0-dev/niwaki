...
class infraAccPortGrp(ManagedObject):
    """ACI Managed Object: ``infraAccPortGrp`` — Leaf Access Port Policy Group.

    The interface policy group enables you to specify the interface policies you want to use.

    RN format: ``accportgrp-{name}``
    """

    _aci_class: ClassVar[str] = "infraAccPortGrp"
    _rn_format: ClassVar[str] = "accportgrp-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The singular ports name. This name can be up to 64 alphanumeric characters. Note that you cannot change this name after the object has been saved.",
        ),
    ]
