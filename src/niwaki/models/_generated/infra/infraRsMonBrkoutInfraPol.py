...
class infraRsMonBrkoutInfraPol(ManagedObject):
    """ACI Managed Object: ``infraRsMonBrkoutInfraPol`` — Relation to Breakout Infra Monitoring Policy.

    Statistics Policy

    RN format: ``rsmonBrkoutInfraPol``
    """

    _aci_class: ClassVar[str] = "infraRsMonBrkoutInfraPol"
    _rn_format: ClassVar[str] = "rsmonBrkoutInfraPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2431": "fltInfraRsMonBrkoutInfraPolResolveFail",
    }
