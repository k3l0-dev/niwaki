...
class infraRsFabricNode(ManagedObject):
    """ACI Managed Object: ``infraRsFabricNode`` — Fabric Node.

    A source relation to the root node for the APIC.

    RN format: ``rsfabricNode-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "infraRsFabricNode"
    _rn_format: ClassVar[str] = "rsfabricNode-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1258": "fltInfraRsFabricNodeResolveFail",
    }
