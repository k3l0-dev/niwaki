...
class infraRsVipAddrNs(ManagedObject):
    """ACI Managed Object: ``infraRsVipAddrNs`` — Relation to VIP Range.

    RN format: ``rsvipAddrNs``
    """

    _aci_class: ClassVar[str] = "infraRsVipAddrNs"
    _rn_format: ClassVar[str] = "rsvipAddrNs"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1427": "fltInfraRsVipAddrNsResolveFail",
    }
