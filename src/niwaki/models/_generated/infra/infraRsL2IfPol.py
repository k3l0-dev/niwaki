...
class infraRsL2IfPol(ManagedObject):
    """ACI Managed Object: ``infraRsL2IfPol`` — Relation to L2 Interface Policy.

    RN format: ``rsl2IfPol``
    """

    _aci_class: ClassVar[str] = "infraRsL2IfPol"
    _rn_format: ClassVar[str] = "rsl2IfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1648": "fltInfraRsL2IfPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnL2IfPolName",
            serialization_alias="tnL2IfPolName",
        ),
    ] = ""
