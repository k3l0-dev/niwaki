...
class infraCtrlrMtuPol(ManagedObject):
    """ACI Managed Object: ``infraCtrlrMtuPol`` — Ctrlr MTU Policy.

    RN format: ``mtu``
    """

    _aci_class: ClassVar[str] = "infraCtrlrMtuPol"
    _rn_format: ClassVar[str] = "mtu"
