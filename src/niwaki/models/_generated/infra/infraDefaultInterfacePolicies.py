...
class infraDefaultInterfacePolicies(ManagedObject):
    """ACI Managed Object: ``infraDefaultInterfacePolicies`` — Fabric-Wide Link Level Policies creation status.

    RN format: ``defautIntPol``
    """

    _aci_class: ClassVar[str] = "infraDefaultInterfacePolicies"
    _rn_format: ClassVar[str] = "defautIntPol"
