...
class infraBrkoutPortGrp(ManagedObject):
    """ACI Managed Object: ``infraBrkoutPortGrp`` — Leaf Breakout Port Group.

    Leaf Breakout Port Group

    RN format: ``brkoutportgrp-{name}``
    """

    _aci_class: ClassVar[str] = "infraBrkoutPortGrp"
    _rn_format: ClassVar[str] = "brkoutportgrp-{name}"
    ...
    breakout_map: EqptBrkoutMap = Field(
        default=EqptBrkoutMap.NONE,
        validation_alias="brkoutMap",
        serialization_alias="brkoutMap",
