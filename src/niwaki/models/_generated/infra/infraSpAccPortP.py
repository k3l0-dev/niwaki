...
class infraSpAccPortP(ManagedObject):
    """ACI Managed Object: ``infraSpAccPortP`` — Spine Interface Profile.

    Spine Interface Profile

    RN format: ``spaccportprof-{name}``
    """

    _aci_class: ClassVar[str] = "infraSpAccPortP"
    _rn_format: ClassVar[str] = "spaccportprof-{name}"
