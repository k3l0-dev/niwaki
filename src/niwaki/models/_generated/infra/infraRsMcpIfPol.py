...
class infraRsMcpIfPol(ManagedObject):
    """ACI Managed Object: ``infraRsMcpIfPol`` — Mis-cabling Protocol Interface Policy.

    RN format: ``rsmcpIfPol``
    """

    _aci_class: ClassVar[str] = "infraRsMcpIfPol"
    _rn_format: ClassVar[str] = "rsmcpIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1486": "fltInfraRsMcpIfPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnMcpIfPolName",
            serialization_alias="tnMcpIfPolName",
        ),
    ] = ""
