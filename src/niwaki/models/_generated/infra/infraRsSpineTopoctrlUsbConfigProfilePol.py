...
class infraRsSpineTopoctrlUsbConfigProfilePol(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "infraRsSpineTopoctrlUsbConfigProfilePol"
    _rn_format: ClassVar[str] = "rsspineTopoctrlUsbConfigProfilePol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4242": "fltInfraRsSpineTopoctrlUsbConfigProfilePolResolveFail",
    }
