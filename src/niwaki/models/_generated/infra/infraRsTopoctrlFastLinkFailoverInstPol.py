...
class infraRsTopoctrlFastLinkFailoverInstPol(ManagedObject):
    ...
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2901": "fltInfraRsTopoctrlFastLinkFailoverInstPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnTopoctrlFastLinkFailoverInstPolName",
            serialization_alias="tnTopoctrlFastLinkFailoverInstPolName",
        ),
    ] = ""
