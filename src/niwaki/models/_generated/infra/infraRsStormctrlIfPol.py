...
class infraRsStormctrlIfPol(ManagedObject):
    """ACI Managed Object: ``infraRsStormctrlIfPol`` — Relation to Storm Control Policy.

    RN format: ``rsstormctrlIfPol``
    """

    _aci_class: ClassVar[str] = "infraRsStormctrlIfPol"
    _rn_format: ClassVar[str] = "rsstormctrlIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1467": "fltInfraRsStormctrlIfPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnStormctrlIfPolName",
            serialization_alias="tnStormctrlIfPolName",
        ),
    ] = ""
