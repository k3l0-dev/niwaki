...
class infraFcAccPortGrp(ManagedObject):
    """ACI Managed Object: ``infraFcAccPortGrp`` — Leaf Access FC Port Policy Group.

    Used for representing leaf singular FC ports

    RN format: ``fcaccportgrp-{name}``
    """

    _aci_class: ClassVar[str] = "infraFcAccPortGrp"
    _rn_format: ClassVar[str] = "fcaccportgrp-{name}"
