...
class infraFexP(ManagedObject):
    """ACI Managed Object: ``infraFexP`` — FEX Profile.

    The FEX profile enables you to configure FEX interfaces.

    RN format: ``fexprof-{name}``
    """

    _aci_class: ClassVar[str] = "infraFexP"
    _rn_format: ClassVar[str] = "fexprof-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The fex profile name",
        ),
    ]
