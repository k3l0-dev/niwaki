...
class infraSpAccPortGrp(ManagedObject):
    """ACI Managed Object: ``infraSpAccPortGrp`` — Spine Access Port Policy Group.

    Used for respresting the spine singular ports

    RN format: ``spaccportgrp-{name}``
    """

    _aci_class: ClassVar[str] = "infraSpAccPortGrp"
    _rn_format: ClassVar[str] = "spaccportgrp-{name}"
