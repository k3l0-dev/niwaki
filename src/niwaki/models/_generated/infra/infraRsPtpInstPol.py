...
class infraRsPtpInstPol(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "infraRsPtpInstPol"
    _rn_format: ClassVar[str] = "rsptpInstPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4158": "fltInfraRsPtpInstPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnPtpInstPolName",
            serialization_alias="tnPtpInstPolName",
        ),
    ] = ""
