...
class infraAccNodePGrp(ManagedObject):
    """ACI Managed Object: ``infraAccNodePGrp`` — Access Switch Policy Group.

    The node policy group enables you to specify the node policies you want to use.

    RN format: ``accnodepgrp-{name}``
    """

    _aci_class: ClassVar[str] = "infraAccNodePGrp"
    _rn_format: ClassVar[str] = "accnodepgrp-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The node policy group name. This name can be up to 64 alphanumeric characters. Note that you cannot change this name after the object has been saved.",
        ),
    ]
