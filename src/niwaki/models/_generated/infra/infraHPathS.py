...
class infraHPathS(ManagedObject):
    """ACI Managed Object: ``infraHPathS`` — Host Path Selector.

    RN format: ``hpaths-{name}``
    """

    _aci_class: ClassVar[str] = "infraHPathS"
    _rn_format: ClassVar[str] = "hpaths-{name}"
