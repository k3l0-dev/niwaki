...
class infraRsOverrideFwPol(ManagedObject):
    """ACI Managed Object: ``infraRsOverrideFwPol`` — Relation to Firewall Policy.

    RN format: ``rsoverrideFwPol``
    """

    _aci_class: ClassVar[str] = "infraRsOverrideFwPol"
    _rn_format: ClassVar[str] = "rsoverrideFwPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1706": "fltInfraRsOverrideFwPolResolveFail",
    }
