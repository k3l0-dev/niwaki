...
class infraRsSynceInstPol(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "infraRsSynceInstPol"
    _rn_format: ClassVar[str] = "rssynceInstPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4122": "fltInfraRsSynceInstPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnSynceInstPolName",
            serialization_alias="tnSynceInstPolName",
        ),
    ] = ""
