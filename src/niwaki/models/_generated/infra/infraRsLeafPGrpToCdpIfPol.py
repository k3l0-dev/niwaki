...
class infraRsLeafPGrpToCdpIfPol(ManagedObject):
    """ACI Managed Object: ``infraRsLeafPGrpToCdpIfPol`` — Relation to cdp interface policy for mgmt port.

    Relationship to cdp interface policy for mgmt port

    RN format: ``rsleafPGrpToCdpIfPol``
    """

    _aci_class: ClassVar[str] = "infraRsLeafPGrpToCdpIfPol"
    _rn_format: ClassVar[str] = "rsleafPGrpToCdpIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3581": "fltInfraRsLeafPGrpToCdpIfPolResolveFail",
    }
