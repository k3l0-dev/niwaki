...
class infraRsLeafTopoctrlUsbConfigProfilePol(ManagedObject):
    """ACI Managed Object: ``infraRsLeafTopoctrlUsbConfigProfilePol`` — USB Config Policy.

    Relation to topoctrlUsbConfigProfilePol

    RN format: ``rsleafTopoctrlUsbConfigProfilePol``
    """

    _aci_class: ClassVar[str] = "infraRsLeafTopoctrlUsbConfigProfilePol"
    _rn_format: ClassVar[str] = "rsleafTopoctrlUsbConfigProfilePol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4241": "fltInfraRsLeafTopoctrlUsbConfigProfilePolResolveFail",
    }
