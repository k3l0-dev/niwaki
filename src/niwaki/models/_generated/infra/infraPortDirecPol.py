...
class infraPortDirecPol(ManagedObject):
    """ACI Managed Object: ``infraPortDirecPol`` — Port Status Infra Policy.

    RN format: ``prtdirec``
    """

    _aci_class: ClassVar[str] = "infraPortDirecPol"
    _rn_format: ClassVar[str] = "prtdirec"
