...
class infraFcAccBndlGrp(ManagedObject):
    """ACI Managed Object: ``infraFcAccBndlGrp`` — Leaf Access FC-PC Policy Group.

    Used for representing leaf FC port-channels

    RN format: ``fcaccbundle-{name}``
    """

    _aci_class: ClassVar[str] = "infraFcAccBndlGrp"
    _rn_format: ClassVar[str] = "fcaccbundle-{name}"
