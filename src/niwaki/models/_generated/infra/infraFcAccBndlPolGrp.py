...
class infraFcAccBndlPolGrp(ManagedObject):
    """ACI Managed Object: ``infraFcAccBndlPolGrp`` — Leaf Access FC-PC Policy override Group.

    Used for FC Port Channel overrides

    RN format: ``fcaccbundlepolgrp-{name}``
    """

    _aci_class: ClassVar[str] = "infraFcAccBndlPolGrp"
    _rn_format: ClassVar[str] = "fcaccbundlepolgrp-{name}"
