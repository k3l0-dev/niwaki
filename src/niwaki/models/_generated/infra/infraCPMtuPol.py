...
class infraCPMtuPol(ManagedObject):
    """ACI Managed Object: ``infraCPMtuPol`` — CP MTU Policy.

    RN format: ``CPMtu``
    """

    _aci_class: ClassVar[str] = "infraCPMtuPol"
    _rn_format: ClassVar[str] = "CPMtu"
    ...
    # ── Configurable ───────────────────────────────────────────────────────────
    apply_mtu_to_apic: bool = Field(default=False, alias="APICMtuApply")
    mtu_size_for_cp_traffic: Annotated[int, Field(ge=576, le=9216, alias="CPMtu")] = 9000
