...
class infraRsPoeIfPol(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "infraRsPoeIfPol"
    _rn_format: ClassVar[str] = "rspoeIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2823": "fltInfraRsPoeIfPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnPoeIfPolName",
            serialization_alias="tnPoeIfPolName",
        ),
    ] = ""
