...
class infraRsSpineCoppProfile(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "infraRsSpineCoppProfile"
    _rn_format: ClassVar[str] = "rsspineCoppProfile"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2689": "fltInfraRsSpineCoppProfileResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnCoppSpineProfileName",
            serialization_alias="tnCoppSpineProfileName",
        ),
    ] = ""
