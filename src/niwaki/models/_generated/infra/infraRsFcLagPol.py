...
class infraRsFcLagPol(ManagedObject):
    """ACI Managed Object: ``infraRsFcLagPol`` — Relation to Link Aggregation Interface Policy.

    Relationship to LACP PC Policy

    RN format: ``rsfcLagPol``
    """

    _aci_class: ClassVar[str] = "infraRsFcLagPol"
    _rn_format: ClassVar[str] = "rsfcLagPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3043": "fltInfraRsFcLagPolResolveFail",
    }
