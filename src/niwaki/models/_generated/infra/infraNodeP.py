...
class infraNodeP(ManagedObject):
    """ACI Managed Object: ``infraNodeP`` — Leaf Profile.

    The node profile enables you to specify which nodes (Example: a leaf) to configure.

    RN format: ``nprof-{name}``
    """

    _aci_class: ClassVar[str] = "infraNodeP"
    _rn_format: ClassVar[str] = "nprof-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The node policy name. This name can be up to 64 alphanumeric characters. Note that you cannot change this name after the object has been saved.",
        ),
    ]
