...
class infraDhcpPoolReconcile(ManagedObject):
    """ACI Managed Object: ``infraDhcpPoolReconcile`` — DhcpPool Reconcile Trigger.

    RN format: ``poolrecconfig-{id}``
    """

    _aci_class: ClassVar[str] = "infraDhcpPoolReconcile"
    _rn_format: ClassVar[str] = "poolrecconfig-{id}"
