...
class infraRsNetflowNodePol(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "infraRsNetflowNodePol"
    _rn_format: ClassVar[str] = "rsnetflowNodePol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2471": "fltInfraRsNetflowNodePolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnNetflowNodePolName",
            serialization_alias="tnNetflowNodePolName",
        ),
    ] = ""
