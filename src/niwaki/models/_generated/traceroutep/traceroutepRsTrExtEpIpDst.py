...
class traceroutepRsTrExtEpIpDst(ManagedObject):
    """ACI Managed Object: ``traceroutepRsTrExtEpIpDst`` — Relation to Destination End Point.

    RN format: ``rstrExtEpIpDst-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "traceroutepRsTrExtEpIpDst"
    _rn_format: ClassVar[str] = "rstrExtEpIpDst-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3157": "fltTraceroutepRsTrExtEpIpDstResolveFail",
    }
