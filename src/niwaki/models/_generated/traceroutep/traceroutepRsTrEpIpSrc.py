...
class traceroutepRsTrEpIpSrc(ManagedObject):
    """ACI Managed Object: ``traceroutepRsTrEpIpSrc`` — Source End Point.

    RN format: ``rstrEpIpSrc-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "traceroutepRsTrEpIpSrc"
    _rn_format: ClassVar[str] = "rstrEpIpSrc-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1351": "fltTraceroutepRsTrEpIpSrcResolveFail",
    }
