...
class traceroutepRsTrEpIpDst(ManagedObject):
    """ACI Managed Object: ``traceroutepRsTrEpIpDst`` — Relation to Destination End Point.

    RN format: ``rstrEpIpDst-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "traceroutepRsTrEpIpDst"
    _rn_format: ClassVar[str] = "rstrEpIpDst-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1350": "fltTraceroutepRsTrEpIpDstResolveFail",
    }
