...
class bfdMhIfPol(ManagedObject):
    """ACI Managed Object: ``bfdMhIfPol`` — BFD Interface Policy.

    RN format: ``bfdMhIfPol-{name}``
    """

    _aci_class: ClassVar[str] = "bfdMhIfPol"
    _rn_format: ClassVar[str] = "bfdMhIfPol-{name}"
