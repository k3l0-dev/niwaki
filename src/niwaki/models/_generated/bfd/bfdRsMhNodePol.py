...
class bfdRsMhNodePol(ManagedObject):
    """ACI Managed Object: ``bfdRsMhNodePol`` — Node Policy.

    Relationship to the BFD node policy

    RN format: ``rsMhNodePol``
    """

    _aci_class: ClassVar[str] = "bfdRsMhNodePol"
    _rn_format: ClassVar[str] = "rsMhNodePol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3798": "fltBfdRsMhNodePolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnBfdMhNodePolName",
            serialization_alias="tnBfdMhNodePolName",
        ),
    ] = ""
