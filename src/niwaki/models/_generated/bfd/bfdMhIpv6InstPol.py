...
class bfdMhIpv6InstPol(ManagedObject):
    """ACI Managed Object: ``bfdMhIpv6InstPol`` — BFD Global IPv6 MH Policy.

    RN format: ``bfdMhIpv6Inst-{name}``
    """

    _aci_class: ClassVar[str] = "bfdMhIpv6InstPol"
    _rn_format: ClassVar[str] = "bfdMhIpv6Inst-{name}"
