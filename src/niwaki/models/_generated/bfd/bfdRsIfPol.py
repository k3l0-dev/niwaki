...
class bfdRsIfPol(ManagedObject):
    """ACI Managed Object: ``bfdRsIfPol`` — Interface Policy.
    ...
    _aci_class: ClassVar[str] = "bfdRsIfPol"
    _rn_format: ClassVar[str] = "rsIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2145": "fltBfdRsIfPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnBfdIfPolName",
            serialization_alias="tnBfdIfPolName",
        ),
    ] = ""
