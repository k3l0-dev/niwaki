...
class bfdIpv4InstPol(ManagedObject):
    """ACI Managed Object: ``bfdIpv4InstPol`` — BFD Global IPv4 Policy.

    RN format: ``bfdIpv4Inst-{name}``
    """

    _aci_class: ClassVar[str] = "bfdIpv4InstPol"
    _rn_format: ClassVar[str] = "bfdIpv4Inst-{name}"
