...
class bfdMhIpv4InstPol(ManagedObject):
    """ACI Managed Object: ``bfdMhIpv4InstPol`` — BFD Global IPv4 MH Policy.

    RN format: ``bfdMhIpv4Inst-{name}``
    """

    _aci_class: ClassVar[str] = "bfdMhIpv4InstPol"
    _rn_format: ClassVar[str] = "bfdMhIpv4Inst-{name}"
