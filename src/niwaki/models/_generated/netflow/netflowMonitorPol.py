...
class netflowMonitorPol(ManagedObject):
    """ACI Managed Object: ``netflowMonitorPol`` — NetFlow Monitor.

    RN format: ``monitorpol-{name}``
    """

    _aci_class: ClassVar[str] = "netflowMonitorPol"
    _rn_format: ClassVar[str] = "monitorpol-{name}"
