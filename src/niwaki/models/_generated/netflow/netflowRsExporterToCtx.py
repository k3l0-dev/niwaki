...
class netflowRsExporterToCtx(ManagedObject):
    """ACI Managed Object: ``netflowRsExporterToCtx`` — Relation to Ctx behind which the Exporter resides.

    Points to the Ctx behind which the Netflow Exporter Resides

    RN format: ``rsexporterToCtx``
    """
