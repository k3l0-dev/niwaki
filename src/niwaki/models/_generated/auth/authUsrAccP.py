...
class authUsrAccP(ManagedObject):
    """ACI Managed Object: ``authUsrAccP`` — Server credential.

    RN format: ``usracc``
    """

    _aci_class: ClassVar[str] = "authUsrAccP"
    _rn_format: ClassVar[str] = "usracc"
    ...
    keyring_dn: str = Field(
        default="",
        validation_alias="keyRingDn",
        serialization_alias="keyRingDn",
        description="Key ring DN",
    )
