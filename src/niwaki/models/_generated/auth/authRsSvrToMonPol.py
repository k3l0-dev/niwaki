...
class authRsSvrToMonPol(ManagedObject):
    """ACI Managed Object: ``authRsSvrToMonPol`` — Monitoring Policy.

    Association to the monitoring policy for this Svr

    RN format: ``rssvrToMonPol``
    """

    _aci_class: ClassVar[str] = "authRsSvrToMonPol"
    _rn_format: ClassVar[str] = "rssvrToMonPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3182": "fltAuthRsSvrToMonPolResolveFail",
    }
