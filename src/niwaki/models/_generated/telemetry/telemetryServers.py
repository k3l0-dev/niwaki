...
class telemetryServers(ManagedObject):
    """ACI Managed Object: ``telemetryServers`` — Telemetry Server Container.

    RN format: ``servers``
    """

    _aci_class: ClassVar[str] = "telemetryServers"
    _rn_format: ClassVar[str] = "servers"
