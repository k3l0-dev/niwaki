...
class telemetryRsToRemoteLogServer(ManagedObject):
    """ACI Managed Object: ``telemetryRsToRemoteLogServer`` — Relation to Pol Group.

    RN format: ``rstoRemoteLogServer-{name}``
    """
