...
class telemetryRsToStatsServerGrp(ManagedObject):
    """ACI Managed Object: ``telemetryRsToStatsServerGrp`` — Stats Group.

    RN format: ``rstoStatsServerGrp-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "telemetryRsToStatsServerGrp"
    _rn_format: ClassVar[str] = "rstoStatsServerGrp-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2984": "fltTelemetryRsToStatsServerGrpResolveFail",
    }
