...
class telemetryRsToInbandEpg(ManagedObject):
    """ACI Managed Object: ``telemetryRsToInbandEpg`` — Inband Management through which traffic is sent.

    Association with the inband epg

    RN format: ``rstoInbandEpg``
    """

    _aci_class: ClassVar[str] = "telemetryRsToInbandEpg"
    _rn_format: ClassVar[str] = "rstoInbandEpg"
