...
class telemetryEventStreamP(ManagedObject):
    """ACI Managed Object: ``telemetryEventStreamP`` — Enable/Disable event streaming.

    RN format: ``evtstrm``
    """

    _aci_class: ClassVar[str] = "telemetryEventStreamP"
    _rn_format: ClassVar[str] = "evtstrm"
