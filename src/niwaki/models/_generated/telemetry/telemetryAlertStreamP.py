...
class telemetryAlertStreamP(ManagedObject):
    """ACI Managed Object: ``telemetryAlertStreamP`` — Enable/Disable Alert Consumer.

    RN format: ``alrtstrm``
    """

    _aci_class: ClassVar[str] = "telemetryAlertStreamP"
    _rn_format: ClassVar[str] = "alrtstrm"
