...
class telemetryRsServerToCtx(ManagedObject):
    """ACI Managed Object: ``telemetryRsServerToCtx`` — Relation to Ctx behind which the server policy resides.

    RN format: ``rsserverToCtx``
    """
