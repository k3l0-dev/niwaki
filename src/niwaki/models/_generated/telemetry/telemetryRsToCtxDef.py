...
class telemetryRsToCtxDef(ManagedObject):
    """ACI Managed Object: ``telemetryRsToCtxDef`` — Association to inband ctxdef.

    Association with inband ctxdef

    RN format: ``rstoCtxDef``
    """

    _aci_class: ClassVar[str] = "telemetryRsToCtxDef"
    _rn_format: ClassVar[str] = "rstoCtxDef"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3086": "fltTelemetryRsToCtxDefResolveFail",
    }
