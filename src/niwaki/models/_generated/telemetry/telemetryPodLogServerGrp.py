...
class telemetryPodLogServerGrp(ManagedObject):
    """ACI Managed Object: ``telemetryPodLogServerGrp`` — POD Maintenance Group.

    POD Telemetry Group. A set of PODs to which a telemetry log policy may be applied.

    RN format: ``podloggrp-{name}``
    """

    _aci_class: ClassVar[str] = "telemetryPodLogServerGrp"
    _rn_format: ClassVar[str] = "podloggrp-{name}"
