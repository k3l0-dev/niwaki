...
class telemetryEpStreamP(ManagedObject):
    """ACI Managed Object: ``telemetryEpStreamP`` — Enable/Disable ep streaming.

    RN format: ``epstrm``
    """

    _aci_class: ClassVar[str] = "telemetryEpStreamP"
    _rn_format: ClassVar[str] = "epstrm"
