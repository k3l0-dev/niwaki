...
class telemetryStatsServer(ManagedObject):
    """ACI Managed Object: ``telemetryStatsServer`` — Telemetry StatsServer.

    RN format: ``stserver-{name}``
    """

    _aci_class: ClassVar[str] = "telemetryStatsServer"
    _rn_format: ClassVar[str] = "stserver-{name}"
