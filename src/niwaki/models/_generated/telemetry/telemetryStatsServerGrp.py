...
class telemetryStatsServerGrp(ManagedObject):
    """ACI Managed Object: ``telemetryStatsServerGrp`` — Telemetry Policy Group.

    Telemtry Log Group. A set of nodes to which a telemetry log policy may be applied.

    RN format: ``statsgrp-{name}``
    """

    _aci_class: ClassVar[str] = "telemetryStatsServerGrp"
    _rn_format: ClassVar[str] = "statsgrp-{name}"
