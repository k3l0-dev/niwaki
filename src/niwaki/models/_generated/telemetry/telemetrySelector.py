...
class telemetrySelector(ManagedObject):
    """ACI Managed Object: ``telemetrySelector`` — Telemetry Selector.

    RN format: ``selector-{name}``
    """

    _aci_class: ClassVar[str] = "telemetrySelector"
    _rn_format: ClassVar[str] = "selector-{name}"
