...
class telemetryRsToInbEpg(ManagedObject):
    """ACI Managed Object: ``telemetryRsToInbEpg`` — Inband Management to be used.

    Association with the inband epg

    RN format: ``rsToInbEpg``
    """

    _aci_class: ClassVar[str] = "telemetryRsToInbEpg"
    _rn_format: ClassVar[str] = "rsToInbEpg"
