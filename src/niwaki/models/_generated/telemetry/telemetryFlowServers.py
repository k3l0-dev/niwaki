...
class telemetryFlowServers(ManagedObject):
    """ACI Managed Object: ``telemetryFlowServers`` — Telemetry Servers.

    RN format: ``flowserversp-{name}``
    """

    _aci_class: ClassVar[str] = "telemetryFlowServers"
    _rn_format: ClassVar[str] = "flowserversp-{name}"
    ...
    collection_interval_in_milliseconds: Annotated[
        int, Field(ge=100, le=1000, alias="collectIntvl", description="Collect interval")
    ] = 1000
