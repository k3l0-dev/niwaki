...
class telemetryRsToInbCtxDef(ManagedObject):
    """ACI Managed Object: ``telemetryRsToInbCtxDef`` — Association to inband ctxdef.

    Association with inband ctxdef

    RN format: ``rsToInbCtxDef``
    """

    _aci_class: ClassVar[str] = "telemetryRsToInbCtxDef"
    _rn_format: ClassVar[str] = "rsToInbCtxDef"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2966": "fltTelemetryRsToInbCtxDefResolveFail",
    }
