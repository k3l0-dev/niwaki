...
class telemetryRsToFltPolGrp(ManagedObject):
    """ACI Managed Object: ``telemetryRsToFltPolGrp`` — Relation to telemetry analytics filter Policy Group.

    RN format: ``rstoFltPolGrp-{name}``
    """
