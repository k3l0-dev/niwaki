...
class telemetryRsToLogServerGrp(ManagedObject):
    """ACI Managed Object: ``telemetryRsToLogServerGrp`` — Log Group.

    RN format: ``rstoLogServerGrp-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "telemetryRsToLogServerGrp"
    _rn_format: ClassVar[str] = "rstoLogServerGrp-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2978": "fltTelemetryRsToLogServerGrpResolveFail",
    }
