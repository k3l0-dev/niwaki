...
class l1FcPhysIfClearCountersLTask(ManagedObject):
    """ACI Managed Object: ``l1FcPhysIfClearCountersLTask``.

    RN format: ``l1FcPhysIfClearCountersLTask``
    """

    _aci_class: ClassVar[str] = "l1FcPhysIfClearCountersLTask"
    _rn_format: ClassVar[str] = "l1FcPhysIfClearCountersLTask"
