...
class l1PhysIfLocateLTask(ManagedObject):
    """ACI Managed Object: ``l1PhysIfLocateLTask``.

    A task object to set a beacon or port-locator LED to on or off for a port.

    RN format: ``l1PhysIfLocateLTask``
    """

    _aci_class: ClassVar[str] = "l1PhysIfLocateLTask"
    _rn_format: ClassVar[str] = "l1PhysIfLocateLTask"
