...
class l1PhysIfClearCountersLTask(ManagedObject):
    """ACI Managed Object: ``l1PhysIfClearCountersLTask``.

    A task object to clear counters of a port.

    RN format: ``l1PhysIfClearCountersLTask``
    """

    _aci_class: ClassVar[str] = "l1PhysIfClearCountersLTask"
    _rn_format: ClassVar[str] = "l1PhysIfClearCountersLTask"
