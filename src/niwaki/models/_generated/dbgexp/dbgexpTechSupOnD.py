...
class dbgexpTechSupOnD(ManagedObject):
    """ACI Managed Object: ``dbgexpTechSupOnD`` — TechSupport Export on Demand.
    ...
    _aci_class: ClassVar[str] = "dbgexpTechSupOnD"
    _rn_format: ClassVar[str] = "tsod-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the on-demand TechSupport object.",
        ),
    ]
