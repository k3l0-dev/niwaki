...
class dbgexpTechSupODev(ManagedObject):
    """ACI Managed Object: ``dbgexpTechSupODev`` — TechSupport Export Policy for ODev.

    Techsupport export for ODev

    RN format: ``tsodev-{name}``
    """

    _aci_class: ClassVar[str] = "dbgexpTechSupODev"
    _rn_format: ClassVar[str] = "tsodev-{name}"
