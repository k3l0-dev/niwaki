...
class dbgexpRsTSOnDScheduler(ManagedObject):
    """ACI Managed Object: ``dbgexpRsTSOnDScheduler`` — Relation to Techsupport Scheduler Policy.

    RN format: ``rsTSOnDScheduler``
    """

    _aci_class: ClassVar[str] = "dbgexpRsTSOnDScheduler"
    _rn_format: ClassVar[str] = "rsTSOnDScheduler"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3887": "fltDbgexpRsTSOnDSchedulerResolveFail",
    }
