...
class dbgexpRsTsODev(ManagedObject):
    """ACI Managed Object: ``dbgexpRsTsODev`` — Relation to ODev.

    Relation to source fabric node

    RN format: ``rstsODev-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "dbgexpRsTsODev"
    _rn_format: ClassVar[str] = "rstsODev-[{target_dn}]"
