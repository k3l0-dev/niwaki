...
class dbgexpTechSupTrigCollectLTask(ManagedObject):
    """ACI Managed Object: ``dbgexpTechSupTrigCollectLTask``.

    A local task for a tech support trigger collection.

    RN format: ``dbgexpTechSupTrigCollectLTask``
    """

    _aci_class: ClassVar[str] = "dbgexpTechSupTrigCollectLTask"
    _rn_format: ClassVar[str] = "dbgexpTechSupTrigCollectLTask"
    ...
    type: ActionType = Field(
        default=ActionType.COLLECT, description="The specific type of the object or component."
    )
