...
class dbgexpRsData(ManagedObject):
    """ACI Managed Object: ``dbgexpRsData`` — Relation to Techsupport Data Collection Policy.
    ...
    _aci_class: ClassVar[str] = "dbgexpRsData"
    _rn_format: ClassVar[str] = "rsdata"
