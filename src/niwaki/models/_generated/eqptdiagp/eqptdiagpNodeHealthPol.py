...
class eqptdiagpNodeHealthPol(ManagedObject):
    """ACI Managed Object: ``eqptdiagpNodeHealthPol`` — Equipment Diagnostic Node Health Policy.
    ...
    _aci_class: ClassVar[str] = "eqptdiagpNodeHealthPol"
    _rn_format: ClassVar[str] = "nodehlth"
    ...
    health_tests: Annotated[Flags[EqptdiagpNodeHealth], BeforeValidator(parse_flags)] = Field(
