...
class eqptdiagpLeTsHlSc(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "eqptdiagpLeTsHlSc"
    _rn_format: ClassVar[str] = "leHlSupDiags-{name}"
    ...
    diags_bm: Annotated[Flags[EqptdiagLeHlSupTestBmT], BeforeValidator(parse_flags)] = Field(
        default_factory=lambda: frozenset({EqptdiagLeHlSupTestBmT.NONE}),
    ...
    full_bm: Annotated[Flags[EqptdiagLeHlSupTestBmT], BeforeValidator(parse_flags)] = Field(
        default_factory=lambda: frozenset({EqptdiagLeHlSupTestBmT.NONE}),
