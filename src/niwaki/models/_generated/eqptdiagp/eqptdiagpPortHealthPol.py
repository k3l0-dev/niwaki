...
class eqptdiagpPortHealthPol(ManagedObject):
    """ACI Managed Object: ``eqptdiagpPortHealthPol`` — Equipment Diagnostic Port Health Policy.
    ...
    _aci_class: ClassVar[str] = "eqptdiagpPortHealthPol"
    _rn_format: ClassVar[str] = "porthlth"
    ...
    health_tests: Annotated[Flags[EqptdiagpPortHealth], BeforeValidator(parse_flags)] = Field(
