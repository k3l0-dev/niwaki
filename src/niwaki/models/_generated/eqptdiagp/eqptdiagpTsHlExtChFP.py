...
class eqptdiagpTsHlExtChFP(ManagedObject):
    """ACI Managed Object: ``eqptdiagpTsHlExtChFP`` — Health Diag Policy Set for ExtCh Fabric Port Types.

    RN format: ``hlEFpDiags-{name}``
    """

    _aci_class: ClassVar[str] = "eqptdiagpTsHlExtChFP"
    _rn_format: ClassVar[str] = "hlEFpDiags-{name}"
    ...
    diags_bm: Annotated[Flags[EqptdiagHlExtChFPTestBmT], BeforeValidator(parse_flags)] = Field(
        default_factory=lambda: frozenset({EqptdiagHlExtChFPTestBmT.NONE}),
    ...
    full_bm: Annotated[Flags[EqptdiagHlExtChFPTestBmT], BeforeValidator(parse_flags)] = Field(
        default_factory=lambda: frozenset({EqptdiagHlExtChFPTestBmT.NONE}),
