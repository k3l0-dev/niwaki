...
class eqptdiagpLeTsOdSc(ManagedObject):
    """ACI Managed Object: ``eqptdiagpLeTsOdSc`` — Leaf Line Card On-demand.

    RN format: ``leOdSupDiags-{name}``
    """

    _aci_class: ClassVar[str] = "eqptdiagpLeTsOdSc"
    _rn_format: ClassVar[str] = "leOdSupDiags-{name}"
