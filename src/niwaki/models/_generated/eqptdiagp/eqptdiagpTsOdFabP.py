...
class eqptdiagpTsOdFabP(ManagedObject):
    ...
    bitmask_of_diagnostics_tests_to_be_run: Annotated[
        Flags[EqptdiagOdFabPTestBmT], BeforeValidator(parse_flags)
    ] = Field(
        default_factory=lambda: frozenset({EqptdiagOdFabPTestBmT.NONE}),
        validation_alias="diagsBm",
        serialization_alias="diagsBm",
        description="The bitmask of diagnostic test groups that are enabled.",
    )
    full_diagnostics: Annotated[Flags[EqptdiagOdFabPTestBmT], BeforeValidator(parse_flags)] = Field(
        default_factory=lambda: frozenset({EqptdiagOdFabPTestBmT.NONE}),
