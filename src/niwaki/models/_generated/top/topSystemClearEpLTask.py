...
class topSystemClearEpLTask(ManagedObject):
    """ACI Managed Object: ``topSystemClearEpLTask``.

    RN format: ``topSystemClearEpLTask``
    """

    _aci_class: ClassVar[str] = "topSystemClearEpLTask"
    _rn_format: ClassVar[str] = "topSystemClearEpLTask"
