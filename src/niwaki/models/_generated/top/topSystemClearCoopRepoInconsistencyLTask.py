...
class topSystemClearCoopRepoInconsistencyLTask(ManagedObject):
    """ACI Managed Object: ``topSystemClearCoopRepoInconsistencyLTask``.

    RN format: ``topSystemClearCoopRepoInconsistencyLTask``
    """

    _aci_class: ClassVar[str] = "topSystemClearCoopRepoInconsistencyLTask"
    _rn_format: ClassVar[str] = "topSystemClearCoopRepoInconsistencyLTask"
