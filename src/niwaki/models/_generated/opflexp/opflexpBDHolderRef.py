...
class opflexpBDHolderRef(ManagedObject):
    """ACI Managed Object: ``opflexpBDHolderRef``.

    RN format: ``bdholder-[{bd_dn}]``
    """

    _aci_class: ClassVar[str] = "opflexpBDHolderRef"
    _rn_format: ClassVar[str] = "bdholder-[{bd_dn}]"
    _naming_props: ClassVar[list[str]] = ["bd_dn"]
    ...
    # ── Naming (required) ──────────────────────────────────────────────────────
    bd_dn: Annotated[str, Field(alias="bdDn")]
