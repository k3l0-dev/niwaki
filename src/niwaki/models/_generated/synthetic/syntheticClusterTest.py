...
class syntheticClusterTest(ManagedObject):
    """ACI Managed Object: ``syntheticClusterTest``.

    RN format: ``clustertest``
    """

    _aci_class: ClassVar[str] = "syntheticClusterTest"
    _rn_format: ClassVar[str] = "clustertest"
