...
class syntheticCtAv(ManagedObject):
    """ACI Managed Object: ``syntheticCtAv`` — Test Object for Access:Cont.

    RN format: ``ctav``
    """

    _aci_class: ClassVar[str] = "syntheticCtAv"
    _rn_format: ClassVar[str] = "ctav"
