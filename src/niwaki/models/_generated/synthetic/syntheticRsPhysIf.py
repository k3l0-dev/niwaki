...
class syntheticRsPhysIf(ManagedObject):
    """ACI Managed Object: ``syntheticRsPhysIf`` — Layer 1 Physical Interface Configuration.
    ...
    _aci_class: ClassVar[str] = "syntheticRsPhysIf"
    _rn_format: ClassVar[str] = "rsPhysIf"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1053": "fltSyntheticRsPhysIfResolveFail",
    }
