...
class syntheticContext2(ManagedObject):
    """ACI Managed Object: ``syntheticContext2``.

    RN format: ``context2-{name}``
    """

    _aci_class: ClassVar[str] = "syntheticContext2"
    _rn_format: ClassVar[str] = "context2-{name}"
