...
class syntheticRsUnenfPolicy(ManagedObject):
    """ACI Managed Object: ``syntheticRsUnenfPolicy``.

    RN format: ``rsunenfPolicy-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "syntheticRsUnenfPolicy"
    _rn_format: ClassVar[str] = "rsunenfPolicy-[{target_dn}]"
