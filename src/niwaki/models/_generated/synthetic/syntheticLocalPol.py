...
class syntheticLocalPol(ManagedObject):
    """ACI Managed Object: ``syntheticLocalPol``.

    RN format: ``localpol-{name}``
    """

    _aci_class: ClassVar[str] = "syntheticLocalPol"
    _rn_format: ClassVar[str] = "localpol-{name}"
