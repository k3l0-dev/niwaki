...
class syntheticRsPolicy(ManagedObject):
    """ACI Managed Object: ``syntheticRsPolicy``.
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnSyntheticPolicyName",
            serialization_alias="tnSyntheticPolicyName",
        ),
    ] = ""
