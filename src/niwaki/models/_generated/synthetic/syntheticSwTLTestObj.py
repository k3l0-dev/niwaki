...
class syntheticSwTLTestObj(ManagedObject):
    """ACI Managed Object: ``syntheticSwTLTestObj`` — Synthetic Sw TL Test Object.

    RN format: ``sectl-{name}``
    """

    _aci_class: ClassVar[str] = "syntheticSwTLTestObj"
    _rn_format: ClassVar[str] = "sectl-{name}"
