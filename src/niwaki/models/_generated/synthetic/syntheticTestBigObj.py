...
class syntheticTestBigObj(ManagedObject):
    """ACI Managed Object: ``syntheticTestBigObj``.

    RN format: ``testbigobj``
    """

    _aci_class: ClassVar[str] = "syntheticTestBigObj"
    _rn_format: ClassVar[str] = "testbigobj"
