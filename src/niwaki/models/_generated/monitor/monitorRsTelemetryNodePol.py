...
class monitorRsTelemetryNodePol(ManagedObject):
    """ACI Managed Object: ``monitorRsTelemetryNodePol`` — Relation to telemetry node policy.

    RN format: ``rstelemetryNodePol``
    """

    _aci_class: ClassVar[str] = "monitorRsTelemetryNodePol"
    _rn_format: ClassVar[str] = "rstelemetryNodePol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4404": "fltMonitorRsTelemetryNodePolResolveFail",
    }
