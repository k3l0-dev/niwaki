...
class monitorIntfP(ManagedObject):
    """ACI Managed Object: ``monitorIntfP`` — Interface Profile.

    RN format: ``intfp-{name}``
    """

    _aci_class: ClassVar[str] = "monitorIntfP"
    _rn_format: ClassVar[str] = "intfp-{name}"
