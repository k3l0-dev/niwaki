...
class monitorIntfPolGrp(ManagedObject):
    """ACI Managed Object: ``monitorIntfPolGrp`` — Access Node Configuration.

    RN format: ``intfpolgrp-{name}``
    """

    _aci_class: ClassVar[str] = "monitorIntfPolGrp"
    _rn_format: ClassVar[str] = "intfpolgrp-{name}"
