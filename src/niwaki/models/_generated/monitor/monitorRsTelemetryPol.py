...
class monitorRsTelemetryPol(ManagedObject):
    """ACI Managed Object: ``monitorRsTelemetryPol`` — Relation to telemetry policy.

    RN format: ``rstelemetryPol``
    """

    _aci_class: ClassVar[str] = "monitorRsTelemetryPol"
    _rn_format: ClassVar[str] = "rstelemetryPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4401": "fltMonitorRsTelemetryPolResolveFail",
    }
