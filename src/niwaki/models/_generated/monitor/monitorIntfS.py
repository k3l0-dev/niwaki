...
class monitorIntfS(ManagedObject):
    """ACI Managed Object: ``monitorIntfS`` — Switch Association.

    RN format: ``intfs-{name}-type-{selector_type}``
    """

    _aci_class: ClassVar[str] = "monitorIntfS"
    _rn_format: ClassVar[str] = "intfs-{name}-type-{selector_type}"
