...
class monitorNodePolGrp(ManagedObject):
    """ACI Managed Object: ``monitorNodePolGrp`` — Access Node Configuration.

    RN format: ``nodepolgrp-{name}``
    """

    _aci_class: ClassVar[str] = "monitorNodePolGrp"
    _rn_format: ClassVar[str] = "nodepolgrp-{name}"
