...
class monitorNodeP(ManagedObject):
    """ACI Managed Object: ``monitorNodeP`` — Leaf Profile.

    RN format: ``nodep-{name}``
    """

    _aci_class: ClassVar[str] = "monitorNodeP"
    _rn_format: ClassVar[str] = "nodep-{name}"
