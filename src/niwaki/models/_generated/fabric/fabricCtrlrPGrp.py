...
class fabricCtrlrPGrp(ManagedObject):
    """ACI Managed Object: ``fabricCtrlrPGrp`` — Controller Policy Group.

    The controller policy group enables you to apply policies to a group of controllers.

    RN format: ``ctrlrgrp-{name}``
    """

    _aci_class: ClassVar[str] = "fabricCtrlrPGrp"
    _rn_format: ClassVar[str] = "ctrlrgrp-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of a controller policy group. This name can be up to 64 alphanumeric characters.",
        ),
    ]
