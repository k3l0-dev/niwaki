...
class fabricOLeafS(ManagedObject):
    """ACI Managed Object: ``fabricOLeafS`` — Override Leaf Selector.

    Override Leaf Selector

    RN format: ``oleaves-{name}``
    """

    _aci_class: ClassVar[str] = "fabricOLeafS"
    _rn_format: ClassVar[str] = "oleaves-{name}"
