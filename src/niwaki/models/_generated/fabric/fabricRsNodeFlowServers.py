...
class fabricRsNodeFlowServers(ManagedObject):
    """ACI Managed Object: ``fabricRsNodeFlowServers`` — Telemetry Policy.

    Telemetry policy

    RN format: ``rsnodeFlowServers``
    """

    _aci_class: ClassVar[str] = "fabricRsNodeFlowServers"
    _rn_format: ClassVar[str] = "rsnodeFlowServers"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2962": "fltFabricRsNodeFlowServersResolveFail",
    }
