...
class fabricRsLePortP(ManagedObject):
    """ACI Managed Object: ``fabricRsLePortP`` — Leaf Interface Profile.

    A source relation to the leaf fabric port profile.

    RN format: ``rslePortP-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "fabricRsLePortP"
    _rn_format: ClassVar[str] = "rslePortP-[{target_dn}]"
