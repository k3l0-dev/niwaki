...
class fabricRsApplMonPol(ManagedObject):
    """ACI Managed Object: ``fabricRsApplMonPol`` — Monitoring Policy.

    A source relation to the monitoring policy model for the fabric semantic scope.

    RN format: ``rsapplMonPol``
    """

    _aci_class: ClassVar[str] = "fabricRsApplMonPol"
    _rn_format: ClassVar[str] = "rsapplMonPol"
