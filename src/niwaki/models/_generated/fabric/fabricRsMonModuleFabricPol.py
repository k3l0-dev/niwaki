...
class fabricRsMonModuleFabricPol(ManagedObject):
    """ACI Managed Object: ``fabricRsMonModuleFabricPol`` — Monitoring Policy.

    A source relation to the monitoring policy model for the fabric semantic scope.

    RN format: ``rsmonModuleFabricPol``
    """

    _aci_class: ClassVar[str] = "fabricRsMonModuleFabricPol"
    _rn_format: ClassVar[str] = "rsmonModuleFabricPol"
