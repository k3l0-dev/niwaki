...
class fabricNodeBlk(ManagedObject):
    """ACI Managed Object: ``fabricNodeBlk`` — Node Block.
    ...
    _aci_class: ClassVar[str] = "fabricNodeBlk"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the node block.",
        ),
    ]
