...
class fabricRsNodeTechSupP(ManagedObject):
    """ACI Managed Object: ``fabricRsNodeTechSupP`` — Tech Support Policy.
    ...
    RN format: ``rsnodeTechSupP``
    """

    _aci_class: ClassVar[str] = "fabricRsNodeTechSupP"
    _rn_format: ClassVar[str] = "rsnodeTechSupP"
    ...
    name: Annotated[
        ...
        Field(
            ...
            description="The tech support policy name. This name can be up to 64 characters. Note that you cannot change this name after the object has been saved.",
        ),
    ] = ""
