...
class fabricOSpineS(ManagedObject):
    """ACI Managed Object: ``fabricOSpineS`` — Override Spine Selector.

    Override Spine Selector

    RN format: ``ospines-{name}``
    """

    _aci_class: ClassVar[str] = "fabricOSpineS"
    _rn_format: ClassVar[str] = "ospines-{name}"
