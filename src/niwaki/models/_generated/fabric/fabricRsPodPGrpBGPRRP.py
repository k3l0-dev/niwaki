...
class fabricRsPodPGrpBGPRRP(ManagedObject):
    """ACI Managed Object: ``fabricRsPodPGrpBGPRRP`` — BGP Instance Policy.

    RN format: ``rspodPGrpBGPRRP``
    """

    _aci_class: ClassVar[str] = "fabricRsPodPGrpBGPRRP"
    _rn_format: ClassVar[str] = "rspodPGrpBGPRRP"
    ...
    name: Annotated[
        str, Field(max_length=64, pattern="^[a-zA-Z0-9_.:-]+$", alias="tnBgpInstPolName")
    ] = ""
