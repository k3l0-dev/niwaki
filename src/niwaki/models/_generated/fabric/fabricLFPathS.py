...
class fabricLFPathS(ManagedObject):
    """ACI Managed Object: ``fabricLFPathS`` — Leaf Path Selector.

    RN format: ``lfpaths-{name}``
    """

    _aci_class: ClassVar[str] = "fabricLFPathS"
    _rn_format: ClassVar[str] = "lfpaths-{name}"
