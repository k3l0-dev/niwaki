...
class fabricRsVpcInstPol(ManagedObject):
    """ACI Managed Object: ``fabricRsVpcInstPol`` — Relation to VPC Domain Policy.

    A source relation to the node-level vPC domain policy.

    RN format: ``rsvpcInstPol``
    """

    _aci_class: ClassVar[str] = "fabricRsVpcInstPol"
    _rn_format: ClassVar[str] = "rsvpcInstPol"
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnVpcInstPolName",
            serialization_alias="tnVpcInstPolName",
        ),
    ] = ""
