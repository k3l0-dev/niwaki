...
class fabricRsApplTechSupP(ManagedObject):
    """ACI Managed Object: ``fabricRsApplTechSupP`` — Tech Support Policy.

    RN format: ``rsapplTechSupP``
    """

    _aci_class: ClassVar[str] = "fabricRsApplTechSupP"
    _rn_format: ClassVar[str] = "rsapplTechSupP"
