...
class fabricRsApplTechSupOnDemand(ManagedObject):
    """ACI Managed Object: ``fabricRsApplTechSupOnDemand`` — Tech Support Policy for On-demand Collection.

    RN format: ``rsapplTechSupOnDemand-{name}``
    """

    _aci_class: ClassVar[str] = "fabricRsApplTechSupOnDemand"
    _rn_format: ClassVar[str] = "rsapplTechSupOnDemand-{name}"
    _naming_props: ClassVar[list[str]] = ["name"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3554": "fltFabricRsApplTechSupOnDemandResolveFail",
    }
