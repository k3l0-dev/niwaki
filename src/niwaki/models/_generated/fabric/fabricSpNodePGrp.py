...
class fabricSpNodePGrp(ManagedObject):
    """ACI Managed Object: ``fabricSpNodePGrp`` — Spine Switch Policy Group.

    A spine node policy group enables you to apply policies to a group of spine nodes.

    RN format: ``spnodepgrp-{name}``
    """

    _aci_class: ClassVar[str] = "fabricSpNodePGrp"
    _rn_format: ClassVar[str] = "spnodepgrp-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the spine node policy group. This name can be up to 64 characters. Note that you cannot change this name after the object has been saved.",
        ),
    ]
