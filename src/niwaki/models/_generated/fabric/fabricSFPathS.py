...
class fabricSFPathS(ManagedObject):
    """ACI Managed Object: ``fabricSFPathS`` — Spine Path Selector.

    RN format: ``sfpaths-{name}``
    """

    _aci_class: ClassVar[str] = "fabricSFPathS"
    _rn_format: ClassVar[str] = "sfpaths-{name}"
