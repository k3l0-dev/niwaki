...
class fabricBlacklistPol(ManagedObject):
    """ACI Managed Object: ``fabricBlacklistPol`` — Admin Down Policy.
    ...
    _aci_class: ClassVar[str] = "fabricBlacklistPol"
    _rn_format: ClassVar[str] = "blklist"
