...
class fabricRsMacsecPol(ManagedObject):
    """ACI Managed Object: ``fabricRsMacsecPol`` — macsec Policy.

    MACSEC policy

    RN format: ``rsmacsecPol``
    """

    _aci_class: ClassVar[str] = "fabricRsMacsecPol"
    _rn_format: ClassVar[str] = "rsmacsecPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2659": "fltFabricRsMacsecPolResolveFail",
    }
