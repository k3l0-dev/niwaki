...
class fabricRsNodeCfgSrv(ManagedObject):
    """ACI Managed Object: ``fabricRsNodeCfgSrv`` — Analytics Config Server Policy.

    Analytics Config Server Policy

    RN format: ``rsnodeCfgSrv``
    """

    _aci_class: ClassVar[str] = "fabricRsNodeCfgSrv"
    _rn_format: ClassVar[str] = "rsnodeCfgSrv"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2123": "fltFabricRsNodeCfgSrvResolveFail",
    }
