...
class fabricLeNodePGrp(ManagedObject):
    """ACI Managed Object: ``fabricLeNodePGrp`` — Leaf Switch Policy Group.

    A leaf node policy group enables you to apply policies to a group of leaf nodes.

    RN format: ``lenodepgrp-{name}``
    """

    _aci_class: ClassVar[str] = "fabricLeNodePGrp"
    _rn_format: ClassVar[str] = "lenodepgrp-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the leaf node policy group. This name can be up to 64 characters. Note that you cannot change this name after the object has been saved.",
        ),
    ]
