...
class fabricRsCommPol(ManagedObject):
    """ACI Managed Object: ``fabricRsCommPol`` — Communication Policy.

    RN format: ``rsCommPol``
    """

    _aci_class: ClassVar[str] = "fabricRsCommPol"
    _rn_format: ClassVar[str] = "rsCommPol"
    ...
    name: Annotated[
        str, Field(max_length=64, pattern="^[a-zA-Z0-9_.:-]+$", alias="tnCommPolName")
    ] = ""
