...
class fabricRsLFPathAtt(ManagedObject):
    """ACI Managed Object: ``fabricRsLFPathAtt`` — Leaf Fabric Path.

    RN format: ``rslFPathAtt-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "fabricRsLFPathAtt"
    _rn_format: ClassVar[str] = "rslFPathAtt-[{target_dn}]"
