...
class fabricRsFLinkFlapPol(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "fabricRsFLinkFlapPol"
    _rn_format: ClassVar[str] = "rsfLinkFlapPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4011": "fltFabricRsFLinkFlapPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnFabricFLinkFlapPolName",
            serialization_alias="tnFabricFLinkFlapPolName",
        ),
    ] = ""
