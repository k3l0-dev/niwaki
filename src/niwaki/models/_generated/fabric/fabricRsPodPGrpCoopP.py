...
class fabricRsPodPGrpCoopP(ManagedObject):
    """ACI Managed Object: ``fabricRsPodPGrpCoopP`` — COOP Group Policy.

    RN format: ``rspodPGrpCoopP``
    """

    _aci_class: ClassVar[str] = "fabricRsPodPGrpCoopP"
    _rn_format: ClassVar[str] = "rspodPGrpCoopP"
    ...
    name: Annotated[
        str, Field(max_length=64, pattern="^[a-zA-Z0-9_.:-]+$", alias="tnCoopPolName")
    ] = ""
