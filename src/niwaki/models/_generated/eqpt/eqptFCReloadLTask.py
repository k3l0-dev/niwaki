...
class eqptFCReloadLTask(ManagedObject):
    """ACI Managed Object: ``eqptFCReloadLTask``.

    A task to reload the fabric card.

    RN format: ``eqptFCReloadLTask``
    """

    _aci_class: ClassVar[str] = "eqptFCReloadLTask"
    _rn_format: ClassVar[str] = "eqptFCReloadLTask"
