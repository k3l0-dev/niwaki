...
class eqptSupCReloadLTask(ManagedObject):
    """ACI Managed Object: ``eqptSupCReloadLTask``.

    A task to reload a supervisor card.

    RN format: ``eqptSupCReloadLTask``
    """

    _aci_class: ClassVar[str] = "eqptSupCReloadLTask"
    _rn_format: ClassVar[str] = "eqptSupCReloadLTask"
