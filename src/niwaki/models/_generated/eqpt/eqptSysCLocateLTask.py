...
class eqptSysCLocateLTask(ManagedObject):
    """ACI Managed Object: ``eqptSysCLocateLTask``.

    A task to locate a system card.

    RN format: ``eqptSysCLocateLTask``
    """

    _aci_class: ClassVar[str] = "eqptSysCLocateLTask"
    _rn_format: ClassVar[str] = "eqptSysCLocateLTask"
