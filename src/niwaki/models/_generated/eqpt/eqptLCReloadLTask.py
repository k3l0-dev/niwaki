...
class eqptLCReloadLTask(ManagedObject):
    """ACI Managed Object: ``eqptLCReloadLTask``.

    A task to reload the line card.

    RN format: ``eqptLCReloadLTask``
    """

    _aci_class: ClassVar[str] = "eqptLCReloadLTask"
    _rn_format: ClassVar[str] = "eqptLCReloadLTask"
