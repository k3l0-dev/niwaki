...
class eqptLCLocateLTask(ManagedObject):
    """ACI Managed Object: ``eqptLCLocateLTask``.

    A task to locate the line card.

    RN format: ``eqptLCLocateLTask``
    """

    _aci_class: ClassVar[str] = "eqptLCLocateLTask"
    _rn_format: ClassVar[str] = "eqptLCLocateLTask"
