...
class eqptFtLocateLTask(ManagedObject):
    """ACI Managed Object: ``eqptFtLocateLTask``.

    A task to locate a fan tray.

    RN format: ``eqptFtLocateLTask``
    """

    _aci_class: ClassVar[str] = "eqptFtLocateLTask"
    _rn_format: ClassVar[str] = "eqptFtLocateLTask"
