...
class eqptSlotSetInServiceLTask(ManagedObject):
    """ACI Managed Object: ``eqptSlotSetInServiceLTask``.

    RN format: ``eqptSlotSetInServiceLTask``
    """

    _aci_class: ClassVar[str] = "eqptSlotSetInServiceLTask"
    _rn_format: ClassVar[str] = "eqptSlotSetInServiceLTask"
