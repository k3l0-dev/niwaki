...
class eqptChLocateLTask(ManagedObject):
    """ACI Managed Object: ``eqptChLocateLTask``.

    A local task to turn on the beacon LED on the chassis.

    RN format: ``eqptChLocateLTask``
    """

    _aci_class: ClassVar[str] = "eqptChLocateLTask"
    _rn_format: ClassVar[str] = "eqptChLocateLTask"
    ...
    type: ActionType = Field(default=ActionType.LOCATE, description="The task rule type.")
