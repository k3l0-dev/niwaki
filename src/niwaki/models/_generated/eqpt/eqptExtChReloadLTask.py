...
class eqptExtChReloadLTask(ManagedObject):
    """ACI Managed Object: ``eqptExtChReloadLTask``.

    A task to reload the external chassis.

    RN format: ``eqptExtChReloadLTask``
    """

    _aci_class: ClassVar[str] = "eqptExtChReloadLTask"
    _rn_format: ClassVar[str] = "eqptExtChReloadLTask"
    ...
    type: ActionType = Field(
        default=ActionType.RELOAD, description="The specific type of the object or component."
    )
