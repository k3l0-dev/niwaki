...
class eqptSupCLocateLTask(ManagedObject):
    """ACI Managed Object: ``eqptSupCLocateLTask``.

    A task to locate a supervisor card.

    RN format: ``eqptSupCLocateLTask``
    """

    _aci_class: ClassVar[str] = "eqptSupCLocateLTask"
    _rn_format: ClassVar[str] = "eqptSupCLocateLTask"
