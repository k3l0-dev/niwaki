...
class eqptFCPoweroffLTask(ManagedObject):
    """ACI Managed Object: ``eqptFCPoweroffLTask``.

    RN format: ``eqptFCPoweroffLTask``
    """

    _aci_class: ClassVar[str] = "eqptFCPoweroffLTask"
    _rn_format: ClassVar[str] = "eqptFCPoweroffLTask"
