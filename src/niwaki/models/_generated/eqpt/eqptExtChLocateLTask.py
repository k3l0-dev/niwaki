...
class eqptExtChLocateLTask(ManagedObject):
    """ACI Managed Object: ``eqptExtChLocateLTask``.

    A task to locate the external chassis.

    RN format: ``eqptExtChLocateLTask``
    """

    _aci_class: ClassVar[str] = "eqptExtChLocateLTask"
    _rn_format: ClassVar[str] = "eqptExtChLocateLTask"
    ...
    type: ActionType = Field(
        default=ActionType.LOCATE, description="The specific type of the object or component."
    )
