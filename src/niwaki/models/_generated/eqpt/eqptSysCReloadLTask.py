...
class eqptSysCReloadLTask(ManagedObject):
    """ACI Managed Object: ``eqptSysCReloadLTask``.

    A task to reload a system card.

    RN format: ``eqptSysCReloadLTask``
    """

    _aci_class: ClassVar[str] = "eqptSysCReloadLTask"
    _rn_format: ClassVar[str] = "eqptSysCReloadLTask"
