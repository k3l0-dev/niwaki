...
class eqptLCPoweroffLTask(ManagedObject):
    """ACI Managed Object: ``eqptLCPoweroffLTask``.

    RN format: ``eqptLCPoweroffLTask``
    """

    _aci_class: ClassVar[str] = "eqptLCPoweroffLTask"
    _rn_format: ClassVar[str] = "eqptLCPoweroffLTask"
