...
class eqptFlashConfig(ManagedObject):
    """ACI Managed Object: ``eqptFlashConfig`` — FlashConfig.

    Configure Flash thresholds

    RN format: ``flashconfig``
    """

    _aci_class: ClassVar[str] = "eqptFlashConfig"
    _rn_format: ClassVar[str] = "flashconfig"
