...
class eqptSysCPoweroffLTask(ManagedObject):
    """ACI Managed Object: ``eqptSysCPoweroffLTask``.

    RN format: ``eqptSysCPoweroffLTask``
    """

    _aci_class: ClassVar[str] = "eqptSysCPoweroffLTask"
    _rn_format: ClassVar[str] = "eqptSysCPoweroffLTask"
    ...
    type: ActionType = Field(default=ActionType.POWEROFF, description="Task rule type")
