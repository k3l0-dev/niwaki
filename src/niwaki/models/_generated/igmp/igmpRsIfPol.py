...
class igmpRsIfPol(ManagedObject):
    """ACI Managed Object: ``igmpRsIfPol`` — Interface Policy.

    Relationship to the IGMP interface policy

    RN format: ``rsIfPol``
    """

    _aci_class: ClassVar[str] = "igmpRsIfPol"
    _rn_format: ClassVar[str] = "rsIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2250": "fltIgmpRsIfPolResolveFail",
    }
