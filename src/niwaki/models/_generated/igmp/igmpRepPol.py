...
class igmpRepPol(ManagedObject):
    """ACI Managed Object: ``igmpRepPol`` — Report Policy.

    RN format: ``igmprepPol``
    """

    _aci_class: ClassVar[str] = "igmpRepPol"
    _rn_format: ClassVar[str] = "igmprepPol"
