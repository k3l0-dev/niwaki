...
class trigMeta(ManagedObject):
    """ACI Managed Object: ``trigMeta``.

    The meta scheduler.

    RN format: ``metatrig-{sched_name}``
    """

    _aci_class: ClassVar[str] = "trigMeta"
    _rn_format: ClassVar[str] = "metatrig-{sched_name}"
    _naming_props: ClassVar[list[str]] = ["sched_name"]
    ...
    sched_name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="schedName",
            serialization_alias="schedName",
        ),
    ]
    ...
    admin_state: TrigAdminState = Field(
        ...
        description="The administrative state of the trigger instance.",
    )
