...
class trigAbsWindowP(ManagedObject):
    """ACI Managed Object: ``trigAbsWindowP`` — One Time Window.

    A schedule window with absolute start and end times.

    RN format: ``abswinp-{name}``
    """

    _aci_class: ClassVar[str] = "trigAbsWindowP"
    _rn_format: ClassVar[str] = "abswinp-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=16,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the schedule window.",
        ),
    ]
    ...
    date_and_time: str = Field(
        ...
        description="The date that the schedule window starts.",
    )
