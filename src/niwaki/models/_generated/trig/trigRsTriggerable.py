...
class trigRsTriggerable(ManagedObject):
    """ACI Managed Object: ``trigRsTriggerable`` — Relation to Triggerable Policy.

    A source relation to the container for a triggerable object.

    RN format: ``rsTriggerable``
    """

    _aci_class: ClassVar[str] = "trigRsTriggerable"
    _rn_format: ClassVar[str] = "rsTriggerable"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1062": "fltTrigRsTriggerableResolveFail",
    }
