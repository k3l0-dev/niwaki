...
class trigRecurrWindowP(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "trigRecurrWindowP"
    _rn_format: ClassVar[str] = "recurrwinp-{name}"
    ...
    recurring_window_schedule_day: TrigDay = Field(
        ...
        serialization_alias="day",
        description="The day of the week that the recurring window begins.",
    )
    schedule_hour: Annotated[
        int,
        Field(
            ge=0,
            le=23,
            validation_alias="hour",
            serialization_alias="hour",
            description="The hour that the recurring window begins.",
        ),
    ] = 0
    schedule_minute: Annotated[
        int,
        Field(
            ge=0,
            le=59,
            validation_alias="minute",
            serialization_alias="minute",
            description="The minute that the recurring window begins.",
        ),
    ] = 0
