...
class mplsRsIfPol(ManagedObject):
    """ACI Managed Object: ``mplsRsIfPol`` — Mpls IfPol Relation.
    ...
    _aci_class: ClassVar[str] = "mplsRsIfPol"
    _rn_format: ClassVar[str] = "rsIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3742": "fltMplsRsIfPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnMplsIfPolName",
            serialization_alias="tnMplsIfPolName",
        ),
    ] = ""
