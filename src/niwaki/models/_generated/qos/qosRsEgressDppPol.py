...
class qosRsEgressDppPol(ManagedObject):
    """ACI Managed Object: ``qosRsEgressDppPol`` — Policing policy that need to enforced in egress direction.

    RN format: ``rsegressDppPol``
    """
