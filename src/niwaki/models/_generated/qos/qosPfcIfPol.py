...
class qosPfcIfPol(ManagedObject):
    """ACI Managed Object: ``qosPfcIfPol`` — Interface Priority Flow Control Policy.

    RN format: ``pfc-{name}``
    """

    _aci_class: ClassVar[str] = "qosPfcIfPol"
    _rn_format: ClassVar[str] = "pfc-{name}"
    ...
    # ── Configurable ───────────────────────────────────────────────────────────
    priority_flow_control_mode: L1PrioFlowCtrl = Field(default=L1PrioFlowCtrl.AUTO, alias="adminSt")
