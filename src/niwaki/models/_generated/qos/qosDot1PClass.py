...
class qosDot1PClass(ManagedObject):
    """ACI Managed Object: ``qosDot1PClass`` — Dot1P Class to Priority Mapping Policy.

    The class level for dot1P to prioritize the map.

    RN format: ``dot1P-{from_}-{to}``
    """

    _aci_class: ClassVar[str] = "qosDot1PClass"
    _rn_format: ClassVar[str] = "dot1P-{from_}-{to}"
    ...
    from_: Annotated[
        ...
        Field(
            ...
            description="The Dot1p priority range starting value.",
        ),
    ] = "unspecified"
    to: Annotated[
        Annotated[int, Field(ge=0, le=8)]
        ...
        Field(description="The Dot1p priority range ending value."),
    ] = "unspecified"
