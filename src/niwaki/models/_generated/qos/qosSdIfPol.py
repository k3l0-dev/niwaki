...
class qosSdIfPol(ManagedObject):
    """ACI Managed Object: ``qosSdIfPol`` — Slow Drain Policy.

    Slow drain policy

    RN format: ``qossdpol-{name}``
    """

    _aci_class: ClassVar[str] = "qosSdIfPol"
    _rn_format: ClassVar[str] = "qossdpol-{name}"
