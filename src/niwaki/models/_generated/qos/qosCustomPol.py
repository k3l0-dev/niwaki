...
class qosCustomPol(ManagedObject):
    """ACI Managed Object: ``qosCustomPol`` — Custom QOS Policy.
    ...
    RN format: ``qoscustom-{name}``
    """

    _aci_class: ClassVar[str] = "qosCustomPol"
    _rn_format: ClassVar[str] = "qoscustom-{name}"
