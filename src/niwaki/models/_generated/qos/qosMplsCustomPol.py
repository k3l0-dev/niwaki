...
class qosMplsCustomPol(ManagedObject):
    """ACI Managed Object: ``qosMplsCustomPol`` — MPLS Custom QOS Policy.

    MPLS Custom QOS policy to hold Ingress and Egress Rules

    RN format: ``qosmplscustom-{name}``
    """

    _aci_class: ClassVar[str] = "qosMplsCustomPol"
    _rn_format: ClassVar[str] = "qosmplscustom-{name}"
