...
class macsecGlobalStatsClearLTask(ManagedObject):
    """ACI Managed Object: ``macsecGlobalStatsClearLTask``.

    RN format: ``macsecGlobalStatsClearLTask``
    """

    _aci_class: ClassVar[str] = "macsecGlobalStatsClearLTask"
    _rn_format: ClassVar[str] = "macsecGlobalStatsClearLTask"
