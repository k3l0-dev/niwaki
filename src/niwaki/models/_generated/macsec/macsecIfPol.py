...
class macsecIfPol(ManagedObject):
    """ACI Managed Object: ``macsecIfPol`` — MACsec Access Interface Policy.

    Infra MACSEC Policy

    RN format: ``macsecifp-{name}``
    """

    _aci_class: ClassVar[str] = "macsecIfPol"
    _rn_format: ClassVar[str] = "macsecifp-{name}"
