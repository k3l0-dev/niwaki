...
class macsecKeyChainPol(ManagedObject):
    """ACI Managed Object: ``macsecKeyChainPol`` — MACsec Keychain Policy.

    RN format: ``keychainp-{name}``
    """

    _aci_class: ClassVar[str] = "macsecKeyChainPol"
    _rn_format: ClassVar[str] = "keychainp-{name}"
