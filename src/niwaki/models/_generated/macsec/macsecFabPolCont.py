...
class macsecFabPolCont(ManagedObject):
    """ACI Managed Object: ``macsecFabPolCont`` — MACsec Fabric Policy Container.

    Fabric macsec policy container

    RN format: ``macsecpcontfab``
    """

    _aci_class: ClassVar[str] = "macsecFabPolCont"
    _rn_format: ClassVar[str] = "macsecpcontfab"
