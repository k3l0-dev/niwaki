...
class macsecCAStats(ManagedObject):
    """ACI Managed Object: ``macsecCAStats`` — Connectivity Association statistics.

    RN format: ``castats``
    """

    _aci_class: ClassVar[str] = "macsecCAStats"
    _rn_format: ClassVar[str] = "castats"
