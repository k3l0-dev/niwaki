...
class macsecIfClearLTask(ManagedObject):
    """ACI Managed Object: ``macsecIfClearLTask``.

    RN format: ``macsecIfClearLTask``
    """

    _aci_class: ClassVar[str] = "macsecIfClearLTask"
    _rn_format: ClassVar[str] = "macsecIfClearLTask"
