...
class macsecGlobalStatsClearSecyLTask(ManagedObject):
    """ACI Managed Object: ``macsecGlobalStatsClearSecyLTask``.

    RN format: ``macsecGlobalStatsClearSecyLTask``
    """

    _aci_class: ClassVar[str] = "macsecGlobalStatsClearSecyLTask"
    _rn_format: ClassVar[str] = "macsecGlobalStatsClearSecyLTask"
