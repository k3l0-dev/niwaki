...
class macsecRsToKeyChainPol(ManagedObject):
    """ACI Managed Object: ``macsecRsToKeyChainPol`` — Source to KeyChain Relation.

    Relation to KeyChainPol

    RN format: ``rsToKeyChainPol``
    """

    _aci_class: ClassVar[str] = "macsecRsToKeyChainPol"
    _rn_format: ClassVar[str] = "rsToKeyChainPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2661": "fltMacsecRsToKeyChainPolResolveFail",
    }
