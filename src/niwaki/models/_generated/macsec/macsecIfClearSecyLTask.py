...
class macsecIfClearSecyLTask(ManagedObject):
    """ACI Managed Object: ``macsecIfClearSecyLTask``.

    RN format: ``macsecIfClearSecyLTask``
    """

    _aci_class: ClassVar[str] = "macsecIfClearSecyLTask"
    _rn_format: ClassVar[str] = "macsecIfClearSecyLTask"
