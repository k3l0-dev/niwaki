...
class macsecRsToParamPol(ManagedObject):
    """ACI Managed Object: ``macsecRsToParamPol`` — Source to IfPol Relation.

    Relation to IfPol

    RN format: ``rsToParamPol``
    """

    _aci_class: ClassVar[str] = "macsecRsToParamPol"
    _rn_format: ClassVar[str] = "rsToParamPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2662": "fltMacsecRsToParamPolResolveFail",
    }
