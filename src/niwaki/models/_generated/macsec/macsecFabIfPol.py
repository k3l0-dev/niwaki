...
class macsecFabIfPol(ManagedObject):
    """ACI Managed Object: ``macsecFabIfPol`` — MACsec Fabric Interface Policy.

    RN format: ``macsecfabifp-{name}``
    """

    _aci_class: ClassVar[str] = "macsecFabIfPol"
    _rn_format: ClassVar[str] = "macsecfabifp-{name}"
    ...
    use_system_generated_keys: bool = Field(default=False, alias="useAutoKeys")
