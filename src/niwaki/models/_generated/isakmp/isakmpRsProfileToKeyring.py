...
class isakmpRsProfileToKeyring(ManagedObject):
    """ACI Managed Object: ``isakmpRsProfileToKeyring`` — Profile Attachment to Keyring.

    RN format: ``rsprofileToKeyring``
    """

    _aci_class: ClassVar[str] = "isakmpRsProfileToKeyring"
    _rn_format: ClassVar[str] = "rsprofileToKeyring"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3412": "fltIsakmpRsProfileToKeyringResolveFail",
    }
