...
class isakmpGlobalPol(ManagedObject):
    """ACI Managed Object: ``isakmpGlobalPol`` — Isakmp Cloud Router-Level Common Policy.

    RN format: ``globalpol``
    """

    _aci_class: ClassVar[str] = "isakmpGlobalPol"
    _rn_format: ClassVar[str] = "globalpol"
    ...
    isakmp_keepalive_interval: Annotated[int, Field(ge=10, le=3600, alias="keepalive")] = 10
    ...
    number_of_seconds_between_keep_alives: Annotated[
        int, Field(ge=2, le=60, alias="retryInterval")
    ] = 2
