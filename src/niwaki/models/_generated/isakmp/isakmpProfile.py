...
class isakmpProfile(ManagedObject):
    """ACI Managed Object: ``isakmpProfile`` — Isakmp Profile.

    RN format: ``isakmpp-{name}``
    """

    _aci_class: ClassVar[str] = "isakmpProfile"
    _rn_format: ClassVar[str] = "isakmpp-{name}"
