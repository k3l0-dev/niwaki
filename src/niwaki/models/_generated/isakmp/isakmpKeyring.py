...
class isakmpKeyring(ManagedObject):
    """ACI Managed Object: ``isakmpKeyring`` — Isakmp Keyring.

    RN format: ``keyring-{name}``
    """

    _aci_class: ClassVar[str] = "isakmpKeyring"
    ...
    ip_address_of_peer_that_shares_the_key: Annotated[
        str, Field(pattern="^[0-9a-fA-F.:/ ]+$", alias="address")
    ] = ""
    ...
    key_type: HcisakmpKeyType = Field(default=HcisakmpKeyType.PRE_SHARED, alias="keyType")
