...
class firmwarePodFwGrp(ManagedObject):
    """ACI Managed Object: ``firmwarePodFwGrp`` — POD Firmware Group.

    POD Firmware Group. A set of PODS to which a firmware policy may be applied.

    RN format: ``podfwgrp-{name}``
    """

    _aci_class: ClassVar[str] = "firmwarePodFwGrp"
    _rn_format: ClassVar[str] = "podfwgrp-{name}"
