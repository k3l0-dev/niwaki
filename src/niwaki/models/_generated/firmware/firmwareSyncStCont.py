...
class firmwareSyncStCont(ManagedObject):
    """ACI Managed Object: ``firmwareSyncStCont`` — Sync Status Container.

    RN format: ``fwsyncst``
    """

    _aci_class: ClassVar[str] = "firmwareSyncStCont"
    _rn_format: ClassVar[str] = "fwsyncst"
