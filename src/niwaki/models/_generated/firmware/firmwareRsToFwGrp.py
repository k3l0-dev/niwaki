...
class firmwareRsToFwGrp(ManagedObject):
    """ACI Managed Object: ``firmwareRsToFwGrp`` — Firmware Group.

    RN format: ``rstoFwGrp-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "firmwareRsToFwGrp"
    _rn_format: ClassVar[str] = "rstoFwGrp-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1810": "fltFirmwareRsToFwGrpResolveFail",
    }
