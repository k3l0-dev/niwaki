...
class firmwareFwGrp(ManagedObject):
    """ACI Managed Object: ``firmwareFwGrp`` — Firmware Group.

    A firmware group is a set of nodes to which a firmware policy may be applied.

    RN format: ``fwgrp-{name}``
    """

    _aci_class: ClassVar[str] = "firmwareFwGrp"
    _rn_format: ClassVar[str] = "fwgrp-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name for the set of nodes to which the firmware version is applied.",
        ),
    ]
