...
class apPrepackagedPluginsDef(ManagedObject):
    """ACI Managed Object: ``apPrepackagedPluginsDef`` — Pre-packaged Plugins Def policies.

    Pre-packaged Plugins Def Info

    RN format: ``prepackagedPluginsDef``
    """

    _aci_class: ClassVar[str] = "apPrepackagedPluginsDef"
    _rn_format: ClassVar[str] = "prepackagedPluginsDef"
