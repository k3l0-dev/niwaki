...
class apPluginPolContr(ManagedObject):
    """ACI Managed Object: ``apPluginPolContr`` — Legacy Container for plugin policies.

    Legacy Plugin Policy Container

    RN format: ``pluginPolContr``
    """

    _aci_class: ClassVar[str] = "apPluginPolContr"
    _rn_format: ClassVar[str] = "pluginPolContr"
