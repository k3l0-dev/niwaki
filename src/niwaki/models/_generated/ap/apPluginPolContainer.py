...
class apPluginPolContainer(ManagedObject):
    """ACI Managed Object: ``apPluginPolContainer`` — Container for plugin policies.

    Plugin Policy Container

    RN format: ``pluginPolContainer``
    """

    _aci_class: ClassVar[str] = "apPluginPolContainer"
    _rn_format: ClassVar[str] = "pluginPolContainer"
