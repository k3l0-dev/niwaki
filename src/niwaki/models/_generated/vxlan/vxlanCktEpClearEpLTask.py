...
class vxlanCktEpClearEpLTask(ManagedObject):
    """ACI Managed Object: ``vxlanCktEpClearEpLTask``.

    The task to clear endpoints associated with this VXLAN circuit.

    RN format: ``vxlanCktEpClearEpLTask``
    """

    _aci_class: ClassVar[str] = "vxlanCktEpClearEpLTask"
    _rn_format: ClassVar[str] = "vxlanCktEpClearEpLTask"
