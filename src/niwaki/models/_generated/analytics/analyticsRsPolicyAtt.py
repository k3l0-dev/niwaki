...
class analyticsRsPolicyAtt(ManagedObject):
    """ACI Managed Object: ``analyticsRsPolicyAtt`` — Reference to policy.

    Reference to policy

    RN format: ``rspolicyAtt``
    """

    _aci_class: ClassVar[str] = "analyticsRsPolicyAtt"
    _rn_format: ClassVar[str] = "rspolicyAtt"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2579": "fltAnalyticsRsPolicyAttResolveFail",
    }
