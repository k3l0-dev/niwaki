...
class analyticsRsProfAtt(ManagedObject):
    """ACI Managed Object: ``analyticsRsProfAtt`` — Reference to profile.
    ...
    _aci_class: ClassVar[str] = "analyticsRsProfAtt"
    _rn_format: ClassVar[str] = "rsprofAtt"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2301": "fltAnalyticsRsProfAttResolveFail",
    }
