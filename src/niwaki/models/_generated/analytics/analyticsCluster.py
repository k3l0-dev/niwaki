...
class analyticsCluster(ManagedObject):
    """ACI Managed Object: ``analyticsCluster`` — Analytics Cluster.

    RN format: ``cluster-{name}``
    """

    _aci_class: ClassVar[str] = "analyticsCluster"
    _rn_format: ClassVar[str] = "cluster-{name}"
