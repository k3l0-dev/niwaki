...
class analyticsRsRecordSsxAtt(ManagedObject):
    """ACI Managed Object: ``analyticsRsRecordSsxAtt`` — Record SSX Policy Attachment.

    Relation to record

    RN format: ``rsrecordSsxAtt``
    """

    _aci_class: ClassVar[str] = "analyticsRsRecordSsxAtt"
    _rn_format: ClassVar[str] = "rsrecordSsxAtt"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3632": "fltAnalyticsRsRecordSsxAttResolveFail",
    }
