...
class analyticsRsCollectorAtt(ManagedObject):
    """ACI Managed Object: ``analyticsRsCollectorAtt`` — Reference to Collector.

    Relation to collector

    RN format: ``rscollectorAtt-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "analyticsRsCollectorAtt"
    _rn_format: ClassVar[str] = "rscollectorAtt-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2300": "fltAnalyticsRsCollectorAttResolveFail",
    }
