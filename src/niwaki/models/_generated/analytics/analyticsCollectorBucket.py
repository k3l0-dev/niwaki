...
class analyticsCollectorBucket(ManagedObject):
    """ACI Managed Object: ``analyticsCollectorBucket`` — Flow Collector Bucket Entry.
    ...
    _aci_class: ClassVar[str] = "analyticsCollectorBucket"
