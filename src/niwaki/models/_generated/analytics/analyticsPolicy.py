...
class analyticsPolicy(ManagedObject):
    """ACI Managed Object: ``analyticsPolicy`` — Policy.

    Policy Container for ACLs

    RN format: ``policy-{name}``
    """

    _aci_class: ClassVar[str] = "analyticsPolicy"
    _rn_format: ClassVar[str] = "policy-{name}"
