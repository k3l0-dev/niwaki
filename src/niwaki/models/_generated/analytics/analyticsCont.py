...
class analyticsCont(ManagedObject):
    """ACI Managed Object: ``analyticsCont`` — Analytics Policy Container.
    ...
    _aci_class: ClassVar[str] = "analyticsCont"
    _rn_format: ClassVar[str] = "analytics"
