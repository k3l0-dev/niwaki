...
class eventSwRetP(ManagedObject):
    """ACI Managed Object: ``eventSwRetP`` — Switch Event Retention Policy.
    ...
    RN format: ``sweretp-{name}``
    """

    _aci_class: ClassVar[str] = "eventSwRetP"
    _rn_format: ClassVar[str] = "sweretp-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the event retention policy.",
        ),
    ]
    ...
    maximum_size: Annotated[
        ...
        Field(
            ...
            description="The maximum number of records to be maintained in the switch event log.",
        ),
    ] = 10000
