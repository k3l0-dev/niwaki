...
class eventSubscriptionMsgCont(ManagedObject):
    """ACI Managed Object: ``eventSubscriptionMsgCont`` — Temporary MO to hold all the Sub ID and related Class IDs.

    RN format: ``submsgcont``
    """

    _aci_class: ClassVar[str] = "eventSubscriptionMsgCont"
    _rn_format: ClassVar[str] = "submsgcont"
