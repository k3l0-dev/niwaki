...
class mockMockRoot(ManagedObject):
    """ACI Managed Object: ``mockMockRoot`` — Abstract MOCK Policy.
    ...
    _aci_class: ClassVar[str] = "mockMockRoot"
    _rn_format: ClassVar[str] = "mockroot"
    ...
    disable_statsmock_processpr: bool = Field(
        default=False, validation_alias="disable", serialization_alias="disable"
    )
