...
class ipRsNexthopRouteTrack(ManagedObject):
    """ACI Managed Object: ``ipRsNexthopRouteTrack`` — Tracking policy.

    Relation definition for Next Hop to TrackList

    RN format: ``rsNexthopRouteTrack``
    """

    _aci_class: ClassVar[str] = "ipRsNexthopRouteTrack"
    _rn_format: ClassVar[str] = "rsNexthopRouteTrack"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3287": "fltIpRsNexthopRouteTrackResolveFail",
    }
