...
class ipRsRouteTrack(ManagedObject):
    """ACI Managed Object: ``ipRsRouteTrack`` — Tracking policy.

    Relation definition for static route to TrackList

    RN format: ``rsRouteTrack``
    """

    _aci_class: ClassVar[str] = "ipRsRouteTrack"
    _rn_format: ClassVar[str] = "rsRouteTrack"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3282": "fltIpRsRouteTrackResolveFail",
    }
