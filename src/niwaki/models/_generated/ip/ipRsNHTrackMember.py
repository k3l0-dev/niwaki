...
class ipRsNHTrackMember(ManagedObject):
    """ACI Managed Object: ``ipRsNHTrackMember`` — Track Member Policy.

    Relation definition for Next Hop to TrackList

    RN format: ``rsNHTrackMember``
    """

    _aci_class: ClassVar[str] = "ipRsNHTrackMember"
    _rn_format: ClassVar[str] = "rsNHTrackMember"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3311": "fltIpRsNHTrackMemberResolveFail",
    }
