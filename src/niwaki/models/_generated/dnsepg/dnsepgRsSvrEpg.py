...
class dnsepgRsSvrEpg(ManagedObject):
    """ACI Managed Object: ``dnsepgRsSvrEpg`` — Relation from a dnsepgSvrGrp to an EPG.

    RN format: ``rssvrEpg``
    """

    _aci_class: ClassVar[str] = "dnsepgRsSvrEpg"
    _rn_format: ClassVar[str] = "rssvrEpg"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2770": "fltDnsepgRsSvrEpgResolveFail",
    }
