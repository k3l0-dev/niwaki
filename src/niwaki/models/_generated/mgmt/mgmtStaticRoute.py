...
class mgmtStaticRoute(ManagedObject):
    """ACI Managed Object: ``mgmtStaticRoute`` — Route for OOB and Inband management.

    RN format: ``staticroute-[{ip_address}]``
    """

    _aci_class: ClassVar[str] = "mgmtStaticRoute"
    _rn_format: ClassVar[str] = "staticroute-[{ip_address}]"
