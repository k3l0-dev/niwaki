...
class mgmtPodGrp(ManagedObject):
    """ACI Managed Object: ``mgmtPodGrp`` — Pod Management Address.

    RN format: ``mgmtpodgrp-{name}``
    """

    _aci_class: ClassVar[str] = "mgmtPodGrp"
    _rn_format: ClassVar[str] = "mgmtpodgrp-{name}"
