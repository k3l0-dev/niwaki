...
class mgmtMgmtIfClearCountersLTask(ManagedObject):
    """ACI Managed Object: ``mgmtMgmtIfClearCountersLTask``.

    RN format: ``mgmtMgmtIfClearCountersLTask``
    """

    _aci_class: ClassVar[str] = "mgmtMgmtIfClearCountersLTask"
    _rn_format: ClassVar[str] = "mgmtMgmtIfClearCountersLTask"
