...
class mgmtRsToNodeGrp(ManagedObject):
    """ACI Managed Object: ``mgmtRsToNodeGrp`` — Node Management Address.

    RN format: ``rstoNodeGrp-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "mgmtRsToNodeGrp"
    _rn_format: ClassVar[str] = "rstoNodeGrp-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1813": "fltMgmtRsToNodeGrpResolveFail",
    }
