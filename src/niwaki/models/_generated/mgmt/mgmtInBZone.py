...
class mgmtInBZone(ManagedObject):
    """ACI Managed Object: ``mgmtInBZone`` — InB Managed Nodes Zone.

    RN format: ``inbzone``
    """

    _aci_class: ClassVar[str] = "mgmtInBZone"
    _rn_format: ClassVar[str] = "inbzone"
