...
class mgmtRsGrp(ManagedObject):
    """ACI Managed Object: ``mgmtRsGrp`` — Managed Node Connectivity Group.

    A source relation to the managed node group.

    RN format: ``rsgrp-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "mgmtRsGrp"
    _rn_format: ClassVar[str] = "rsgrp-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1031": "fltMgmtRsGrpResolveFail",
    }
