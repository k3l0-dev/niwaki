...
class mgmtConnectivityPrefs(ManagedObject):
    """ACI Managed Object: ``mgmtConnectivityPrefs`` — mgmt connectivity preference.

    ConnectivityPrefs has the information about routing interface(oob/inb)

    RN format: ``connectivityPrefs``
    """

    _aci_class: ClassVar[str] = "mgmtConnectivityPrefs"
    _rn_format: ClassVar[str] = "connectivityPrefs"
