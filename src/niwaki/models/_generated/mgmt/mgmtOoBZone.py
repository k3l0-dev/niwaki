...
class mgmtOoBZone(ManagedObject):
    """ACI Managed Object: ``mgmtOoBZone`` — OOB Managed Nodes Zone.

    RN format: ``oobzone``
    """

    _aci_class: ClassVar[str] = "mgmtOoBZone"
    _rn_format: ClassVar[str] = "oobzone"
