...
class edmRsEncapDef(ManagedObject):
    """ACI Managed Object: ``edmRsEncapDef`` — Relation to a Single Encap Definition.

    Association to Single Encap

    RN format: ``rsencapDef-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "edmRsEncapDef"
    _rn_format: ClassVar[str] = "rsencapDef-[{target_dn}]"
