...
class edmRsCtrlrToDom(ManagedObject):
    """ACI Managed Object: ``edmRsCtrlrToDom`` — Association between proxy Ctrlr and domain.

    Association to domain

    RN format: ``rsctrlrToDom``
    """

    _aci_class: ClassVar[str] = "edmRsCtrlrToDom"
    _rn_format: ClassVar[str] = "rsctrlrToDom"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3326": "fltEdmRsCtrlrToDomResolveFail",
    }
