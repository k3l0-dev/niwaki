...
class edmRsExtDevDomP(ManagedObject):
    """ACI Managed Object: ``edmRsExtDevDomP`` — Domain.

    RN format: ``rsextDevDomP-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "edmRsExtDevDomP"
    _rn_format: ClassVar[str] = "rsextDevDomP-[{target_dn}]"
