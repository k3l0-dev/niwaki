...
class ipv6aclAF(ManagedObject):
    """ACI Managed Object: ``ipv6aclAF`` — IPv6 access control list configuration space.
    ...
    _aci_class: ClassVar[str] = "ipv6aclAF"
    _rn_format: ClassVar[str] = "ipv6"
