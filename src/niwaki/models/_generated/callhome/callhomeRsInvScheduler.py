...
class callhomeRsInvScheduler(ManagedObject):
    """ACI Managed Object: ``callhomeRsInvScheduler`` — Relation to Callhome Inventory Scheduler.

    A source relation to the scheduler policy.

    RN format: ``rsInvScheduler``
    """

    _aci_class: ClassVar[str] = "callhomeRsInvScheduler"
    _rn_format: ClassVar[str] = "rsInvScheduler"
