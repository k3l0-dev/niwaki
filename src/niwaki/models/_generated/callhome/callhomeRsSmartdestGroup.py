...
class callhomeRsSmartdestGroup(ManagedObject):
    """ACI Managed Object: ``callhomeRsSmartdestGroup`` — Relation to CallHome Destination Smart Group.

    RN format: ``rssmartdestGroup``
    """

    _aci_class: ClassVar[str] = "callhomeRsSmartdestGroup"
    _rn_format: ClassVar[str] = "rssmartdestGroup"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3007": "fltCallhomeRsSmartdestGroupResolveFail",
    }
