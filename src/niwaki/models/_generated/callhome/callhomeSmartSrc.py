...
class callhomeSmartSrc(ManagedObject):
    """ACI Managed Object: ``callhomeSmartSrc`` — Smart Callhome Source.

    RN format: ``smartchsrc``
    """

    _aci_class: ClassVar[str] = "callhomeSmartSrc"
    _rn_format: ClassVar[str] = "smartchsrc"
