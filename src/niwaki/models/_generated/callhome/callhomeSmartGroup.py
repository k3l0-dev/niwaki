...
class callhomeSmartGroup(ManagedObject):
    """ACI Managed Object: ``callhomeSmartGroup`` — Smart Callhome Destination Group.

    RN format: ``smartgroup-{name}``
    """

    _aci_class: ClassVar[str] = "callhomeSmartGroup"
    _rn_format: ClassVar[str] = "smartgroup-{name}"
