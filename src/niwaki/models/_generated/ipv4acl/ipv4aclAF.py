...
class ipv4aclAF(ManagedObject):
    """ACI Managed Object: ``ipv4aclAF`` — IPv4 access control list configuration space.
    ...
    _aci_class: ClassVar[str] = "ipv4aclAF"
    _rn_format: ClassVar[str] = "ipv4"
