...
class hcloudIpV4Addr(ManagedObject):
    """ACI Managed Object: ``hcloudIpV4Addr``.

    RN format: ``v4addr-[{addr}]``
    """

    _aci_class: ClassVar[str] = "hcloudIpV4Addr"
    _rn_format: ClassVar[str] = "v4addr-[{addr}]"
    ...
    # ── Naming (required) ──────────────────────────────────────────────────────
    addr: Annotated[str, Field(min_length=1, max_length=512, description="The peer IP address.")]
