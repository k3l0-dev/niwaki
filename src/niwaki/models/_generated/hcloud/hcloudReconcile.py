...
class hcloudReconcile(ManagedObject):
    """ACI Managed Object: ``hcloudReconcile`` — reconcile.

    RN format: ``reconcile``
    """

    _aci_class: ClassVar[str] = "hcloudReconcile"
    _rn_format: ClassVar[str] = "reconcile"
