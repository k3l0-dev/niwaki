...
class hcloudHcloudPolHolder(ManagedObject):
    """ACI Managed Object: ``hcloudHcloudPolHolder`` — hcloudpolholder.

    RN format: ``hcloudpolholder``
    """

    _aci_class: ClassVar[str] = "hcloudHcloudPolHolder"
    _rn_format: ClassVar[str] = "hcloudpolholder"
