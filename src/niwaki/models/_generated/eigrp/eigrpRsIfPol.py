...
class eigrpRsIfPol(ManagedObject):
    """ACI Managed Object: ``eigrpRsIfPol`` — Interface Policy.
    ...
    _aci_class: ClassVar[str] = "eigrpRsIfPol"
    _rn_format: ClassVar[str] = "rsIfPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1600": "fltEigrpRsIfPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnEigrpIfPolName",
            serialization_alias="tnEigrpIfPolName",
        ),
    ] = ""
