...
class eigrpAuthIfP(ManagedObject):
    """ACI Managed Object: ``eigrpAuthIfP`` — KeyChainPol Holder Mo.

    RN format: ``eigrpAuthIfP``
    """

    _aci_class: ClassVar[str] = "eigrpAuthIfP"
    _rn_format: ClassVar[str] = "eigrpAuthIfP"
