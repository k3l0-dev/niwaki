...
class eigrpRsKeyChainPol(ManagedObject):
    """ACI Managed Object: ``eigrpRsKeyChainPol`` — KeyChain Policy.

    Relationship to the Tenant level keychain policy

    RN format: ``rsKeyChainPol``
    """

    _aci_class: ClassVar[str] = "eigrpRsKeyChainPol"
    _rn_format: ClassVar[str] = "rsKeyChainPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3332": "fltEigrpRsKeyChainPolResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnFvKeyChainPolName",
            serialization_alias="tnFvKeyChainPolName",
        ),
    ] = ""
