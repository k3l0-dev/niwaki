...
class conditionRsToNodePolGrp(ManagedObject):
    """ACI Managed Object: ``conditionRsToNodePolGrp`` — Historical Record Node Policy Group.

    RN format: ``rstoNodePolGrp-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "conditionRsToNodePolGrp"
    _rn_format: ClassVar[str] = "rstoNodePolGrp-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1806": "fltConditionRsToNodePolGrpResolveFail",
    }
