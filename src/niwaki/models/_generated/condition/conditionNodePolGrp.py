...
class conditionNodePolGrp(ManagedObject):
    """ACI Managed Object: ``conditionNodePolGrp`` — Historical Record Node Policy Group.
    ...
    _aci_class: ClassVar[str] = "conditionNodePolGrp"
    _rn_format: ClassVar[str] = "cnpg-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="A name for the node policy group.",
        ),
    ]
