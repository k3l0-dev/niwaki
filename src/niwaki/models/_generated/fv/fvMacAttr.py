...
class fvMacAttr(ManagedObject):
    """ACI Managed Object: ``fvMacAttr`` — MAC Attribute.

    A MAC based attribute.

    RN format: ``macattr-{name}``
    """

    _aci_class: ClassVar[str] = "fvMacAttr"
    _rn_format: ClassVar[str] = "macattr-{name}"
