...
class fvRsIpslaMonPol(ManagedObject):
    """ACI Managed Object: ``fvRsIpslaMonPol`` — Track member to IPSLA Policy.

    RN format: ``rsIpslaMonPol``
    """

    _aci_class: ClassVar[str] = "fvRsIpslaMonPol"
    _rn_format: ClassVar[str] = "rsIpslaMonPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3281": "fltFvRsIpslaMonPolResolveFail",
    }
