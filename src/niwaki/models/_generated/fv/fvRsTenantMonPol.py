...
class fvRsTenantMonPol(ManagedObject):
    """ACI Managed Object: ``fvRsTenantMonPol`` — Monitoring Policy.

    A source relation to the monitoring policy model for the endpoint group semantic scope. This is an internal object.

    RN format: ``rsTenantMonPol``
    """

    _aci_class: ClassVar[str] = "fvRsTenantMonPol"
    _rn_format: ClassVar[str] = "rsTenantMonPol"
