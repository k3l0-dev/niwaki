...
class fvCrtrn(ManagedObject):
    ...
    matching_rule_type: FvMatchT = Field(default=FvMatchT.ANY, alias="match")
    ...
    precedence: Annotated[int, Field(alias="prec")] = 0
    criterion_scope: FvCrtrnScopeT = Field(default=FvCrtrnScopeT.SCOPE_BD, alias="scope")
