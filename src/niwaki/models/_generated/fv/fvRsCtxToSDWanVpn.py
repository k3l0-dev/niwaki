...
class fvRsCtxToSDWanVpn(ManagedObject):
    """ACI Managed Object: ``fvRsCtxToSDWanVpn`` — Relationship to External SDWan VPN.

    Relationship to WAN VPNs

    RN format: ``rsctxToSDWanVpn``
    """

    _aci_class: ClassVar[str] = "fvRsCtxToSDWanVpn"
    _rn_format: ClassVar[str] = "rsctxToSDWanVpn"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3659": "fltFvRsCtxToSDWanVpnResolveFail",
    }
