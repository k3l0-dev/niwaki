...
class fvRsOtmListMember(ManagedObject):
    """ACI Managed Object: ``fvRsOtmListMember`` — Track list to Track member relation.

    RN format: ``rsotmListMember-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "fvRsOtmListMember"
    _rn_format: ClassVar[str] = "rsotmListMember-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3280": "fltFvRsOtmListMemberResolveFail",
    }
