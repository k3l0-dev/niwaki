...
class fvRsDppPol(ManagedObject):
    """ACI Managed Object: ``fvRsDppPol`` — QOS DPP Policy.
    ...
    _aci_class: ClassVar[str] = "fvRsDppPol"
    _rn_format: ClassVar[str] = "rsdppPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2719": "fltFvRsDppPolResolveFail",
    }
