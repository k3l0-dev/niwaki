...
class fvNlbStaticGroup(ManagedObject):
    """ACI Managed Object: ``fvNlbStaticGroup`` — NLB Static Group.

    RN format: ``nlbstaticgrp-{mac}``
    """

    _aci_class: ClassVar[str] = "fvNlbStaticGroup"
    _rn_format: ClassVar[str] = "nlbstaticgrp-{mac}"
