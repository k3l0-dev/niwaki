...
class fvRsSubnetToRtSummPol(ManagedObject):
    """ACI Managed Object: ``fvRsSubnetToRtSummPol`` — Route Summarization policy.

    RN format: ``rsSubnetToRtSummPol``
    """

    _aci_class: ClassVar[str] = "fvRsSubnetToRtSummPol"
    _rn_format: ClassVar[str] = "rsSubnetToRtSummPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4277": "fltFvRsSubnetToRtSummPolResolveFail",
    }
