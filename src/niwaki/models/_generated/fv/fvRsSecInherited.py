...
class fvRsSecInherited(ManagedObject):
    """ACI Managed Object: ``fvRsSecInherited`` — Security inheritance.

    Represents that the EPg is inheriting security configuration from another EPg

    RN format: ``rssecInherited-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "fvRsSecInherited"
    _rn_format: ClassVar[str] = "rssecInherited-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2698": "fltFvRsSecInheritedResolveFail",
    }
