...
class fvRsAEPgMonPol(ManagedObject):
    """ACI Managed Object: ``fvRsAEPgMonPol`` — Monitoring Policy.

    A source relation to the monitoring policy model for the endpoint group semantic scope. This is an internal object.

    RN format: ``rsAEPgMonPol``
    """

    _aci_class: ClassVar[str] = "fvRsAEPgMonPol"
    _rn_format: ClassVar[str] = "rsAEPgMonPol"
    ...
    name: Annotated[
        ...
        Field(
            ...
            description="The name of the monitoring policy associated with this EPG.",
        ),
    ] = ""
