...
class fvEpAnycast(ManagedObject):
    """ACI Managed Object: ``fvEpAnycast`` — Anycast Endpoint.

    RN format: ``epAnycast-{mac}``
    """

    _aci_class: ClassVar[str] = "fvEpAnycast"
    _rn_format: ClassVar[str] = "epAnycast-{mac}"
