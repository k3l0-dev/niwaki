...
class fvAEPgLagPolAtt(ManagedObject):
    """ACI Managed Object: ``fvAEPgLagPolAtt`` — Application EPG Lag Policy.

    RN format: ``epglagpolatt``
    """

    _aci_class: ClassVar[str] = "fvAEPgLagPolAtt"
    _rn_format: ClassVar[str] = "epglagpolatt"
