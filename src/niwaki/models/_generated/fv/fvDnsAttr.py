...
class fvDnsAttr(ManagedObject):
    """ACI Managed Object: ``fvDnsAttr`` — DNS Attribute.

    RN format: ``dnsattr-{name}``
    """

    _aci_class: ClassVar[str] = "fvDnsAttr"
    _rn_format: ClassVar[str] = "dnsattr-{name}"
    ...
    domain_name_filter: Annotated[
        str, Field(max_length=512, validation_alias="filter", serialization_alias="filter")
    ] = ""
