...
class fvAccP(ManagedObject):
    """ACI Managed Object: ``fvAccP`` — Legacy Mode.
    ...
    _aci_class: ClassVar[str] = "fvAccP"
    _rn_format: ClassVar[str] = "accp"
    ...
    bd_access_encap: str = Field(
        default="",
        alias="encap",
        description="The selected VLAN for bridge domain access port encapsulation.",
    )
