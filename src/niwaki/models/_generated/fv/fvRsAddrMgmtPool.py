...
class fvRsAddrMgmtPool(ManagedObject):
    """ACI Managed Object: ``fvRsAddrMgmtPool`` — Relation to Address Management Policy.

    RN format: ``rsAddrMgmtPool``
    """

    _aci_class: ClassVar[str] = "fvRsAddrMgmtPool"
    _rn_format: ClassVar[str] = "rsAddrMgmtPool"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4477": "fltFvRsAddrMgmtPoolResolveFail",
    }
