...
class fvRsScope(ManagedObject):
    """ACI Managed Object: ``fvRsScope`` — Private Network.

    RN format: ``rsscope``
    """

    _aci_class: ClassVar[str] = "fvRsScope"
    _rn_format: ClassVar[str] = "rsscope"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3702": "fltFvRsScopeResolveFail",
    }
