...
class fvSCrtrn(ManagedObject):
    """ACI Managed Object: ``fvSCrtrn`` — Sub-Criterion.

    Sub-Criterion

    RN format: ``crtrn-{name}``
    """

    _aci_class: ClassVar[str] = "fvSCrtrn"
    _rn_format: ClassVar[str] = "crtrn-{name}"
