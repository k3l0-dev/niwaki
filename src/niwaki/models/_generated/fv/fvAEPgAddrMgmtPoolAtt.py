...
class fvAEPgAddrMgmtPoolAtt(ManagedObject):
    """ACI Managed Object: ``fvAEPgAddrMgmtPoolAtt`` — Application EPG IP Address Management Policy.

    RN format: ``epgipampoolatt``
    """

    _aci_class: ClassVar[str] = "fvAEPgAddrMgmtPoolAtt"
    _rn_format: ClassVar[str] = "epgipampoolatt"
