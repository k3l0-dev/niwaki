...
class fvRsImportFromFabricProfile(ManagedObject):
    """ACI Managed Object: ``fvRsImportFromFabricProfile`` — Import Route Profile.

    RN format: ``rsimportFromFabricProfile``
    """

    _aci_class: ClassVar[str] = "fvRsImportFromFabricProfile"
    _rn_format: ClassVar[str] = "rsimportFromFabricProfile"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4283": "fltFvRsImportFromFabricProfileResolveFail",
    }
