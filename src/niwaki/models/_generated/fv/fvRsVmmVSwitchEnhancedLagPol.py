...
class fvRsVmmVSwitchEnhancedLagPol(ManagedObject):
    """ACI Managed Object: ``fvRsVmmVSwitchEnhancedLagPol`` — Relation to Enhanced LACP Lag Policy.

    RN format: ``rsvmmVSwitchEnhancedLagPol``
    """

    _aci_class: ClassVar[str] = "fvRsVmmVSwitchEnhancedLagPol"
    _rn_format: ClassVar[str] = "rsvmmVSwitchEnhancedLagPol"
