...
class fvRsTrustCtrl(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "fvRsTrustCtrl"
    _rn_format: ClassVar[str] = "rstrustCtrl"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2504": "fltFvRsTrustCtrlResolveFail",
    }
    ...
    name: Annotated[
        ...
        Field(
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            validation_alias="tnFhsTrustCtrlPolName",
            serialization_alias="tnFhsTrustCtrlPolName",
        ),
    ] = ""
