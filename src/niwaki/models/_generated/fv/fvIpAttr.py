...
class fvIpAttr(ManagedObject):
    """ACI Managed Object: ``fvIpAttr`` — IP Attribute.

    The IP based attributes.

    RN format: ``ipattr-{name}``
    """

    _aci_class: ClassVar[str] = "fvIpAttr"
    _rn_format: ClassVar[str] = "ipattr-{name}"
    ...
    ip_address: Annotated[
        str, Field(pattern="^[0-9a-fA-F.:/ ]+$", alias="ip", description="The device IP address.")
    ] = ""
    ...
    use_fvsubnet_address: bool = Field(default=False, alias="usefvSubnet")
