...
class fvAddrMgmtPool(ManagedObject):
    """ACI Managed Object: ``fvAddrMgmtPool`` — IP Address Management Pool.

    RN format: ``ipampool-{name}``
    """

    _aci_class: ClassVar[str] = "fvAddrMgmtPool"
    _rn_format: ClassVar[str] = "ipampool-{name}"
