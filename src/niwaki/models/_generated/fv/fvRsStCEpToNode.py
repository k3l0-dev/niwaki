...
class fvRsStCEpToNode(ManagedObject):
    """ACI Managed Object: ``fvRsStCEpToNode`` — Fabric Node.

    A source relation to the root node for the APIC.

    RN format: ``rsstCEpToNode-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "fvRsStCEpToNode"
    _rn_format: ClassVar[str] = "rsstCEpToNode-[{target_dn}]"
