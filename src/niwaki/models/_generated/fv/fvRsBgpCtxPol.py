...
class fvRsBgpCtxPol(ManagedObject):
    """ACI Managed Object: ``fvRsBgpCtxPol`` — BGP Context Policy.

    A source relation to the BGP timer policy. This is an internal object.

    RN format: ``rsbgpCtxPol``
    """

    _aci_class: ClassVar[str] = "fvRsBgpCtxPol"
    _rn_format: ClassVar[str] = "rsbgpCtxPol"
