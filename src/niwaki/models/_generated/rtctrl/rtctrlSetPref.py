...
class rtctrlSetPref(ManagedObject):
    """ACI Managed Object: ``rtctrlSetPref``.
    ...
    _aci_class: ClassVar[str] = "rtctrlSetPref"
    _rn_format: ClassVar[str] = "spref"
    ...
    local_pref: Annotated[
        int,
        Field(
            validation_alias="localPref",
            serialization_alias="localPref",
