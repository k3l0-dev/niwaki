...
class rtctrlRsSetPolicyTagToInstP(ManagedObject):
    """ACI Managed Object: ``rtctrlRsSetPolicyTagToInstP`` — Relation to External Network Instance Profile.

    RN format: ``rssetPolicyTagToInstP``
    """

    _aci_class: ClassVar[str] = "rtctrlRsSetPolicyTagToInstP"
    _rn_format: ClassVar[str] = "rssetPolicyTagToInstP"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F4261": "fltRtctrlRsSetPolicyTagToInstPResolveFail",
    }
