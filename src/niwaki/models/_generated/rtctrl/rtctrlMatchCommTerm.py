...
class rtctrlMatchCommTerm(ManagedObject):
    """ACI Managed Object: ``rtctrlMatchCommTerm`` — Match Community Term.

    Match Community Term

    RN format: ``commtrm-{name}``
    """

    _aci_class: ClassVar[str] = "rtctrlMatchCommTerm"
    _rn_format: ClassVar[str] = "commtrm-{name}"
