...
class rtctrlMatchRtNh(ManagedObject):
    """ACI Managed Object: ``rtctrlMatchRtNh`` — Match Route Next Hop Rule.

    RN format: ``nh-[{match_ip_address}]``
    """

    _aci_class: ClassVar[str] = "rtctrlMatchRtNh"
    _rn_format: ClassVar[str] = "nh-[{match_ip_address}]"
