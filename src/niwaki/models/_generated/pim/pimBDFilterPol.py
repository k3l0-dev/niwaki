...
class pimBDFilterPol(ManagedObject):
    """ACI Managed Object: ``pimBDFilterPol`` — PIM BD Filter Policy.

    PIM BD Filter policy container

    RN format: ``pimbdfilterp``
    """

    _aci_class: ClassVar[str] = "pimBDFilterPol"
    _rn_format: ClassVar[str] = "pimbdfilterp"
