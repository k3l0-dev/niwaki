...
class pimIPV6IfP(ManagedObject):
    """ACI Managed Object: ``pimIPV6IfP`` — Interface Profile.

    RN format: ``pimipv6ifp``
    """

    _aci_class: ClassVar[str] = "pimIPV6IfP"
    _rn_format: ClassVar[str] = "pimipv6ifp"
