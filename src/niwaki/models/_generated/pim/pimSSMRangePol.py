...
class pimSSMRangePol(ManagedObject):
    """ACI Managed Object: ``pimSSMRangePol`` — SSM group range Policy.
    ...
    _aci_class: ClassVar[str] = "pimSSMRangePol"
    _rn_format: ClassVar[str] = "ssmrange"
