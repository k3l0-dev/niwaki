...
class pimStaticRPPol(ManagedObject):
    """ACI Managed Object: ``pimStaticRPPol`` — Static RP PIM Policy.
    ...
    _aci_class: ClassVar[str] = "pimStaticRPPol"
    _rn_format: ClassVar[str] = "staticrp"
