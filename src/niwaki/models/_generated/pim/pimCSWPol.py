...
class pimCSWPol(ManagedObject):
    """ACI Managed Object: ``pimCSWPol`` — Configured Stripe Winner Policy.
    ...
    _aci_class: ClassVar[str] = "pimCSWPol"
    _rn_format: ClassVar[str] = "cswpol"
