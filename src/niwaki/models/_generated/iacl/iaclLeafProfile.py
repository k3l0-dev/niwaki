...
class iaclLeafProfile(ManagedObject):
    """ACI Managed Object: ``iaclLeafProfile`` — CoPP Prefilter Leaf Level Policy.

    CoPP Prefilter policy that can be applied at LEAF nodes

    RN format: ``iaclleafp-{name}``
    """

    _aci_class: ClassVar[str] = "iaclLeafProfile"
    _rn_format: ClassVar[str] = "iaclleafp-{name}"
