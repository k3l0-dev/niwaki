...
class iaclSpineProfile(ManagedObject):
    """ACI Managed Object: ``iaclSpineProfile`` — CoPP Prefilter Spine Level Policy.

    CoPP Prefilter policy that can be applied at SPINE nodes

    RN format: ``iaclspinep-{name}``
    """

    _aci_class: ClassVar[str] = "iaclSpineProfile"
    _rn_format: ClassVar[str] = "iaclspinep-{name}"
