...
class vnsRsRedirectHealthGroup(ManagedObject):
    """ACI Managed Object: ``vnsRsRedirectHealthGroup`` — L4-L7 Redirect Health Group.

    RN format: ``rsRedirectHealthGroup``
    """

    _aci_class: ClassVar[str] = "vnsRsRedirectHealthGroup"
    _rn_format: ClassVar[str] = "rsRedirectHealthGroup"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2830": "fltVnsRsRedirectHealthGroupResolveFail",
    }
