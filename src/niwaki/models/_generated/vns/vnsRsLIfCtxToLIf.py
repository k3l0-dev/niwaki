...
class vnsRsLIfCtxToLIf(ManagedObject):
    """ACI Managed Object: ``vnsRsLIfCtxToLIf`` — Relation from LIf Context to LIf.

    A source relation to the logical interface of a device cluster.

    RN format: ``rsLIfCtxToLIf``
    """

    _aci_class: ClassVar[str] = "vnsRsLIfCtxToLIf"
    _rn_format: ClassVar[str] = "rsLIfCtxToLIf"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1103": "fltVnsRsLIfCtxToLIfResolveFail",
    }
