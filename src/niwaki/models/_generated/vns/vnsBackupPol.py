...
class vnsBackupPol(ManagedObject):
    """ACI Managed Object: ``vnsBackupPol`` — PBR Backup Policy.

    RN format: ``backupPol-{name}``
    """

    _aci_class: ClassVar[str] = "vnsBackupPol"
    _rn_format: ClassVar[str] = "backupPol-{name}"
