...
class vnsAbsFuncConn(ManagedObject):
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the function node connector.",
        ),
    ]
    ...
    conn_type: VnsFuncConnType = Field(
        default=VnsFuncConnType.NONE, validation_alias="connType", serialization_alias="connType"
    )
