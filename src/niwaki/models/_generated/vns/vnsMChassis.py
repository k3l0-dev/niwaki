...
class vnsMChassis(ManagedObject):
    """ACI Managed Object: ``vnsMChassis`` — L4-L7 Chassis type.

    RN format: ``mChassis-{vendor}-{model}-{version}``
    ...
    _aci_class: ClassVar[str] = "vnsMChassis"
    _rn_format: ClassVar[str] = "mChassis-{vendor}-{model}-{version}"
    ...
    # ── Naming (required) ──────────────────────────────────────────────────────
    model: Annotated[
        str, Field(min_length=1, max_length=512, description="The model of the controller.")
    ]
    vendor: Annotated[
    ...
    version: Annotated[
        str,
        Field(
            min_length=1, max_length=512, description="The version of the compatibility catalog."
        ),
    ]
