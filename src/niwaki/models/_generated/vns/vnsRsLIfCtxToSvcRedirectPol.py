...
class vnsRsLIfCtxToSvcRedirectPol(ManagedObject):
    """ACI Managed Object: ``vnsRsLIfCtxToSvcRedirectPol`` — Relation from LIf Context to Service Redirect Policy.

    RN format: ``rsLIfCtxToSvcRedirectPol``
    """

    _aci_class: ClassVar[str] = "vnsRsLIfCtxToSvcRedirectPol"
    _rn_format: ClassVar[str] = "rsLIfCtxToSvcRedirectPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1823": "fltVnsRsLIfCtxToSvcRedirectPolResolveFail",
    }
