...
class vnsSvcEPgPol(ManagedObject):
    """ACI Managed Object: ``vnsSvcEPgPol`` — Service EPg Policy.

    RN format: ``svcEPgPol-{name}``
    """

    _aci_class: ClassVar[str] = "vnsSvcEPgPol"
    _rn_format: ClassVar[str] = "svcEPgPol-{name}"
    ...
    preferred_group_member: VnsPrefGrMemb = Field(default=VnsPrefGrMemb.EXCLUDE, alias="prefGrMemb")
