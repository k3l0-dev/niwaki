...
class vnsRedirectHealthGroup(ManagedObject):
    """ACI Managed Object: ``vnsRedirectHealthGroup`` — L4-L7 Redirect Health Group.

    RN format: ``redirectHealthGroup-{name}``
    """

    _aci_class: ClassVar[str] = "vnsRedirectHealthGroup"
    _rn_format: ClassVar[str] = "redirectHealthGroup-{name}"
