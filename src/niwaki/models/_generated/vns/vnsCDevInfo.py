...
class vnsCDevInfo(ManagedObject):
    """ACI Managed Object: ``vnsCDevInfo`` — Chassis Operational Information.

    RN format: ``cDevInfo-[{t_dn}]``
    """

    _aci_class: ClassVar[str] = "vnsCDevInfo"
    _rn_format: ClassVar[str] = "cDevInfo-[{t_dn}]"
