...
class vnsRsLIfCtxToOut(ManagedObject):
    """ACI Managed Object: ``vnsRsLIfCtxToOut`` — Relation from LIf Context to l3ext:Out.

    RN format: ``rsLIfCtxToOut``
    """

    _aci_class: ClassVar[str] = "vnsRsLIfCtxToOut"
    _rn_format: ClassVar[str] = "rsLIfCtxToOut"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1539": "fltVnsRsLIfCtxToOutResolveFail",
    }
