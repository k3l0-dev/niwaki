...
class vnsDeviceScriptBackups(ManagedObject):
    """ACI Managed Object: ``vnsDeviceScriptBackups`` — Container for device package debug log backups.

    RN format: ``devicescriptbackups``
    """

    _aci_class: ClassVar[str] = "vnsDeviceScriptBackups"
    _rn_format: ClassVar[str] = "devicescriptbackups"
