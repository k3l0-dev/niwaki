...
class vnsAbsFuncCfg(ManagedObject):
    """ACI Managed Object: ``vnsAbsFuncCfg`` — L4-L7 Services Function Config.

    The configuration for a function. This configuration can be shared across multiple functions.

    RN format: ``absFuncCfg``
    """

    _aci_class: ClassVar[str] = "vnsAbsFuncCfg"
    _rn_format: ClassVar[str] = "absFuncCfg"
