...
class vnsAbsGrpCfg(ManagedObject):
    """ACI Managed Object: ``vnsAbsGrpCfg`` — L4-L7 Services Group Shared Config.
    ...
    _aci_class: ClassVar[str] = "vnsAbsGrpCfg"
    _rn_format: ClassVar[str] = "absGrpCfg"
