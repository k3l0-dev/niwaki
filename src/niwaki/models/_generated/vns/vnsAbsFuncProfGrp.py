...
class vnsAbsFuncProfGrp(ManagedObject):
    """ACI Managed Object: ``vnsAbsFuncProfGrp`` — L4-L7 Services Function Profile Group.

    A function profile group.

    RN format: ``absFuncProfGrp-{name}``
    """

    _aci_class: ClassVar[str] = "vnsAbsFuncProfGrp"
    _rn_format: ClassVar[str] = "absFuncProfGrp-{name}"
    ...
    name: Annotated[
        ...
        Field(
            ...
            max_length=64,
            pattern="^[a-zA-Z0-9_.:-]+$",
            description="The name of the function profile group.",
        ),
    ]
