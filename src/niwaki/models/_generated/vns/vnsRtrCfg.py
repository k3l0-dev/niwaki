...
class vnsRtrCfg(ManagedObject):
    """ACI Managed Object: ``vnsRtrCfg`` — Router configuration.

    RN format: ``rtrCfg-{name}``
    """

    _aci_class: ClassVar[str] = "vnsRtrCfg"
    _rn_format: ClassVar[str] = "rtrCfg-{name}"
    ...
    rtr_id: Annotated[
        ...
        Field(
            ...
            description="router id for ospf/bgp instance",
        ),
    ] = ""
