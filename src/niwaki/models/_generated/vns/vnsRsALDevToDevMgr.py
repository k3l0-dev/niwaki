...
class vnsRsALDevToDevMgr(ManagedObject):
    """ACI Managed Object: ``vnsRsALDevToDevMgr`` — Device Manager.

    RN format: ``rsaLDevToDevMgr``
    """

    _aci_class: ClassVar[str] = "vnsRsALDevToDevMgr"
    _rn_format: ClassVar[str] = "rsaLDevToDevMgr"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1654": "fltVnsRsALDevToDevMgrResolveFail",
    }
