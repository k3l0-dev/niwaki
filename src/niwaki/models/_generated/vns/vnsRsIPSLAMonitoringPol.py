...
class vnsRsIPSLAMonitoringPol(ManagedObject):
    """ACI Managed Object: ``vnsRsIPSLAMonitoringPol`` — IP SLA Monitoring Policy.

    RN format: ``rsIPSLAMonitoringPol``
    """

    _aci_class: ClassVar[str] = "vnsRsIPSLAMonitoringPol"
    _rn_format: ClassVar[str] = "rsIPSLAMonitoringPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2831": "fltVnsRsIPSLAMonitoringPolResolveFail",
    }
