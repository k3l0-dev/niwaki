...
class vnsRsChassisEpg(ManagedObject):
    """ACI Managed Object: ``vnsRsChassisEpg`` — Relation from a Device Cluster to an EPG.

    RN format: ``rschassisEpg``
    """

    _aci_class: ClassVar[str] = "vnsRsChassisEpg"
    _rn_format: ClassVar[str] = "rschassisEpg"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1656": "fltVnsRsChassisEpgResolveFail",
    }
