...
class vnsRsCIfAttN(ManagedObject):
    """ACI Managed Object: ``vnsRsCIfAttN`` — Relation to a Set of Concrete Interfaces from the Device in the Cluster.

    RN format: ``rscIfAttN-[{target_dn}]``
    """

    _aci_class: ClassVar[str] = "vnsRsCIfAttN"
    _rn_format: ClassVar[str] = "rscIfAttN-[{target_dn}]"
    _naming_props: ClassVar[list[str]] = ["target_dn"]
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1909": "fltVnsRsCIfAttNResolveFail",
    }
