...
class vnsRsNodeToLDev(ManagedObject):
    """ACI Managed Object: ``vnsRsNodeToLDev`` — Relation from a AbsNode to an LDev.

    Relation from AbsNode to LDev

    RN format: ``rsNodeToLDev``
    """

    _aci_class: ClassVar[str] = "vnsRsNodeToLDev"
    _rn_format: ClassVar[str] = "rsNodeToLDev"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1799": "fltVnsRsNodeToLDevResolveFail",
    }
