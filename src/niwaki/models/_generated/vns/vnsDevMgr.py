...
class vnsDevMgr(ManagedObject):
    """ACI Managed Object: ``vnsDevMgr`` — Device Manager.

    RN format: ``devMgr-{name}``
    ...
    _aci_class: ClassVar[str] = "vnsDevMgr"
    _rn_format: ClassVar[str] = "devMgr-{name}"
