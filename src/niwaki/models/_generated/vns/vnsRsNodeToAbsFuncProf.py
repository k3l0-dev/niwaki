...
class vnsRsNodeToAbsFuncProf(ManagedObject):
    ...
    _aci_class: ClassVar[str] = "vnsRsNodeToAbsFuncProf"
    _rn_format: ClassVar[str] = "rsNodeToAbsFuncProf"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1091": "fltVnsRsNodeToAbsFuncProfResolveFail",
    }
    ...
    target_dn: str = Field(
        ...
        description="The profile name associated with the abrstract node.",
    )
