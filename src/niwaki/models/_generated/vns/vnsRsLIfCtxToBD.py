...
class vnsRsLIfCtxToBD(ManagedObject):
    """ACI Managed Object: ``vnsRsLIfCtxToBD`` — Bridge Domain.

    A source relation to a private layer 2 bridge domain (BD).

    RN format: ``rsLIfCtxToBD``
    """

    _aci_class: ClassVar[str] = "vnsRsLIfCtxToBD"
    _rn_format: ClassVar[str] = "rsLIfCtxToBD"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1374": "fltVnsRsLIfCtxToBDResolveFail",
    }
