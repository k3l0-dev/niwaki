...
class vnsRsVLIfP(ManagedObject):
    """ACI Managed Object: ``vnsRsVLIfP`` — Relation from Concrete Interface to the floating SVI interface.

    Association to floating svi interface

    RN format: ``rsVLIfP``
    """

    _aci_class: ClassVar[str] = "vnsRsVLIfP"
    _rn_format: ClassVar[str] = "rsVLIfP"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3566": "fltVnsRsVLIfPResolveFail",
    }
