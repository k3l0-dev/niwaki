...
class vnsAbsTermNodeCon(ManagedObject):
    """ACI Managed Object: ``vnsAbsTermNodeCon`` — Consumer Terminal Node.

    An abstract terminal node connected to a contract consumer.

    RN format: ``AbsTermNodeCon-{name}``
    """

    _aci_class: ClassVar[str] = "vnsAbsTermNodeCon"
    _rn_format: ClassVar[str] = "AbsTermNodeCon-{name}"
