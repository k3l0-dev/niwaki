...
class vnsRsCDevToCtrlrP(ManagedObject):
    """ACI Managed Object: ``vnsRsCDevToCtrlrP`` — VMM Controller.

    implicit relation to validate the controller profile

    RN format: ``rscDevToCtrlrP``
    """

    _aci_class: ClassVar[str] = "vnsRsCDevToCtrlrP"
    _rn_format: ClassVar[str] = "rscDevToCtrlrP"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1778": "fltVnsRsCDevToCtrlrPResolveFail",
    }
