...
class vnsAddrInst(ManagedObject):
    """ACI Managed Object: ``vnsAddrInst`` — IP Address Pool.

    RN format: ``CtrlrAddrInst-{name}``
    """

    _aci_class: ClassVar[str] = "vnsAddrInst"
    _rn_format: ClassVar[str] = "CtrlrAddrInst-{name}"
    ...
    ip_address: Annotated[
        ...
        Field(
            pattern="^[0-9a-fA-F.:/ ]+$",
            alias="addr",
            description="The Gateway IP address specified in x.x.x.x/y or in x.x.x.x format with the netwrok mask specified in the Mask field.",
        ),
    ] = ""
