...
class vnsRsDevMgrToMDevMgr(ManagedObject):
    """ACI Managed Object: ``vnsRsDevMgrToMDevMgr`` — L4-L7 Device Manager type.

    RN format: ``rsdevMgrToMDevMgr``
    """

    _aci_class: ClassVar[str] = "vnsRsDevMgrToMDevMgr"
    _rn_format: ClassVar[str] = "rsdevMgrToMDevMgr"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1659": "fltVnsRsDevMgrToMDevMgrResolveFail",
    }
