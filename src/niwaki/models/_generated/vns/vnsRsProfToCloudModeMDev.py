...
class vnsRsProfToCloudModeMDev(ManagedObject):
    """ACI Managed Object: ``vnsRsProfToCloudModeMDev`` — Relation to CloudMode MDev..

    Relation from profile to Cloud Mode MDev

    RN format: ``rsProfToCloudModeMDev``
    """

    _aci_class: ClassVar[str] = "vnsRsProfToCloudModeMDev"
    _rn_format: ClassVar[str] = "rsProfToCloudModeMDev"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2987": "fltVnsRsProfToCloudModeMDevResolveFail",
    }
