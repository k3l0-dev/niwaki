...
class vnsRsToCIf(ManagedObject):
    """ACI Managed Object: ``vnsRsToCIf`` — Concrete Interface.

    RN format: ``rstoCIf``
    """

    _aci_class: ClassVar[str] = "vnsRsToCIf"
    _rn_format: ClassVar[str] = "rstoCIf"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3288": "fltVnsRsToCIfResolveFail",
    }
