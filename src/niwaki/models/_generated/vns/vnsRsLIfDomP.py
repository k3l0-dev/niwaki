...
class vnsRsLIfDomP(ManagedObject):
    """ACI Managed Object: ``vnsRsLIfDomP`` — Relation from LIf to a Vlan Namespace Instance Profile.

    RN format: ``rsLIfDomP``
    """

    _aci_class: ClassVar[str] = "vnsRsLIfDomP"
    _rn_format: ClassVar[str] = "rsLIfDomP"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3921": "fltVnsRsLIfDomPResolveFail",
    }
