...
class vnsAbsFuncProfContr(ManagedObject):
    """ACI Managed Object: ``vnsAbsFuncProfContr`` — L4-L7 Services Function Profile Group.

    A function profile group container.

    RN format: ``absFuncProfContr``
    """

    _aci_class: ClassVar[str] = "vnsAbsFuncProfContr"
    _rn_format: ClassVar[str] = "absFuncProfContr"
