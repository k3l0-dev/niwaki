...
class vnsRsCDevTemplateToAddrInst(ManagedObject):
    """ACI Managed Object: ``vnsRsCDevTemplateToAddrInst`` — Relation to IP Address Pool.

    RN format: ``rscDevTemplateToAddrInst``
    """

    _aci_class: ClassVar[str] = "vnsRsCDevTemplateToAddrInst"
    _rn_format: ClassVar[str] = "rscDevTemplateToAddrInst"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3238": "fltVnsRsCDevTemplateToAddrInstResolveFail",
    }
