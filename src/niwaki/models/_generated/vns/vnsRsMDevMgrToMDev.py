...
class vnsRsMDevMgrToMDev(ManagedObject):
    """ACI Managed Object: ``vnsRsMDevMgrToMDev`` — L4-L7 Service Device Type.

    RN format: ``rsmDevMgrToMDev``
    """

    _aci_class: ClassVar[str] = "vnsRsMDevMgrToMDev"
    _rn_format: ClassVar[str] = "rsmDevMgrToMDev"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1661": "fltVnsRsMDevMgrToMDevResolveFail",
    }
