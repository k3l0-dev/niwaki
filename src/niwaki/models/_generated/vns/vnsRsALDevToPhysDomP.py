...
class vnsRsALDevToPhysDomP(ManagedObject):
    """ACI Managed Object: ``vnsRsALDevToPhysDomP`` — Relation from L4-L7 Devices to a Vlan Namespace Instance Profile.

    A source relation to a physical domain profile.

    RN format: ``rsALDevToPhysDomP``
    """

    _aci_class: ClassVar[str] = "vnsRsALDevToPhysDomP"
    _rn_format: ClassVar[str] = "rsALDevToPhysDomP"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1082": "fltVnsRsALDevToPhysDomPResolveFail",
    }
