...
class vnsRsInterface(ManagedObject):
    """ACI Managed Object: ``vnsRsInterface`` — Relation to L4-L7 Service Connector Interface Label.

    A source relation to an interface label. Note that this relation is an internal object.

    RN format: ``rsinterface``
    """

    _aci_class: ClassVar[str] = "vnsRsInterface"
    _rn_format: ClassVar[str] = "rsinterface"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1104": "fltVnsRsInterfaceResolveFail",
    }
