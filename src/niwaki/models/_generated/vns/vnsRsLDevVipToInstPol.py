...
class vnsRsLDevVipToInstPol(ManagedObject):
    """ACI Managed Object: ``vnsRsLDevVipToInstPol`` — Service Instance Policy.

    Association to the Service Instance Policy for this controller

    RN format: ``rslDevVipToInstPol``
    """

    _aci_class: ClassVar[str] = "vnsRsLDevVipToInstPol"
    _rn_format: ClassVar[str] = "rslDevVipToInstPol"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3135": "fltVnsRsLDevVipToInstPolResolveFail",
    }
