...
class vnsRsMChassisToMDev(ManagedObject):
    """ACI Managed Object: ``vnsRsMChassisToMDev`` — L4-L7 Service Device Type.

    RN format: ``rsmChassisToMDev``
    """

    _aci_class: ClassVar[str] = "vnsRsMChassisToMDev"
    _rn_format: ClassVar[str] = "rsmChassisToMDev"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F1660": "fltVnsRsMChassisToMDevResolveFail",
    }
