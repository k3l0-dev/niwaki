...
class vnsRsNodeToCloudLDev(ManagedObject):
    """ACI Managed Object: ``vnsRsNodeToCloudLDev`` — Relation from a AbsNode to an CloudLDev.

    Relation from AbsNode to clould LDev

    RN format: ``rsNodeToCloudLDev``
    """

    _aci_class: ClassVar[str] = "vnsRsNodeToCloudLDev"
    _rn_format: ClassVar[str] = "rsNodeToCloudLDev"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3465": "fltVnsRsNodeToCloudLDevResolveFail",
    }
