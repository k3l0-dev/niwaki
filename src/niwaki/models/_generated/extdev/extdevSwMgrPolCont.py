...
class extdevSwMgrPolCont(ManagedObject):
    """ACI Managed Object: ``extdevSwMgrPolCont`` — Container for domain relations.

    RN format: ``swmgrcont``
    """

    _aci_class: ClassVar[str] = "extdevSwMgrPolCont"
    _rn_format: ClassVar[str] = "swmgrcont"
