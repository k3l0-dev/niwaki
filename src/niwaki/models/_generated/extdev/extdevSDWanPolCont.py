...
class extdevSDWanPolCont(ManagedObject):
    """ACI Managed Object: ``extdevSDWanPolCont`` — WAN SLA Policy Container.

    SDWAN policy Container

    RN format: ``sdwanpolcont``
    """

    _aci_class: ClassVar[str] = "extdevSDWanPolCont"
    _rn_format: ClassVar[str] = "sdwanpolcont"
