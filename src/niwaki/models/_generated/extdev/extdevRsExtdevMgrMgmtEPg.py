...
class extdevRsExtdevMgrMgmtEPg(ManagedObject):
    """ACI Managed Object: ``extdevRsExtdevMgrMgmtEPg`` — Management EPg.

    Association to the Management EPg for this Controller @@@ This is used to decide the Context (VRF) in which @@@ the controller is present.

    RN format: ``rsextdevMgrMgmtEPg``
    """

    _aci_class: ClassVar[str] = "extdevRsExtdevMgrMgmtEPg"
    _rn_format: ClassVar[str] = "rsextdevMgrMgmtEPg"
