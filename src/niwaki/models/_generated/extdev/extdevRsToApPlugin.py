...
class extdevRsToApPlugin(ManagedObject):
    """ACI Managed Object: ``extdevRsToApPlugin`` — Target App Plugin.

    Default set of plugins to allow communication with

    RN format: ``rstoApPlugin-[{target_dn}]``
    """
