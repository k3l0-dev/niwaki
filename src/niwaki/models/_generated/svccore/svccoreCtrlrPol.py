...
class svccoreCtrlrPol(ManagedObject):
    """ACI Managed Object: ``svccoreCtrlrPol`` — Policy for Cores Generated at Ctrlrs.

    RN format: ``CtrlrCore-{name}``
    """

    _aci_class: ClassVar[str] = "svccoreCtrlrPol"
    _rn_format: ClassVar[str] = "CtrlrCore-{name}"
