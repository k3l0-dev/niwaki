...
class vlanCktEpClearEpLTask(ManagedObject):
    """ACI Managed Object: ``vlanCktEpClearEpLTask``.

    A task object to clear endpoints in a given VLAN.

    RN format: ``vlanCktEpClearEpLTask``
    """

    _aci_class: ClassVar[str] = "vlanCktEpClearEpLTask"
    _rn_format: ClassVar[str] = "vlanCktEpClearEpLTask"
