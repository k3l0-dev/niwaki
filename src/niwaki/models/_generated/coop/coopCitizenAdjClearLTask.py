...
class coopCitizenAdjClearLTask(ManagedObject):
    """ACI Managed Object: ``coopCitizenAdjClearLTask``.

    The task object that clears a COOP citizen adjacency.

    RN format: ``coopCitizenAdjClearLTask``
    """

    _aci_class: ClassVar[str] = "coopCitizenAdjClearLTask"
    _rn_format: ClassVar[str] = "coopCitizenAdjClearLTask"
