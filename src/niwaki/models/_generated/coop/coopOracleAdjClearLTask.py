...
class coopOracleAdjClearLTask(ManagedObject):
    """ACI Managed Object: ``coopOracleAdjClearLTask``.

    The task object that clears a COOP oracle adjacency.

    RN format: ``coopOracleAdjClearLTask``
    """

    _aci_class: ClassVar[str] = "coopOracleAdjClearLTask"
    _rn_format: ClassVar[str] = "coopOracleAdjClearLTask"
