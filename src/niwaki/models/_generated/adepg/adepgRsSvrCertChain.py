...
class adepgRsSvrCertChain(ManagedObject):
    """ACI Managed Object: ``adepgRsSvrCertChain`` — Key Ring.

    ISE certChain

    RN format: ``rssvrCertChain``
    """

    _aci_class: ClassVar[str] = "adepgRsSvrCertChain"
    _rn_format: ClassVar[str] = "rssvrCertChain"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3180": "fltAdepgRsSvrCertChainResolveFail",
    }
