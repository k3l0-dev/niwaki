...
class adepgRsSvrKeyRing(ManagedObject):
    """ACI Managed Object: ``adepgRsSvrKeyRing`` — Key Ring.

    ISE private key, certificate

    RN format: ``rssvrKeyRing``
    """

    _aci_class: ClassVar[str] = "adepgRsSvrKeyRing"
    _rn_format: ClassVar[str] = "rssvrKeyRing"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F3181": "fltAdepgRsSvrKeyRingResolveFail",
    }
