...
class polRsCtrlrFipsMode(ManagedObject):
    """ACI Managed Object: ``polRsCtrlrFipsMode`` — Controller Fips Mode.

    RN format: ``rsctrlrFipsMode``
    """

    _aci_class: ClassVar[str] = "polRsCtrlrFipsMode"
    _rn_format: ClassVar[str] = "rsctrlrFipsMode"
    _naming_props: ClassVar[list[str]] = []
    _fault_codes: ClassVar[dict[str, str]] = {
        "F2562": "fltPolRsCtrlrFipsModeResolveFail",
    }
