...
class polRsFirmwareRepoP(ManagedObject):
    """ACI Managed Object: ``polRsFirmwareRepoP`` — Firmware Repository.

    RN format: ``rsfirmwareRepoP``
    """

    _aci_class: ClassVar[str] = "polRsFirmwareRepoP"
    _rn_format: ClassVar[str] = "rsfirmwareRepoP"
