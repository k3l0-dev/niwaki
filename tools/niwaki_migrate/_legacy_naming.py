"""FROZEN — the 1.x naming policy, verbatim (commit f81a960d).

The migration-table builder derives the *old* readable names by running this
module's resolution over the current catalogue inputs.  Never edit: this file
is the 1.x behavior, kept as data.  The live policy is
``niwaki._schema.naming``.
"""
...
# curated positions).  Reserved for names whose schema label is wrong at the
# source; keep this list short and justified.
NAV_NAME_OVERRIDES: dict[str, str] = {
    # Cisco ships the label "Catalog Maitenance Policy" — fix the typo.
    "maintCatMaintP": "catalog_maintenance_policy",
    # Cisco ships the label "VMM Host Availibility Policy" — fix the typo.
    # (Its only current position, vmmCtrlrP, is curated as
    # host_availability_policy — the maker overlay wins there; this override
    # guards any future uncurated position against the misspelled label.)
    "vmmHvAvailPol": "vmm_host_availability_policy",
}
...
FIELD_NAME_OVERRIDES: dict[tuple[str, str], str] = {
    ...
    # Label "Indicate whether MPLS is enabled or not" is a whole sentence that
    # slips under the length cap; the wire prop is the operator word.  This
    # flag is what makes an L3Out a SR-MPLS VRF L3Out.
    ("l3extOut", "mplsEnabled"): "mpls_enabled",
    # ── Everyday config knobs whose schema label is a full sentence that slips
    #    under the length cap; the wire prop is the operator word. ────────────
    ("bgpPeerP", "weight"): "weight",
    ("bgpPeerP", "connectivityType"): "connectivity_type",
    ("bgpInfraPeerP", "weight"): "weight",
    ("bgpCtxAfPol", "maxLocalEcmp"): "max_local_ecmp",
    ("l2IfPol", "vlanScope"): "vlan_scope",
    ("l2PortSecurityPol", "maximum"): "maximum",
    ("l2PortSecurityPol", "timeout"): "timeout",
    ("hsrpGroupP", "mac"): "mac",
    ("hsrpGroupPol", "preemptDelayReload"): "preempt_delay_reload",
    ("l3extDefaultRouteLeakP", "scope"): "scope",
    ("infraPortTrackPol", "minlinks"): "minlinks",
    ("l4VxlanInstPol", "udpPort"): "udp_port",
    ("ospfCtxPol", "maxLsaNum"): "max_lsa_num",
    ("isakmpKeyring", "address"): "address",
    ("mplsNodeSidP", "loopbackAddr"): "loopback_addr",
    ("fvCepNetCfgPol", "startIp"): "start_ip",
    ("fvCepNetCfgPol", "endIp"): "end_ip",
    ("fvCepNetCfgPol", "dnsSuffix"): "dns_suffix",
    ("fvCepNetCfgPol", "dnsSearchSuffix"): "dns_search_suffix",
    ("infraSetPol", "enforceSubnetCheck"): "enforce_subnet_check",
    # ── Sentence-label cleanup, batch 2 (niche/protocol config fields) ──────
    ("bfdIpv4InstPol", "echoSrcAddr"): "echo_src_addr",
    ("bfdIpv6InstPol", "echoSrcAddr"): "echo_src_addr",
    ("commApiRespTime", "topNRequests"): "top_n_requests",
    ("commReconfig", "toggle"): "toggle",
    ("datetimePol", "StratumValue"): "stratum_value",
    ("dbgexpTechSupP", "category"): "category",
    ("fvBD", "limitIpLearnToSubnets"): "limit_ip_learn_to_subnets",
    ("fvBD", "mcastARPDrop"): "mcast_arp_drop",
    ("fvRouteDeployP", "spineIntraVrf"): "spine_intra_vrf",
    ("fvTagSelector", "matchKey"): "match_key",
    ("fvTagSelector", "matchValue"): "match_value",
    ("fvVmAttr", "value"): "value",
    ("infraRlPodRedPol", "enableRlPodRedPol"): "enable_rl_pod_red_pol",
    ("infraSetPol", "dampFactor"): "damp_factor",
    ("isakmpGlobalPol", "retryInterval"): "retry_interval",
    ("l3extRogueExceptMacP", "enableAllMacs"): "enable_all_macs",
    ("l3extVrfValidationPol", "enableVrfValidationOspfArea"): "enable_vrf_validation_ospf_area",
    (
        "l3extVrfValidationPol",
        "enableVrfValidationSviLinkLocalAddr",
    ): "enable_vrf_validation_svi_link_local_addr",
    ("latencyPtpMode", "systemResolution"): "system_resolution",
    ("licenseLicPolicy", "reportInterval"): "report_interval",
    ("mgmtConnectivityPrefs", "interfacePref"): "interface_pref",
    ("ptpProfile", "delayIntvl"): "delay_intvl",
    ("ptpProfile", "nodeProfileOverride"): "node_profile_override",
    ("ptpProfileTemplate", "delayReqIntvlEnd"): "delay_req_intvl_end",
    ("qosInstPol", "EtrapAgeTimer"): "etrap_age_timer",
    ("qosLlfcIfPol", "llfcRcvAdminSt"): "llfc_rcv_admin_st",
    ("qosLlfcIfPol", "llfcSendAdminSt"): "llfc_send_admin_st",
    ("stormctrlIfPol", "isUcMcBcStormPktCfgValid"): "is_uc_mc_bc_storm_pkt_cfg_valid",
    ("synceEthIfPol", "qloptype"): "qloptype",
    ("telemetryFlowCollectorP", "externalServerIp"): "external_server_ip",
    ("telemetryFteEventSetP", "aclSpan"): "acl_span",
    ("telemetryFteEventSetP", "dropFlowCount"): "drop_flow_count",
    ("telemetryFteEventSetP", "eventExportMax"): "event_export_max",
    ("telemetryFteEventSetP", "exportFlowCount"): "export_flow_count",
    ("telemetryFteEventSetP", "exportFlowLimit"): "export_flow_limit",
    ("telemetryFteEventSetP", "firstPacketCount"): "first_packet_count",
    ("telemetryFteEventSetP", "firstPacketLimit"): "first_packet_limit",
    ("telemetryFteEventSetP", "latencyFlowCount"): "latency_flow_count",
    ("telemetryFteEventSetP", "mousePacketCount"): "mouse_packet_count",
    ("telemetryFteEventSetP", "mousePacketLimit"): "mouse_packet_limit",
    ("telemetryFteEventSetP", "rttAckCount"): "rtt_ack_count",
    ("telemetryFteEventSetP", "rttAckLimit"): "rtt_ack_limit",
    ("telemetryFteEventSetP", "tableFullCount"): "table_full_count",
    ("telemetryFteEventSetP", "tableFullLimit"): "table_full_limit",
    ("vnsSvcRedirectPol", "srcMacRewriteEnabled"): "src_mac_rewrite_enabled",
    # ── Sentence-label cleanup, batch 3 (high-traffic classes: BD/subnet/entry) ──
    ("fvSubnet", "virtual"): "virtual",
    ("fvSubnet", "preferred"): "preferred",
    ("vzEntry", "applyToFrag"): "apply_to_frag",
    ("vzEntry", "matchDscp"): "match_dscp",
    ("l3extSubnet", "aggregate"): "aggregate",
    ("l3extSubnet", "scope"): "scope",
    ("fvBD", "OptimizeWanBandwidth"): "optimize_wan_bandwidth",
    ("fvBD", "intersiteBumTrafficAllow"): "intersite_bum_traffic_allow",
    ("fvBD", "serviceBdRoutingDisable"): "service_bd_routing_disable",
}
