...
_MAKER_RENAMES = {
    ...
    ("fvTenant", "service_graph"): "l4_l7_service_graph_template",
    ("fvTenant", "logical_device"): "l4_l7_devices",
    ("vnsLDevVip", "logical_interface"): "vns_logical_interface",
    ("vnsCDev", "device_param"): "vns_device",
    ("vnsLIfCtx", "virtual_ip"): "l4_l7_virtual_ip_address",
    ("fvTenant", "function_profile_container"): "l4_l7_services_function_profile_group",
    ("vnsAbsFuncProfContr", "function_profile_group"): "l4_l7_services_function_profile_group",
    ("vnsAbsFuncProfGrp", "function_profile"): "l4_l7_services_function_profile",
    ("vnsAbsFuncProf", "function_config"): "l4_l7_services_function_config",
    ("vnsAbsFuncProf", "device_config"): "l4_l7_services_device_shared_config",
    ("vnsAbsFuncProf", "group_config"): "l4_l7_services_group_shared_config",
    ("vnsAbsFuncConn", "folder"): "l4_l7_services_folder",
    ("vnsAbsFuncConn", "param"): "l4_l7_services_parameter",
    ("vnsAbsFolder", "param"): "l4_l7_services_parameter",
    ("vnsAbsFolder", "relation"): "l4_l7_services_relation",
    ("fvTenant", "chassis"): "chassis_for_cdevs",
    ("fvTenant", "policy_container"): "l4_l7_policy_container",
    ("fvTenant", "folder_instance"): "l4_l7_folder_instance",
    ("fvTenant", "firewall_parameters"): "normalized_firewall_parameters",
    ("vnsSvcPol", "folder_instance"): "l4_l7_folder_instance",
    ("vnsFolderInst", "param_instance"): "l4_l7_param_instance",
    ("vnsFolderInst", "relation"): "relation_to_l4_l7_services_param_relation_abstract_class",
