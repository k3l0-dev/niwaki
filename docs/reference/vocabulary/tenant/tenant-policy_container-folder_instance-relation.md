...
(vocab-tenant-policy_container-folder_instance-relation)=
...
| | |
| --- | --- |
| ACI class | `vnsCfgRelInst` |
| RN | `CfgRelInst-{name}` |
| Cursor | `PolicyContainerFolderInstanceRelationCursor` |
| Parent | {ref}`tenant.policy_container.folder_instance <vocab-tenant-policy_container-folder_instance>` |
| Atomic | — |

## Attributes

Accepted as keyword arguments of `.relation(name)` and of `.set(**attrs)` on this cursor.  Enum parameters also accept the plain string.

| parameter | wire | type | values | default | description |
| --- | --- | --- | --- | --- | --- |
| `name` *(positional)* | `name` | `str` | — | — | The name of the folder instance configured by the administrator. |
...
| `target_name` | `targetName` | `str` | — | — | The target to which this parameter applies. |
...
| code | condition |
| --- | --- |
| `F1379` | `fltVnsCfgRelInstValidationFailed` |
