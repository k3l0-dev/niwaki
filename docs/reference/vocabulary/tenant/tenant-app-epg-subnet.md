...
(vocab-tenant-app-epg-subnet)=

# `tenant.app.epg.subnet`
...
| --- | --- | --- |
| `.anycast_endpoint(mac, **attrs)` | `fvEpAnycast` | {ref}`tenant.app.epg.subnet.anycast_endpoint <vocab-tenant-app-epg-subnet-anycast_endpoint>` |
| `.nlb_endpoint(**attrs)` | `fvEpNlb` | {ref}`tenant.app.epg.subnet.nlb_endpoint <vocab-tenant-app-epg-subnet-nlb_endpoint>` |
| `.endpoint_network_config(name, **attrs)` | `fvCepNetCfgPol` | {ref}`tenant.app.epg.subnet.endpoint_network_config <vocab-tenant-app-epg-subnet-endpoint_network_config>` |
