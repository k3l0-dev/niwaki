...
(vocab-tenant-l3out-node_profile-interface_profile-pim_interface)=
...
| ACI class | `pimIfP` |
| RN | `pimifp` |
| Cursor | `PimInterfaceCursor` |
| Parent | {ref}`tenant.l3out.node_profile.interface_profile <vocab-tenant-l3out-node_profile-interface_profile>` |
| Atomic | — |

## Attributes

Accepted as keyword arguments of `.pim_interface()` and of `.set(**attrs)` on this cursor.  Enum parameters also accept the plain string.
