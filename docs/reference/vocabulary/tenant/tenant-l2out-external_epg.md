...
(vocab-tenant-l2out-external_epg)=

# `tenant.l2out.external_epg`
...
| | |
| --- | --- |
| ACI class | `l2extInstP` |
| RN | `instP-{name}` |
| Cursor | `L2outExternalEpgCursor` |
| Parent | {ref}`tenant.l2out <vocab-tenant-l2out>` |
| Atomic | — |
...
| --- | --- | --- | --- | --- | --- |
| `name` *(positional)* | `name` | `str` | — | — | The name of the layer 2 external network instance profile. This name can be up to 64 alphanumeric characters. Note that you cannot change this name after the object has been saved. |
...
| --- | --- | --- |
| `.subnet(subnet, **attrs)` | `fvSubnet` | {ref}`tenant.l2out.external_epg.subnet <vocab-tenant-l2out-external_epg-subnet>` |
| `.provider_label(name, **attrs)` | `vzProvLbl` | {ref}`tenant.l2out.external_epg.provider_label <vocab-tenant-l2out-external_epg-provider_label>` |
| `.consumer_label(name, **attrs)` | `vzConsLbl` | {ref}`tenant.l2out.external_epg.consumer_label <vocab-tenant-l2out-external_epg-consumer_label>` |
| `.provider_subject_label(name, **attrs)` | `vzProvSubjLbl` | {ref}`tenant.l2out.external_epg.provider_subject_label <vocab-tenant-l2out-external_epg-provider_subject_label>` |
| `.consumer_subject_label(name, **attrs)` | `vzConsSubjLbl` | {ref}`tenant.l2out.external_epg.consumer_subject_label <vocab-tenant-l2out-external_epg-consumer_subject_label>` |
| `.provider_contract_label(name, **attrs)` | `vzProvCtrctLbl` | {ref}`tenant.l2out.external_epg.provider_contract_label <vocab-tenant-l2out-external_epg-provider_contract_label>` |
| `.consumer_contract_label(name, **attrs)` | `vzConsCtrctLbl` | {ref}`tenant.l2out.external_epg.consumer_contract_label <vocab-tenant-l2out-external_epg-consumer_contract_label>` |
