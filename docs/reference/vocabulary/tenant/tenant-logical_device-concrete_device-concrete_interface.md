...
(vocab-tenant-logical_device-concrete_device-concrete_interface)=
...
| ACI class | `vnsCIf` |
| RN | `cIf-[{name}]` |
| Cursor | `ConcreteInterfaceCursor` |
| Parent | {ref}`tenant.logical_device.concrete_device <vocab-tenant-logical_device-concrete_device>` |
| Atomic | — |

## Attributes

Accepted as keyword arguments of `.concrete_interface(name)` and of `.set(**attrs)` on this cursor.  Enum parameters also accept the plain string.

| parameter | wire | type | values | default | description |
| --- | --- | --- | --- | --- | --- |
| `name` *(positional)* | `name` | `str` | — | — | The name of the concrete interface in the L4-L7 device cluster. |
| `encap` | `encap` | `str` | — | — | encap value |
| `vnic` | `vnicName` | `str` | — | — | The concrete interface vNIC name. |
