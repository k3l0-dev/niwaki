...
(vocab-tenant-vrf-pim-inter_vrf-entry)=

# `tenant.vrf.pim.inter_vrf.entry`
...
| Cursor | `PimInterVrfEntryCursor` |
| Parent | {ref}`tenant.vrf.pim.inter_vrf <vocab-tenant-vrf-pim-inter_vrf>` |
| Atomic | — |
