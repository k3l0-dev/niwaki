...
(vocab-tenant-vrf-pim-bootstrap_rp-bsr_filter)=

# `tenant.vrf.pim.bootstrap_rp.bsr_filter`
...
| RN | `bsfilter` |
| Cursor | `PimBootstrapRpBsrFilterCursor` |
| Parent | {ref}`tenant.vrf.pim.bootstrap_rp <vocab-tenant-vrf-pim-bootstrap_rp>` |
| Atomic | — |
