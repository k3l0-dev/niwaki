...
| `enable_vrf_validation_ospf_area_id` | `enableVrfValidationOspfAreaId` | `bool` | — | `True` | Implementation note: Corresponds to kVrfValidationOspfAreaId |
...
| `enable_vrf_validation_subnet` | `enableVrfValidationSubnet` | `bool` | — | `True` | Implementation note: Corresponds to kVrfValidationSubnet |
