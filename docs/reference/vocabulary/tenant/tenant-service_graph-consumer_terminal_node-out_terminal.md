...
(vocab-tenant-service_graph-consumer_terminal_node-out_terminal)=
...
| RN | `outtmnl` |
| Cursor | `ConsumerTerminalNodeOutTerminalCursor` |
| Parent | {ref}`tenant.service_graph.consumer_terminal_node <vocab-tenant-service_graph-consumer_terminal_node>` |
| Atomic | — |
