...
(vocab-tenant-policy_container-folder_instance-param_instance)=
...
| | |
| --- | --- |
| ACI class | `vnsParamInst` |
| RN | `ParamInst-{name}` |
| Cursor | `PolicyContainerFolderInstanceParamInstanceCursor` |
| Parent | {ref}`tenant.policy_container.folder_instance <vocab-tenant-policy_container-folder_instance>` |
| Atomic | — |

## Attributes

Accepted as keyword arguments of `.param_instance(name)` and of `.set(**attrs)` on this cursor.  Enum parameters also accept the plain string.

| parameter | wire | type | values | default | description |
| --- | --- | --- | --- | --- | --- |
| `name` *(positional)* | `name` | `str` | — | — | The name of the parameter instance. |
...
| `meta_param_key` | `key` | `str` | — | — | The key uniquely identifying this configuration object. |
