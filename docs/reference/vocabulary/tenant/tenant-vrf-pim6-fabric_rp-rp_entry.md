...
(vocab-tenant-vrf-pim6-fabric_rp-rp_entry)=

# `tenant.vrf.pim6.fabric_rp.rp_entry`
...
| Cursor | `Pim6FabricRpRpEntryCursor` |
| Parent | {ref}`tenant.vrf.pim6.fabric_rp <vocab-tenant-vrf-pim6-fabric_rp>` |
| Atomic | — |
...
| --- | --- | --- |
| `.group_range(**attrs)` | `pimRPGrpRangePol` | {ref}`tenant.vrf.pim6.fabric_rp.rp_entry.group_range <vocab-tenant-vrf-pim6-fabric_rp-rp_entry-group_range>` |
