...
(vocab-tenant-vrf-pim-fabric_rp-rp_entry)=

# `tenant.vrf.pim.fabric_rp.rp_entry`
...
| Cursor | `PimFabricRpRpEntryCursor` |
| Parent | {ref}`tenant.vrf.pim.fabric_rp <vocab-tenant-vrf-pim-fabric_rp>` |
| Atomic | — |
...
| --- | --- | --- |
| `.group_range(**attrs)` | `pimRPGrpRangePol` | {ref}`tenant.vrf.pim.fabric_rp.rp_entry.group_range <vocab-tenant-vrf-pim-fabric_rp-rp_entry-group_range>` |
