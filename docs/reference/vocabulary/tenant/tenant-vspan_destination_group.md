...
(vocab-tenant-vspan_destination_group)=
...
| RN | `vdestgrp-{name}` |
| Cursor | `TenantVspanDestinationGroupCursor` |
...
| --- | --- | --- |
| `.vspan_vdestination(name, **attrs)` | `spanVDest` | {ref}`tenant.vspan_destination_group.vspan_vdestination <vocab-tenant-vspan_destination_group-vspan_vdestination>` |
