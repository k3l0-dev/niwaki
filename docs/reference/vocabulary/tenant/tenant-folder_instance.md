...
| Cursor | `TenantFolderInstanceCursor` |
...
| --- | --- | --- |
| `.param_instance(name, **attrs)` | `vnsParamInst` | {ref}`tenant.folder_instance.param_instance <vocab-tenant-folder_instance-param_instance>` |
| `.relation(name, **attrs)` | `vnsCfgRelInst` | {ref}`tenant.folder_instance.relation <vocab-tenant-folder_instance-relation>` |
