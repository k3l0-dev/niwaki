...
(vocab-tenant-l2out-node_profile-interface_profile)=
...
| ACI class | `l2extLIfP` |
| RN | `lifp-{name}` |
| Cursor | `L2outNodeProfileInterfaceProfileCursor` |
| Parent | {ref}`tenant.l2out.node_profile <vocab-tenant-l2out-node_profile>` |
| Atomic | — |
...
| --- | --- | --- |
| `.static_path(target_dn, **attrs)` | `l2extRsPathL2OutAtt` | {ref}`tenant.l2out.node_profile.interface_profile.static_path <vocab-tenant-l2out-node_profile-interface_profile-static_path>` |
