...
(vocab-tenant-folder_instance-relation)=

# `tenant.folder_instance.relation`
...
| RN | `CfgRelInst-{name}` |
| Cursor | `TenantFolderInstanceRelationCursor` |
| Parent | {ref}`tenant.folder_instance <vocab-tenant-folder_instance>` |
| Atomic | — |
