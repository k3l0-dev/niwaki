...
(vocab-tenant-vrf-pim-auto_rp-ma_filter)=

# `tenant.vrf.pim.auto_rp.ma_filter`
...
| RN | `mafilter` |
| Cursor | `PimAutoRpMaFilterCursor` |
| Parent | {ref}`tenant.vrf.pim.auto_rp <vocab-tenant-vrf-pim-auto_rp>` |
| Atomic | — |
