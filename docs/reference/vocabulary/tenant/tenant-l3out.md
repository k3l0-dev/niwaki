...
| `enforce_rtctrl` | `enforceRtctrl` | `str` | — | — | The enforce route control type. |
| `indicate_whether_mpls_is_enabled_or_not` | `mplsEnabled` | `bool` | — | `False` | Indiscate whether MPLS is enabled or not |
