...
(vocab-tenant-l3out-node_profile-interface_profile-bfd_interface)=
...
| ACI class | `bfdIfP` |
| RN | `bfdIfP` |
| Cursor | `BfdInterfaceCursor` |
| Parent | {ref}`tenant.l3out.node_profile.interface_profile <vocab-tenant-l3out-node_profile-interface_profile>` |
| Atomic | — |

## Attributes

Accepted as keyword arguments of `.bfd_interface()` and of `.set(**attrs)` on this cursor.  Enum parameters also accept the plain string.
