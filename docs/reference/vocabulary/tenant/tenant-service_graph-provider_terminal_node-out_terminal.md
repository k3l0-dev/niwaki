...
(vocab-tenant-service_graph-provider_terminal_node-out_terminal)=
...
| | |
| --- | --- |
| ACI class | `vnsOutTerm` |
| RN | `outtmnl` |
| Cursor | `ProviderTerminalNodeOutTerminalCursor` |
| Parent | {ref}`tenant.service_graph.provider_terminal_node <vocab-tenant-service_graph-provider_terminal_node>` |
| Atomic | — |

## Attributes

Accepted as keyword arguments of `.out_terminal()` and of `.set(**attrs)` on this cursor.  Enum parameters also accept the plain string.
