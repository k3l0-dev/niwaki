...
(vocab-tenant-service_graph-provider_terminal_node-in_terminal)=
...
| ACI class | `vnsInTerm` |
| RN | `intmnl` |
| Cursor | `ProviderTerminalNodeInTerminalCursor` |
| Parent | {ref}`tenant.service_graph.provider_terminal_node <vocab-tenant-service_graph-provider_terminal_node>` |
| Atomic | — |

## Attributes

Accepted as keyword arguments of `.in_terminal()` and of `.set(**attrs)` on this cursor.  Enum parameters also accept the plain string.
