...
(vocab-tenant-vrf-leak_routes-internal_prefix)=

# `tenant.vrf.leak_routes.internal_prefix`

| | |
| --- | --- |
| ACI class | `leakInternalPrefix` |
| RN | `leakintprefix-[{subnet}]` |
| Cursor | `InternalPrefixCursor` |
...
| --- | --- | --- |
| `.leak_to(leak_to_tenant_name, leak_to_vrf_name, **attrs)` | `leakTo` | {ref}`tenant.vrf.leak_routes.internal_prefix.leak_to <vocab-tenant-vrf-leak_routes-internal_prefix-leak_to>` |
