...
(vocab-tenant-l2out-node_profile)=
...
| | |
| --- | --- |
| ACI class | `l2extLNodeP` |
| RN | `lnodep-{name}` |
| Cursor | `L2outNodeProfileCursor` |
...
| --- | --- | --- |
| `.interface_profile(name, **attrs)` | `l2extLIfP` | {ref}`tenant.l2out.node_profile.interface_profile <vocab-tenant-l2out-node_profile-interface_profile>` |
