...
(vocab-tenant-service_graph-function_node-function_connector-folder-param)=
...
| | |
| --- | --- |
| ACI class | `vnsAbsParam` |
| RN | `absParam-{name}` |
| Cursor | `FolderParamCursor` |
| Parent | {ref}`tenant.service_graph.function_node.function_connector.folder <vocab-tenant-service_graph-function_node-function_connector-folder>` |
| Atomic | — |

## Attributes

Accepted as keyword arguments of `.param(name)` and of `.set(**attrs)` on this cursor.  Enum parameters also accept the plain string.

| parameter | wire | type | values | default | description |
| --- | --- | --- | --- | --- | --- |
| `name` *(positional)* | `name` | `str` | — | — | The name of the abstract node parameters. |
...
| `mandatory` | `mandatory` | `bool` | — | `False` | The value that indicates if this parameter is mandatory. |
| `src_ref` | `srcRef` | `str` | — | — | — |
| `validation` | `validation` | `str` | — | — | The validation expression. |
