...
(vocab-tenant-service_graph-function_node-function_connector-folder-relation)=
...
| | |
| --- | --- |
| ACI class | `vnsAbsCfgRel` |
| RN | `absRel-{name}` |
| Cursor | `FolderRelationCursor` |
...
| --- | --- | --- | --- | --- | --- |
| `name` *(positional)* | `name` | `str` | — | — | The name of the folder/param relations. |
