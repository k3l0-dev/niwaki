...
(vocab-fabric-vspan_destination_group)=
...
| RN | `vdestgrp-{name}` |
| Cursor | `FabricVspanDestinationGroupCursor` |
...
| --- | --- | --- |
| `.vspan_vdestination(name, **attrs)` | `spanVDest` | {ref}`fabric.vspan_destination_group.vspan_vdestination <vocab-fabric-vspan_destination_group-vspan_vdestination>` |
